...
|----------|------------|
| **IronClaw stack (most current work)** | `crates/ironclaw_runner/`, `crates/ironclaw_cli/`, `crates/ironclaw_composition/`, `crates/ironclaw_event_store/`, `crates/ironclaw_identity/`, `crates/ironclaw_openai_compat*/`, `crates/ironclaw_traces/`, `crates/ironclaw_webui/`, `crates/ironclaw_product_workflow/`, `crates/ironclaw_webui*/`, `crates/ironclaw_turns/`, `crates/ironclaw_threads/`, `crates/ironclaw_agent_loop/`, `crates/ironclaw_host_runtime/`, `crates/ironclaw_loop_host/`, `crates/ironclaw_capabilities/` |
...
| **Config & Setup** | `src/config/`, `src/setup/`, `src/cli/`, `crates/ironclaw_config/` |
