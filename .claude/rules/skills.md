...
2. **Scoring** -- Deterministic scoring: keywords (10/5 pts, cap 30) + patterns (20 pts, cap 40) when regex activation is enabled + tags (3 pts, cap 15). `exclude_keywords` veto (score = 0 if any present)
