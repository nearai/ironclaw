...
description: "Entry point to the IronClaw codebase: navigation guide, architecture overview, common tasks, and resource links for contributors."
---
...
The following documentation sections are referenced in navigation but not yet written. These represent planned areas for future wiki expansion:

| Page | Reason | Source |
|------|--------|--------|
<!-- openwiki: broken internal link [quickstart.md#-understanding-the-code] heading anchor "-understanding-the-code" does not exist in "quickstart.md". Fix the href or restore the target, then delete this comment. -->
| `architecture/data-model.md` | Events, runs, threads, turns, capabilities, and state flows — foundational data structures | [quickstart.md navigation](quickstart.md#-understanding-the-code) |
<!-- openwiki: broken internal link [quickstart.md#-understanding-the-code] heading anchor "-understanding-the-code" does not exist in "quickstart.md". Fix the href or restore the target, then delete this comment. -->
| `architecture/security.md` | Kernel/userland boundary, policy enforcement, threat model, sandbox design | [quickstart.md navigation](quickstart.md#-understanding-the-code) |
| `domains/agent-loop.md` | How turns flow through planning, execution, and checkpointing — core agent runtime | [quickstart.md navigation](quickstart.md#-domain-deep-dives) |
| `domains/capabilities.md` | Tool registration, approval, execution, WASM sandbox, MCP integration | [quickstart.md navigation](quickstart.md#-domain-deep-dives) |
| `domains/memory.md` | Event store, snapshots, recovery, semantic search indexing, persistence backends | [quickstart.md navigation](quickstart.md#-domain-deep-dives) |
| `domains/product-workflow.md` | Missions, projects, skills, routines, approvals, user-facing workflows | [quickstart.md navigation](quickstart.md#-domain-deep-dives) |
| `domains/channels.md` | Slack, WebUI, Discord, Telegram, custom channel adapters, multi-platform support | [quickstart.md navigation](quickstart.md#-domain-deep-dives) |
| `reference/glossary.md` | Key terminology: turns, threads, capabilities, missions, projections, etc. | [quickstart.md navigation](quickstart.md#-reference) |
| `reference/api.md` | HTTP endpoints, WebSocket events, CLI commands, OpenAI compatibility | [quickstart.md navigation](quickstart.md#-reference) |
| `reference/configuration.md` | Startup options, environment variables, config.toml schema, policy profiles | [quickstart.md navigation](quickstart.md#-reference) |
| `reference/troubleshooting.md` | Common errors, debugging tips, support resources, FAQ | [quickstart.md navigation](quickstart.md#-reference) |
