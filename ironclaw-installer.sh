...
if [ -n "${IRONCLAW_INSTALLER_GHE_BASE_URL:-}" ]; then
    INSTALLER_BASE_URL="$IRONCLAW_INSTALLER_GHE_BASE_URL"
else
    INSTALLER_BASE_URL="${IRONCLAW_INSTALLER_GITHUB_BASE_URL:-https://github.com}"
fi
if [ -n "${IRONCLAW_DOWNLOAD_URL:-}" ]; then
    ARTIFACT_DOWNLOAD_URL="$IRONCLAW_DOWNLOAD_URL"
elif [ -n "${INSTALLER_DOWNLOAD_URL:-}" ]; then
    ARTIFACT_DOWNLOAD_URL="$INSTALLER_DOWNLOAD_URL"
else
    ARTIFACT_DOWNLOAD_URL="${INSTALLER_BASE_URL}/nearai/ironclaw/releases/download/ironclaw-v0.27.0"
fi
...
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.30.3"},"source":{"app_name":"ironclaw","name":"ironclaw","owner":"nearai","release_type":"github"},"version":"0.27.0"}
EORECEIPT
...
The installer for ironclaw 0.27.0

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/nearai/ironclaw/releases/download/ironclaw-v0.27.0
...
download_binary_and_run_installer() {
    ...
    case "$_artifact_name" in 
        "ironclaw-x86_64-pc-windows-msvc.tar.gz")
            ...
            _checksum_value="e21efc6724d27edfa9f785e882f6d9d5c2738d072c9e4031a0e3f6d5aa7c45ea"
            _bins="ironclaw.exe sandbox_daemon.exe"
            _bins_js_array='"ironclaw.exe","sandbox_daemon.exe"'
            _libs=""
            _libs_js_array=""
            _staticlibs=""
        ...
        "ironclaw-x86_64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="b053ec051e398bd82696714e5feff54a8ce6a74886dea524aeed8b549f31693a"
            _bins="ironclaw sandbox_daemon"
            _bins_js_array='"ironclaw","sandbox_daemon"'
            _libs=""
            _libs_js_array=""
            _staticlibs=""
            _staticlibs_js_array=""
        ...
        "ironclaw-aarch64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="e2b1c9787f55dd0229d5037557a93ede7c3c495cf9f9c192d26db1b6d83c21ed"
            _bins="ironclaw sandbox_daemon"
            _bins_js_array='"ironclaw","sandbox_daemon"'
            _libs=""
            _libs_js_array=""
        ...
        "ironclaw-x86_64-unknown-linux-musl.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="81ea6614a765a69d43d95a29b6c8972360a26354cf1738bdf37953a7526418ee"
            _bins="ironclaw sandbox_daemon"
            _bins_js_array='"ironclaw","sandbox_daemon"'
            _libs=""
            _libs_js_array=""
        ...
        "ironclaw-aarch64-unknown-linux-musl.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="3506a2c90b4d7594e45bcfe77d11f61db73e85a5cc15cfd18896435e0e6dc9da"
            _bins="ironclaw sandbox_daemon"
            _bins_js_array='"ironclaw","sandbox_daemon"'
            _libs=""
            _libs_js_array=""
        ...
        "ironclaw-x86_64-apple-darwin.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="7d47a9313ba3d462d446f7809b3611bbd790c9be1071321c76e785aa3548981f"
            _bins="ironclaw sandbox_daemon"
            _bins_js_array='"ironclaw","sandbox_daemon"'
            _libs=""
            _libs_js_array=""
        ...
        "ironclaw-aarch64-apple-darwin.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="9b855b3119c7e04a70c4d3b5dfe51bfad56246c78787eb4aefd3309b7dbb8d24"
            _bins="ironclaw sandbox_daemon"
            _bins_js_array='"ironclaw","sandbox_daemon"'
            _libs=""
            _libs_js_array=""
