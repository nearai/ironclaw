...
**Reference:** `src/auth/oauth.rs` / `crates/ironclaw_auth/src/loopback_oauth.rs` — `OAUTH_CALLBACK_PORT`, `bind_callback_listener()`
...
**Reference:** `src/auth/oauth.rs` / `crates/ironclaw_auth/src/loopback_oauth.rs` — `html_escape()`
...
**Reference:** `src/auth/oauth.rs` / `crates/ironclaw_auth/src/loopback_oauth.rs` — `wait_for_callback()`
