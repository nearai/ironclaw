...
pub fn model_cost(model_id: &str) -> Option<(Decimal, Decimal)> {
    ...
    match id {
        ...
        | "claude-sonnet-4-5-20250929" => Some((dec!(0.000003), dec!(0.000015))),
        "claude-3-5-haiku-20241022" | "claude-3-5-haiku-latest" | "claude-haiku-4-5-20251001" => {
            Some((dec!(0.0000008), dec!(0.000004)))
        }
        "claude-3-opus-20240229"
        | "claude-3-opus-latest"
        | "claude-opus-4-20250514"
        | "claude-opus-4-6" => Some((dec!(0.000015), dec!(0.000075))),
