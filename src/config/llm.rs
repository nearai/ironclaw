...
mod tests {
    ...
    /// Stub NEARAI_AUTH_URL and NEARAI_BASE_URL to localhost so tests don't
    /// depend on DNS resolution for `private.near.ai`.
    ///
