...
fn default_tools_dir() -> PathBuf {
    dirs::home_dir()
        .map(|h| h.join(".clawyer").join("tools"))
        .unwrap_or_else(|| PathBuf::from(".clawyer/tools"))
}
...
pub enum ToolCommand {
    ...
    Install {
        ...
        /// Target directory for installation (default: ~/.clawyer/tools/)
        #[arg(short, long)]
    ...
    List {
        /// Directory to list tools from (default: ~/.clawyer/tools/)
        #[arg(short, long)]
        dir: Option<PathBuf>,
    ...
    Remove {
        ...
        /// Directory to remove tool from (default: ~/.clawyer/tools/)
        #[arg(short, long)]
        dir: Option<PathBuf>,
    },
    ...
    Info {
        ...
        /// Directory to look for tool (default: ~/.clawyer/tools/)
        #[arg(short, long)]
        dir: Option<PathBuf>,
    },
...
async fn list_tools(dir: Option<PathBuf>, verbose: bool) -> anyhow::Result<()> {
    ...
    if !tools_dir.exists() {
        ...
        println!("Install a tool with: clawyer tool install <path>");
        return Ok(());
    }
...
mod tests {
    ...
    fn test_default_tools_dir() {
        ...
        assert!(dir.to_string_lossy().contains(".clawyer"));
