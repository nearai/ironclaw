...
use crate::db::{
    ConversationStore, Database, JobStore, JudgeVerdictStore, RoutineStore, SandboxStore,
...
impl JudgeVerdictStore for PgBackend {
    async fn record_judge_verdict(
        ...
        self.store
            .record_judge_verdict(tool_name, verdict, attack_type, confidence, reasoning, latency_ms)
            .await
    }
}
