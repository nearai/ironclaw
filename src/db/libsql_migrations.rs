...
"#,
    ...
    (
        26,
        "product_inbound_actions_and_bindings",
        ...
        //   Webhook retries replay the prior outcome instead of double-dispatching.
        // * product_bindings: maps external (adapter, installation, conversation,
        //   actor) tuples to canonical Reborn (tenant, user, thread, agent_id?, project_id?).
        //   Created lazily on first inbound from a previously-unseen conversation.
        //
