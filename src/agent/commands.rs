    ...
    pub(super) async fn handle_system_command(
        ...
        match command {
            "help" => Ok(SubmissionResult::response(concat!(
                ...
                "  /plan enter       Enable read-first plan mode for this thread\n",
                "  /plan exit        Disable thread-level plan mode\n",
                "  /plan-mode status Show whether thread-level plan mode is active\n",
                "\n",
                "Session:\n",
                "  /undo             Undo last turn\n",
