...
use crate::channels::web::handlers::engine::{
    ...
    engine_project_create_handler, engine_project_detail_handler,
    engine_project_get_active_handler, engine_project_set_active_handler,
    engine_project_update_handler, engine_projects_handler, engine_projects_overview_handler,
    engine_thread_assign_project_handler, engine_thread_detail_handler,
...
pub async fn start_server(
    ...
    let protected = Router::new()
        ...
        .route(
            "/api/engine/projects",
            get(engine_projects_handler).post(engine_project_create_handler),
        )
        .route(
        ...
        .route(
            "/api/engine/projects/active",
            get(engine_project_get_active_handler).post(engine_project_set_active_handler),
        )
        .route(
            "/api/engine/projects/{id}",
            get(engine_project_detail_handler).patch(engine_project_update_handler),
        )
        .route(
        ...
        .route(
            "/api/chat/threads/{id}/project",
            post(engine_thread_assign_project_handler),
        )
