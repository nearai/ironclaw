...
// build_turns_from_db_messages is used in tests (via `use super::*`)
#[cfg(test)]
...
// Chat handlers are in handlers/chat.rs. Image conversion helpers remain here
// because they're shared with ws.rs.
...
mod tests {
    ...
    // build_turns_from_db_messages tests and turn_info_from_in_memory_turn tests
    // moved to handlers/chat.rs
    ...
    // is_local_origin tests moved to handlers/chat.rs
}
