...
- **Deep-link URL:** `https://<agent>/#/install/<slug>?slug=&version=&uid=&aid=&ts=&nonce=&sig=&artifact_digest=` parsed by `static/js/core/routing.js` and consumed by `static/js/surfaces/install.js`.
