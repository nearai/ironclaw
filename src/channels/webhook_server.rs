...
mod tests {
    ...
    async fn test_restart_with_addr_rollback_on_bind_failure() {
        ...
        // Try to bind to the same address the server is already using —
        // this reliably fails regardless of privilege level (unlike port 1,
        // which succeeds when running as root).
