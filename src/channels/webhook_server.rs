...
mod tests {
    ...
    async fn test_restart_with_addr_rollback_on_bind_failure() {
        ...
        // Try to bind an address that's already in use (addr1 is occupied by
        // the running server). This reliably fails regardless of whether the
        // process has root/elevated privileges.
