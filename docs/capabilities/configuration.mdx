...
| `SKILLS_REGEX_ACTIVATION_ENABLED` | Enables regex pattern skill auto-activation. Keyword/tag activation and explicit skill mentions still work when disabled. |
