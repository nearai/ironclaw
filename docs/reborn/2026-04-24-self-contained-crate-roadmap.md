...
- `ProcessResultStore` records scoped terminal process output/error records as inline JSON for V1; later output work should move large/sensitive/streaming payloads behind filesystem/artifact references
