...
- runtime/input/output plumbing for non-WASM network I/O policy enforcement, audit-after, output redaction, output limiting, generic runtime environment injection, or credential-account resolution
