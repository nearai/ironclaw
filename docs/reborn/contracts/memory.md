...
**Date:** 2026-04-25
**Target crate:** `crates/ironclaw_memory` (provider-neutral contract) + `crates/extensions/packages/memory-native` (native provider implementation), plus service composition crates
