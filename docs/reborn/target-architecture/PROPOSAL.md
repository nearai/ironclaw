...
│   │                                   [amended 2026-07-29: sits beside the host, not inside packages/]
...
| 54 | `ironclaw_first_party_extensions` | **retain-widen + move** → `extensions/first_party/` (amended 2026-07-29) | §6.8.4; absorbs host_runtime first_party_tools; slack/telegram assets move to their packages |
