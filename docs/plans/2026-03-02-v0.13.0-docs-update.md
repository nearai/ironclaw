...
**Goal:** Update all ironclaw-docs files to accurately reflect the v0.13.0 release, covering 10 new features, 17 bug-fix items, and 3 protocol/quality changes against verified source code.
