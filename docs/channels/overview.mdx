...
<Warning>
These pages document the retained v1 channel runtime. Build and invoke it as `ironclaw-v1`; the canonical `ironclaw` command now runs Reborn and must not be configured with v1 onboarding flags.
</Warning>
