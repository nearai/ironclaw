...
<Warning>
本页记录 retained v1 的 WASM tool CLI。以下命令请使用 `ironclaw-v1`。
Canonical Reborn 的扩展生命周期命令请参阅 [CLI 参考](/reborn-binary#extension)。
</Warning>
...
```bash
ironclaw-v1 tool install ./my-tool.wasm
ironclaw-v1 tool install https://example.com/tools/my-tool.wasm
