...
初始化 canonical Reborn runtime，然后启动交互式 REPL：
...
阅读[快速开始指南](/zh/quickstart)，配置 provider 并发送第一条消息。Profile、生产存储、扩展和 WebUI serve 模式请参阅 [canonical CLI 参考](/reborn-binary)。
