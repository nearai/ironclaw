...
Droplet 创建并加固完成后，就可以开始安装 IronClaw 了。您可以按照[快速开始指南](/zh/quickstart)中的安装步骤来完成部署。
...
接下来阅读[快速开始指南](/zh/quickstart)，配置 provider 并发送第一条消息。Profile、生产存储、扩展和 WebUI serve 模式请参阅 [canonical CLI 参考](/reborn-binary)。
