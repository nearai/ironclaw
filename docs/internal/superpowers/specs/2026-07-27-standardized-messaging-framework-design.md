...
- **Structured guest errors exist:** WASM guests may return typed `GuestFailure` values with `kind`, `code`, optional `message`, and optional `retry_after_ms`
  (`crates/kernel/ironclaw_host_runtime/src/services/wasm_execution.rs:333-394`), code
