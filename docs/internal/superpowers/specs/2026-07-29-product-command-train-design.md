...
| 6 | WebUI results | **Ephemeral** system-notice bubble (Slack-like, #6678's shape). Explicitly ephemeral per the events rule; not a durable timeline event. Durable rendering is a future decision. |
