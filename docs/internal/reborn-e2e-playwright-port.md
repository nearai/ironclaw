...
| `test_extensions.py`, `test_settings_extensions_labels.py`, `test_settings_search.py`, `test_skills.py`, `test_tool_permissions.py`, `test_tool_approval.py`, `test_tool_execution.py`, `test_v2_engine_approval_flow.py` | Covered by Reborn settings search, Skills, Extensions, tool-permission, approval, and tool-execution suites. |
