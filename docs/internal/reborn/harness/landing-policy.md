...
`docs/internal/reborn/production-cutover-readiness-closeout.md`), and the final
...
- If the edit touches a security/compatibility boundary (auth, secrets,
  ...
  contract under `docs/internal/reborn/contracts/`.
...
- Rollback is defined and default-off remains reachable: switch the profile
  ...
  (`docs/internal/reborn/production-cutover-readiness-closeout.md`, "Rollback And
