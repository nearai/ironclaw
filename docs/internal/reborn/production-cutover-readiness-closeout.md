...
| Operator status/config surfaces consuming readiness | #4595, #4593 | #4737, #4736 | `docs/internal/reborn/contracts/operator-observability-backends.md`, `docs/internal/reborn/contracts/operator-effective-config.md` |
