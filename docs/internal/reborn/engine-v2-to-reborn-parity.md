...
| **Project** — unit of context (scopes memory/threads/missions); `types/project.rs` | First-class `ProjectRecord` + membership ACL (`Owner>Editor>Viewer`) over the scoped filesystem substrate | `contracts/storage-placement.md`; plan `docs/internal/plans/2026-06-17-reborn-projects.md` | `ironclaw_identity::projects` (was `ironclaw_projects`; merged 2026-08-05, PROPOSAL §6.4.11) | `crates/domains/ironclaw_identity/tests/project_repository_contract.rs`, `tests/reborn_scope_isolation_suite/reborn_project_scope_isolation_parity.rs`, `tests/reborn_scope_isolation_suite/reborn_identity_project_scope_isolation_parity.rs` | Covered |
