...
| Need | Start with |
| --- | --- |
| Standalone Reborn binary | `crates/app/ironclaw_cli/` and `docs/internal/reborn/onboarding.md` |
| Standalone Reborn onboarding | `docs/internal/reborn/onboarding.md` |
| Production cutover readiness closeout | `docs/internal/reborn/production-cutover-readiness-closeout.md` |
| Standalone Reborn Slack setup | `docs/internal/reborn/setup-slack-for-reborn-binary.md` |
| Porting v1 channels to Reborn surfaces/ChannelAdapters | `docs/internal/reborn/how-to-port-channel-to-reborn.md` |
| Subagents — architecture, background design, roadmap (canonical) | `docs/internal/reborn/subagent-spawn/README.md` |
...
`docs/internal/reborn/contracts/` set over older design notes:
...
| Harness area | Doc |
| --- | --- |
| Local per-worktree environment | `docs/internal/reborn/harness/local-dev.md` |
| Replay and compatibility fixtures | `docs/internal/reborn/harness/replay.md` |
| Logs, events, traces, debug bundles | `docs/internal/reborn/harness/observability.md` |
| Change-category landing policy for review | `docs/internal/reborn/harness/landing-policy.md` |
...
- Reborn lifecycle behavior: `docs/internal/reborn/contracts/extensions.md` and
  `docs/internal/reborn/contracts/skills-extension.md`
