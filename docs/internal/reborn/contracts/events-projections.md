...
**Depends on:** `docs/internal/reborn/contracts/run-state.md`, `docs/internal/reborn/contracts/host-api.md`, `docs/internal/reborn/contracts/communication-delivery-resolution.md`
