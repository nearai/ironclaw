...
**Depends on:** `docs/internal/reborn/contracts/agent-loop-protocol.md`, `docs/internal/reborn/contracts/capability-access.md`, and the owning crate contracts.
**Default loop mechanics:** `docs/internal/reborn/contracts/lightweight-agent-loop.md`
