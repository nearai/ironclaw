...
- Require privileged operations such as bulk export, retention override, and tombstone deletion to carry an explicit reason. Review decisions and delayed credit mutation already require non-empty reasons.
