...
`crates/ironclaw_architecture/tests/ironclaw_retired_taxonomy.rs`.
...
| Second (TypeScript) Playwright harness | `tests/e2e/` already has `ironclaw_webui_harness.py` + fake vendor APIs | never |
