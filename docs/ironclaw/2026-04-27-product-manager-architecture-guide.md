# IronClaw Product Manager Architecture Guide
...
This guide explains how to follow IronClaw architecture changes from a product perspective.
...
This is not a new kernel layer, Rust crate, or service boundary. It is a planning map that translates product features into the IronClaw architecture.

---

## 2. The mental model

IronClaw separates product behavior from safety enforcement.
...
```text
Architecture map: docs/ironclaw/2026-04-25-current-architecture-map.md
Kernel boundary: docs/ironclaw/contracts/kernel-boundary.md
Capability flow: docs/ironclaw/contracts/capabilities.md
Memory: docs/ironclaw/contracts/memory.md
Events/replay: docs/ironclaw/contracts/events-projections.md
Secrets: docs/ironclaw/contracts/secrets.md
Network: docs/ironclaw/contracts/network.md
Extensions: docs/ironclaw/contracts/extensions.md
Turns/loops: docs/ironclaw/contracts/turns-agent-loop.md
```
