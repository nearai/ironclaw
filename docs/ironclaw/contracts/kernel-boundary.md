# IronClaw Contract — Kernel Boundary
...
The IronClaw kernel is the security perimeter. It is defined by what it mediates and secures, not by how much product behavior it performs.
