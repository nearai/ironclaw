# IronClaw process lifecycle contract

**Date:** 2026-04-25
**Status:** V1 contract slice
**Crate:** `crates/ironclaw_processes`
**Depends on:** `docs/ironclaw/contracts/host-api.md`, `docs/ironclaw/contracts/capabilities.md`, `docs/ironclaw/contracts/filesystem.md`, `docs/ironclaw/contracts/events.md`
