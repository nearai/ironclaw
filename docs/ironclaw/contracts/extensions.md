# IronClaw Extensions Contract

**Status:** Draft implementation contract
**Date:** 2026-04-24
**Depends on:** `docs/ironclaw/contracts/host-api.md`, `docs/ironclaw/contracts/filesystem.md`, `crates/ironclaw_host_api`, `crates/ironclaw_filesystem`
