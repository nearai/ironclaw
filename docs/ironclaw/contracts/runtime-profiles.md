# IronClaw runtime profiles contract

**Date:** 2026-04-26
**Status:** Decision guide / profile boundary
**Depends on:** `docs/ironclaw/contracts/runtime-selection.md`, `docs/ironclaw/contracts/capabilities.md`, `docs/ironclaw/contracts/dispatcher.md`, `docs/ironclaw/contracts/filesystem.md`, `docs/ironclaw/contracts/processes.md`, `docs/ironclaw/contracts/resources.md`, `docs/ironclaw/contracts/approvals.md`, `docs/ironclaw/contracts/host-runtime.md`
...
Local profiles are for explicit local operator workflows. They are not a shortcut around IronClaw authority boundaries.
