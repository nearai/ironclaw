# IronClaw Contract — Settings and Configuration
...
Production IronClaw source of truth is:
...
method is a compatibility wrapper over that view while `IronClawServicesApi`
