# IronClaw Contract - Communication Delivery Resolution
...
for a user-visible communication event after IronClaw has already determined that
...
are compatibility wrappers over those views while `IronClawServicesApi` shrinks
