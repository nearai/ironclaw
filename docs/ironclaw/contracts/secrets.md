# IronClaw secrets service contract
...
`ironclaw_secrets` is the scoped secret metadata and lease service for IronClaw.
...
The shared IronClaw runtime HTTP egress service uses this surface to:
...
## 7. IronClaw issue #3088 closeout notes
...
Closed in the current IronClaw slice:
