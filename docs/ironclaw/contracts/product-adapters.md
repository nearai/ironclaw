# IronClaw ProductAdapter contract
...
IronClaw pipeline. Adapters parse external protocol payloads into structured
...
projection read / fetch
  -> caller resolves any opaque product/API id into canonical IronClaw metadata
