# IronClaw script runner contract

**Date:** 2026-04-25
**Status:** V1 contract slice
**Crate:** `crates/ironclaw_scripts`
**Depends on:** `docs/ironclaw/contracts/host-api.md`, `docs/ironclaw/contracts/extensions.md`, `docs/ironclaw/contracts/resources.md`, `docs/ironclaw/contracts/dispatcher.md`
