# IronClaw Contract — `ironclaw_host_api`
...
- `docs/ironclaw/2026-04-24-host-api-invariants-and-authorization.md`
- `docs/ironclaw/2026-04-24-os-like-architecture-design.md`
- `docs/ironclaw/2026-04-24-self-contained-crate-roadmap.md`
- `docs/ironclaw/2026-04-24-existing-code-reuse-map.md`

---

## 1. Purpose

`ironclaw_host_api` defines the shared vocabulary for IronClaw authority boundaries.
...
| `VirtualPath` | canonical IronClaw namespace path like `/projects/p1/threads/t1` | only through trusted host APIs |
...
`ironclaw_host_api::ingress` defines route and policy vocabulary for IronClaw
...
The global IronClaw scope model must preserve `AgentId` as a first-class optional scope.
