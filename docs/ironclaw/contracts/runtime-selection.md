# IronClaw runtime selection contract

**Date:** 2026-04-26
**Status:** Decision guide / contract boundary
**Depends on:** `docs/ironclaw/contracts/capabilities.md`, `docs/ironclaw/contracts/dispatcher.md`, `docs/ironclaw/contracts/processes.md`, `docs/ironclaw/contracts/scripts.md`, `docs/ironclaw/contracts/wasm.md`, `docs/ironclaw/contracts/host-runtime.md`
**Profile presets:** `docs/ironclaw/contracts/runtime-profiles.md`

---

## 1. Purpose

IronClaw has several execution needs that look similar but have different security and ergonomics requirements:
