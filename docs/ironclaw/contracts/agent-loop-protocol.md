# IronClaw agent loop protocol contract

**Date:** 2026-04-25
**Status:** Draft contract
**Depends on:** `docs/ironclaw/2026-04-24-os-like-architecture-design.md`, `docs/ironclaw/contracts/runtime-workflows.md`, `docs/ironclaw/contracts/capability-access.md`, `docs/ironclaw/contracts/run-state.md`
**Reference loop mechanics:** `docs/ironclaw/contracts/lightweight-agent-loop.md`

---

## 1. Purpose

Define the parent loop protocol boundary for IronClaw and make the layering explicit:
...
- stronger reply typing does not become a new host-wide parent protocol branch unless IronClaw explicitly revisits the contract
...
This preserves the IronClaw architecture law that effectful work flows through:
