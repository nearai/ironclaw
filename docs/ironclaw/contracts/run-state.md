# IronClaw run-state contract

**Date:** 2026-04-25
**Status:** V1 contract slice
**Crate:** `crates/ironclaw_run_state`
**Depends on:** `docs/ironclaw/contracts/host-api.md`, `docs/ironclaw/contracts/filesystem.md`, `docs/ironclaw/contracts/capabilities.md`
...
This is intentional. Production can later back `/engine` with a DB-backed filesystem/document-store implementation while IronClaw service crates continue depending on host storage traits instead of Postgres/libSQL internals.
