# IronClaw lightweight agent loop contract

**Date:** 2026-04-26
**Status:** Decision guide / reference loop contract
**Inspired by:** `badlogic/pi-mono/packages/agent` loop mechanics
**Depends on:** `docs/ironclaw/contracts/agent-loop-protocol.md`, `docs/ironclaw/contracts/runtime-workflows.md`, `docs/ironclaw/contracts/capabilities.md`, `docs/ironclaw/contracts/run-state.md`, `docs/ironclaw/contracts/approvals.md`, `docs/ironclaw/contracts/events.md`, `docs/ironclaw/contracts/runtime-selection.md`, `docs/ironclaw/contracts/runtime-profiles.md`

---

## 1. Purpose

Define the default shipped lightweight agent loop for IronClaw as a reference loop implementation, not as kernel behavior.
...
But it is not a dependency on `pi-mono`, and it does not import `pi-mono` authority semantics. It is a IronClaw-native loop that runs inside IronClaw host contracts.
