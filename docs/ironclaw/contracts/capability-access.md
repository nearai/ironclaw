# IronClaw capability access contract

**Date:** 2026-04-25
**Status:** V1 contract slice
**Crate:** `crates/ironclaw_authorization`
**Depends on:** `docs/ironclaw/contracts/host-api.md`
...
See `docs/ironclaw/contracts/approvals.md` for how approval resolution issues leases and how resume claims/consumes them.
