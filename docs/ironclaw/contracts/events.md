# IronClaw events and audit contract

**Date:** 2026-04-25
**Status:** V1 contract slice
**Crate:** `crates/ironclaw_events`
**Depends on:** `docs/ironclaw/contracts/host-api.md`, `docs/ironclaw/contracts/dispatcher.md`, `docs/ironclaw/contracts/live-vertical-slice.md`
...
`JsonlEventSink` and `JsonlAuditSink` are append-style JSONL persistence helpers over the IronClaw filesystem contract.
...
```rust
scoped_runtime_event_log_path(&scope, "ironclaw-demo.jsonl")
...
```text
/engine/tenants/{tenant_id}/users/{user_id}/agents/{agent_id-or-_none}/events/runtime/ironclaw-demo.jsonl
