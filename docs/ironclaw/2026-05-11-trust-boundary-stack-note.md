# IronClaw Trust-Boundary Stack Note

**Date:** 2026-05-11
**Issue:** #3492 — Establish trust-boundary hardening baseline

This trust-boundary-stack note maps current open IronClaw PRs to the trust-boundary baseline so reviewers and agents can distinguish slice-owned fixes from deferred follow-up work. It is not a claim that every PR below already satisfies every invariant.
...
### PR #3471 — GitHub issue #3431: [IronClaw] Add MemoryPromptContextService production adapter
...
### PR #3470 — GitHub issue #3432: [IronClaw] Add deterministic trust-aware SkillContextService
...
### PR #3469 — GitHub issue #3433: [IronClaw] Complete HostManagedModelGateway budget, credential, and redaction tests
...
### PR #3468 — GitHub issue #3451: [IronClaw] Add direct DB operations for loop checkpoint mappings
...
### PR #3462 — [IronClaw] Add user-selectable model routes and provider pool
...
### PR #3454 — Add IronClaw loop capability host-runtime adapter slice
...
### PR #3400 — Add IronClaw text-only model reply driver
...
For broader IronClaw policy/status changes, include:
