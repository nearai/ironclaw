...
package name. The root integration-test harness is marked `dist = false`;
...
CLI package carries its own WiX identity and a checked-in canonical `ironclaw`
Product name for Windows installers.
