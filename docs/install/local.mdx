...
<Tabs>
  ...
  <Tab title="Windows (WSL2)">
    ...
    - In WSL2: `http://127.0.0.1:3001`
    - From Windows: `http://localhost:3001` (WSL2 forwards ports automatically)
  ...
  <Tab title="Windows (Native)">
    ...
    Or manually:
    1. Download `ironclaw-x86_64-pc-windows-msvc.zip` from [releases](https://github.com/ironclaw-ai/ironclaw/releases)
...
3. **Open Web Gateway**: `http://127.0.0.1:3001`
