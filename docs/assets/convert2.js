...
const outputPath = process.argv[3] || excalidrawPath.replace('.excalidraw', '.svg');

if (!excalidrawPath) {
  console.error('Usage: node convert2.js <input.excalidraw> [output.svg]');
  process.exit(1);
}
...
console.log(`Converted ${excalidrawPath} to ${outputPath}`);
