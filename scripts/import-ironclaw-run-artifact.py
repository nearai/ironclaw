#!/usr/bin/env python3
"""Convert a downloaded IronClaw run artifact into a reviewable LLM trace candidate."""
...
def trace_candidate(artifact: dict[str, Any], model_override: str | None) -> dict[str, Any]:
    ...
    model_name = model_override or (captured_models[0] if captured_models else "ironclaw-qa-import")
    tools = list(
