        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(
                ...
                [
                    ...
                    "webui_v2_settings_restart_banner_browser_smoke",
                ],
            )
            self.assertIn("settings-restart.test.mjs", commands[0]["command"])
            self.assertIn(
                "test_reborn_webui_v2_settings_restart_browser.py",
                commands[1]["command"],
            )
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(
                ...
                [
                    ...
                    "webui_v2_settings_toolbar_browser_smoke",
                ],
            )
            ...
            self.assertIn(
                "test_reborn_webui_v2_settings_toolbar_browser.py",
                commands[1]["command"],
            )
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(
                ...
                [
                    ...
                    "webui_v2_admin_console_browser_smoke",
                ],
            )
            self.assertIn("admin-contracts.test.mjs", commands[0]["command"])
            self.assertIn(
                "test_reborn_webui_v2_admin_console_browser.py",
                commands[1]["command"],
            )
