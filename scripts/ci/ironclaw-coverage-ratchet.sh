...
# aggregation ironclaw-coverage-summary.sh already computes (via
# scripts/ci/lib/ironclaw_coverage_lcov.py — reused here, not reimplemented)
...
#
# Usage:
#   ironclaw-coverage-ratchet.sh <lcov-path> <exemptions-toml-path> <floor-toml-path>
#
...
lcov_path="${1:?usage: ironclaw-coverage-ratchet.sh <lcov-path> <exemptions-toml-path> <floor-toml-path>}"
exemptions_path="${2:?usage: ironclaw-coverage-ratchet.sh <lcov-path> <exemptions-toml-path> <floor-toml-path>}"
floor_path="${3:?usage: ironclaw-coverage-ratchet.sh <lcov-path> <exemptions-toml-path> <floor-toml-path>}"
