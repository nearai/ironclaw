...
assert_flags ironclaw_turn_runner ""
...
# compiles it — see package-feature-flags.sh's ironclaw_composition arm.
assert_flags ironclaw_composition "--features test-support,memory-mem0"
