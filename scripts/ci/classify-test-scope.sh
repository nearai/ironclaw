...
is_shared_test_path() {
  ...
  case "$path" in
    ...
    scripts/ci/classify-test-scope.sh|scripts/ci/test-classify-test-scope.sh|scripts/ci/package-feature-flags.sh)
      return 0
      ;;
    .github/workflows/test.yml|.github/workflows/reborn-integration.yml|.github/workflows/reborn-e2e.yml|.github/workflows/nightly-deep-ci.yml)
      return 0
      ;;
...
is_reborn_test_path() {
  local path="$1"
  case "$path" in
    docs/reborn/*|scripts/reborn-e2e-rust.sh|scripts/ci/run-reborn-root-partition.sh|scripts/ci/validate-reborn-tests-workflow.py|tests/reborn_*|tests/support/reborn/*|tests/e2e/scenarios/test_reborn_*)
      return 0
      ;;
