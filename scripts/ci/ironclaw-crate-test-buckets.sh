  ...
  def bucket_map:
    {
      ...
      ironclaw_runner: "ironclaw-core",
      ironclaw: "ironclaw-core",
      ironclaw_config: "ironclaw-core",
      ironclaw_event_store: "ironclaw-core",
      ironclaw_identity: "ironclaw-core",
      ironclaw_openai_compat: "ironclaw-core",
