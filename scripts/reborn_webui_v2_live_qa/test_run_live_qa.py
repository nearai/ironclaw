...
class RebornWebUiV2LiveQaRunnerTests(unittest.TestCase):
    ...
    def test_default_suite_includes_github_connect_after_generated_auth_seed(self):
        ...
        self.assertIn("webui_auth_gate", default_cases)
        self.assertIn("webui_api_auth_security_headers", default_cases)
        self.assertIn("webui_static_shell_csp_nonce", default_cases)
        self.assertIn("webui_projects_browser", default_cases)
        self.assertIn("webui_workspace_browser", default_cases)
        ...
        self.assertEqual(
            run_live_qa.CASES["webui_auth_gate"].qa_matrix_test_ids,
            [
                "REBCLI-055-TC-02",
                "REBCLI-055-TC-05",
                "REBCLI-064-TC-01",
        ...
        self.assertEqual(
            run_live_qa.CASES["webui_projects_browser"].qa_matrix_test_ids,
            [
                "REBCLI-066-TC-01",
                "REBCLI-066-TC-02",
                "REBCLI-066-TC-03",
        ...
        self.assertEqual(
            run_live_qa.CASES["webui_workspace_browser"].qa_matrix_test_ids,
            [
                "REBCLI-066-TC-04",
                "REBCLI-066-TC-06",
                "REBCLI-084-TC-01",
        ...
        self.assertEqual(
            ...
            ["REBCLI-057-TC-02", "REBCLI-057-TC-04", "REBCLI-057-TC-05"],
        )
        self.assertEqual(
            run_live_qa.CASES[
    ...
    def test_case_manifest_distinguishes_targeted_from_placeholder_gates(self):
        ...
        self.assertEqual(
            cases["webui_auth_gate"]["qa_matrix_test_ids"],
            [
                "REBCLI-055-TC-02",
                "REBCLI-055-TC-05",
                "REBCLI-064-TC-01",
        ...
        self.assertEqual(
            cases["webui_projects_browser"]["qa_matrix_test_ids"],
            [
                "REBCLI-066-TC-01",
                "REBCLI-066-TC-02",
                "REBCLI-066-TC-03",
        ...
        self.assertEqual(
            cases["webui_workspace_browser"]["qa_matrix_test_ids"],
            [
                "REBCLI-066-TC-04",
                "REBCLI-066-TC-06",
                "REBCLI-084-TC-01",
