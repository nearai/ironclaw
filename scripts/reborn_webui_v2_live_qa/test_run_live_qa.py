...
class RebornWebUiV2LiveQaRunnerTests(unittest.TestCase):
    ...
    def test_live_canary_workflow_shards_cover_non_telegram_qa_suite(self):
        ...
        self.assertNotIn("cp target/debug/ironclaw target/debug/ironclaw-reborn", prepare_body)
        self.assertIn(
            "ironclaw-reborn.tar.gz ironclaw",
            prepare_body,
        )
        ...
        self.assertNotIn("cp target/debug/ironclaw target/debug/ironclaw-reborn", reborn_e2e)
        self.assertIn(
            "ironclaw-reborn.tar.gz\" ironclaw",
            reborn_e2e,
        )
