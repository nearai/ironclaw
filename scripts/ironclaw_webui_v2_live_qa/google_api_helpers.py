"""Google API polling helpers for IronClaw WebUI v2 live QA."""
...
from scripts.ironclaw_webui_v2_live_qa.env_helpers import _first_env_value
...
def _latest_google_id_match(
    ...
    for pattern in patterns:
        for match in pattern.finditer(text):
            ...
            if not candidate.startswith("IRONCLAW_QA_"):
