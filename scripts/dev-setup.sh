...
#   cargo test --all-features         # full test suite (requires Node.js/pnpm for WebUI bundle)
...
echo "  cargo test --all-features            # Full test suite (requires Node.js/pnpm for WebUI bundle)"
echo "  cargo clippy --all-features          # Lint all code (requires Node.js/pnpm for WebUI bundle)"
