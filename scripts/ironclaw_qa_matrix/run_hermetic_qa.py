#!/usr/bin/env python3
"""Hermetic QA matrix runner for IronClaw WebUI v2 and ResponsesAPI rows.
...
DEFAULT_OUTPUT_DIR = ROOT / "artifacts" / "ironclaw-qa-matrix-hermetic"
DEFAULT_TIMEOUT_SECONDS = 45 * 60
PROVIDER = "ironclaw-qa-matrix"
MODE = "hermetic"

REMOVED_CI_OWNED_CASES = {
    "openai_compat_owner_crate_regression",
    "ironclaw_cli_credential_refresh_settings_regression",
    "ironclaw_cli_docker_railway_entrypoint_regression",
    "ironclaw_cli_trigger_poller_settings_regression",
    "ironclaw_operator_logs_service_regression",
    ...
    [
        _case(
            ...
            _pytest_command(
                ...
                [
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_openai_compat_route_mounts_require_bearer_served",
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_openai_compat_route_mounts_authenticated_aliases_served",
                ],
            ),
        ...
        _case(
            ...
            _pytest_command(
                ...
                [
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_responses_lookup_and_cancel_missing_id_match_not_found_shape",
                ],
            ),
        ...
        _case(
            ...
            "Served IronClaw ResponsesAPI E2E",
            ...
            _pytest_command(
                ...
                [
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_responses_repeated_external_tools_round_trip",
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_responses_external_tool_failure_output_reaches_llm",
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_responses_rejects_wrong_external_tool_call_id",
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_responses_mixed_internal_and_external_tools_same_assistant_response",
                ],
            ),
        ...
        _case(
            ...
            _pytest_command(
                ...
                [
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_chat_completions_non_streaming_served",
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_chat_completions_idempotency_replay_and_conflict_served",
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_chat_completions_streaming_raw_sse_served",
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_chat_completions_auth_and_validation_served",
                ],
            ),
        ...
        _case(
            ...
            _pytest_command(
                ...
                [
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_models_v1_lists_configured_mock_model",
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_models_api_v1_alias_matches_v1_models",
                    "tests/e2e/scenarios/test_ironclaw_responses_api.py::test_ironclaw_models_requires_auth",
                ],
            ),
        ...
        _case(
            ...
            _pytest_command(
                ...
                ["tests/e2e/scenarios/test_ironclaw_webui_v2_session_api.py"],
            ),
        ...
        _case(
            ...
            _pytest_command(
                ...
                ["tests/e2e/scenarios/test_ironclaw_webui_v2_streaming_run_control_api.py"],
            ),
        ...
        _case(
            ...
            _pytest_command(
                ...
                [
                    "tests/e2e/scenarios/test_ironclaw_webui_v2_automation_trace_outbound_api.py"
                ],
            ),
        ...
        _case(
            ...
            _pytest_command(
                ...
                ["tests/e2e/scenarios/test_ironclaw_webui_v2_extensions_api.py"],
            ),
        ...
        _case(
            ...
            _pytest_command(
                ...
                ["tests/e2e/scenarios/test_ironclaw_webui_v2_skills_api.py"],
            ),
        ...
        _case(
            ...
            _pytest_command(
                ...
                ["tests/e2e/scenarios/test_ironclaw_webui_v2_filesystem_api.py"],
            ),
        ...
        _case(
            ...
            _pytest_command(
                ...
                ["tests/e2e/scenarios/test_ironclaw_webui_v2_product_auth_api.py"],
            ),
        ...
        _case(
            ...
            _pytest_command(
                ...
                ["tests/e2e/scenarios/test_ironclaw_webui_v2_operator_api.py"],
            ),
...
def write_case_manifest(output_dir: Path, selected_cases: list[str]) -> Path:
    ...
    matrix_path = os.environ.get("IRONCLAW_QA_MATRIX_PATH", "").strip()
    manifest = {
