...
//!
//! Proves the full headline promise end-to-end against a real IronClaw run:
...
use ironclaw_support::doubles::RecordingTestCapabilityPort;
...
/// external retry.
#[tokio::test]
async fn ironclaw_single_stale_model_request_redrives_in_loop_to_completion() {
    let model_gateway = IronClawTraceReplayModelGateway::with_scripted_steps([
        IronClawModelReplayStep::ModelError {
...
#[tokio::test]
async fn ironclaw_model_failure_is_retryable_and_retry_resumes_to_completion() {
    let model_gateway = IronClawTraceReplayModelGateway::with_scripted_steps([
...
#[tokio::test]
async fn ironclaw_invalid_model_request_fails_without_in_loop_retry() {
    let model_gateway = IronClawTraceReplayModelGateway::with_scripted_steps([
        IronClawModelReplayStep::ModelError {
...
#[tokio::test]
async fn ironclaw_inflight_model_cancelled_preserves_interrupted_unexpectedly() {
    let model_gateway = IronClawTraceReplayModelGateway::with_scripted_steps([
        IronClawModelReplayStep::ModelError {
...
#[tokio::test]
async fn ironclaw_capability_failure_is_retryable_and_retry_resumes_to_completion() {
    let model_gateway = IronClawTraceReplayModelGateway::with_scripted_steps([
