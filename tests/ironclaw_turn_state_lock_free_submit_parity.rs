...
#[tokio::test]
async fn ironclaw_user_submit_completes_while_another_turn_state_write_is_blocked() {
    ...
    let mut blocked_harness =
        IronClawBinaryE2EHarness::with_model_gateway_scope_initial_actor_installation_shared_storage(
            ROOM,
            "alice",
