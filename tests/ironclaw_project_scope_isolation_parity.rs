...
#[tokio::test]
async fn ironclaw_project_scope_isolation_parity() {
    ...
    let mut project_a = IronClawBinaryE2EHarness::with_model_gateway_scope_shared_storage(
        ROOM,
    ...
    let mut project_b = IronClawBinaryE2EHarness::with_model_gateway_scope_shared_storage(
        ROOM,
        IronClawTraceReplayModelGateway::with_responses([
