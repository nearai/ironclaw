...
use clawyer::channels::Channel;
use clawyer::channels::wasm::{
...
use clawyer::pairing::PairingStore;
...
mod loader_tests {
    ...
    async fn test_discover_channels_empty_dir() {
        ...
        let channels = clawyer::channels::wasm::discover_channels(dir.path())
            .await
...
mod message_emission_tests {
    use super::*;
    use clawyer::channels::wasm::{ChannelHostState, EmittedMessage};
