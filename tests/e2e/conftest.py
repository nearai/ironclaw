...
def ironclaw_reborn_binary():
    """Ensure the shipping binary is built with the WebChat v2 surface.

    Its WebUI v2 SPA and ``serve`` subcommand are compiled unconditionally.
    Returns the binary path used by the Reborn WebUI v2 scenarios.
    """
