"""Served IronClaw WebUI v2 operator and LLM configuration API tests.
...
async def test_ironclaw_v2_operator_and_llm_routes_require_bearer_served(ironclaw_v2_server):
...
async def test_ironclaw_v2_llm_provider_config_round_trip_served(
    ironclaw_v2_server, mock_llm_server
):
    ...
    async with httpx.AsyncClient(headers=headers) as client:
        initial = await client.get(
            f"{ironclaw_v2_server}/api/webchat/v2/llm/providers",
            timeout=15,
        )
        ...
        models = await client.post(
            f"{ironclaw_v2_server}/api/webchat/v2/llm/list-models",
            json=probe_payload,
            timeout=15,
        )
        ...
        probe = await client.post(
            f"{ironclaw_v2_server}/api/webchat/v2/llm/test-connection",
            json=probe_payload,
            timeout=15,
        )
        ...
        active = await client.post(
            f"{ironclaw_v2_server}/api/webchat/v2/llm/active",
        ...
        delete = await client.post(
            f"{ironclaw_v2_server}/api/webchat/v2/llm/providers/qa-provider/delete",
            timeout=15,
        )
...
async def test_ironclaw_v2_operator_config_status_and_logs_served(ironclaw_v2_server):
    headers = ironclaw_bearer_headers()
    async with httpx.AsyncClient(headers=headers) as client:
        config = await client.get(
            f"{ironclaw_v2_server}/api/webchat/v2/operator/config",
            timeout=15,
        )
        ...
        set_config = await client.post(
            f"{ironclaw_v2_server}/api/webchat/v2/operator/config/agent.auto_approve_tools",
            json={"value": True},
            timeout=15,
        )
        ...
        validate = await client.post(
            f"{ironclaw_v2_server}/api/webchat/v2/operator/config/validate",
        ...
        invalid_key = await client.get(
            f"{ironclaw_v2_server}/api/webchat/v2/operator/config/BadKey",
            timeout=15,
        )
        assert invalid_key.status_code == 400

        status = await client.get(
            f"{ironclaw_v2_server}/api/webchat/v2/operator/status",
            timeout=15,
        )
        ...
        diagnostics = await client.get(
            f"{ironclaw_v2_server}/api/webchat/v2/operator/diagnostics",
            timeout=15,
        )
        ...
        logs = await client.get(
            f"{ironclaw_v2_server}/api/webchat/v2/operator/logs",
