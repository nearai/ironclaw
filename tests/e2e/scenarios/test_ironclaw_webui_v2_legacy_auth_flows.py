"""Legacy product-auth prompt coverage ported to IronClaw WebUI v2."""
...
async def test_ironclaw_legacy_manual_token_auth_prompt_submits_and_resumes_gate(
...
async def test_ironclaw_legacy_manual_token_not_retained_in_browser(
    ironclaw_v2_server, ironclaw_v2_browser
):
...
async def test_ironclaw_legacy_manual_token_submit_failure_keeps_gate_retryable(
    ironclaw_v2_server, ironclaw_v2_browser
):
    context, page, manual_token_requests, resolve_requests = await _open_stubbed_auth_thread(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_manual_token_cancel_resolves_gate_without_token_submit(
    ironclaw_v2_server, ironclaw_v2_browser
):
    context, page, manual_token_requests, resolve_requests = await _open_stubbed_auth_thread(
        ironclaw_v2_server, ironclaw_v2_browser
...
async def test_ironclaw_legacy_auth_prompt_does_not_duplicate_as_assistant_text(
    ironclaw_v2_server, ironclaw_v2_browser
):
...
async def test_ironclaw_legacy_auth_prompt_replaces_existing_prompt(
    ironclaw_v2_server, ironclaw_v2_browser
):
    context, page, manual_token_requests, _resolve_requests = await _open_stubbed_auth_thread(
        ironclaw_v2_server, ironclaw_v2_browser
...
async def test_ironclaw_legacy_auth_prompt_does_not_block_other_thread(
    ironclaw_v2_server, ironclaw_v2_browser
):
    """Port foreign-thread auth isolation to IronClaw's route-scoped auth gate state."""
    context, page, _manual_token_requests, _resolve_requests = await _open_stubbed_auth_thread(
        ironclaw_v2_server,
        ironclaw_v2_browser,
        thread_records=[
...
async def test_ironclaw_legacy_oauth_prompt_opens_https_authorization_only(
    ironclaw_v2_server, ironclaw_v2_browser
):
...
async def test_ironclaw_legacy_notion_oauth_prompt_renders_provider_label(
    ironclaw_v2_server, ironclaw_v2_browser
):
    context, page, _manual_token_requests, _resolve_requests = await _open_stubbed_auth_thread(
        ironclaw_v2_server, ironclaw_v2_browser
...
async def test_ironclaw_legacy_gsuite_oauth_prompt_renders_authorization_action(
    ironclaw_v2_server, ironclaw_v2_browser
):
    context, page, _manual_token_requests, _resolve_requests = await _open_stubbed_auth_thread(
        ironclaw_v2_server, ironclaw_v2_browser
...
async def test_ironclaw_legacy_oauth_callback_completion_clears_matching_gate(
    ironclaw_v2_server, ironclaw_v2_browser
):
    context, page, _manual_token_requests, _resolve_requests = await _open_stubbed_auth_thread(
        ironclaw_v2_server, ironclaw_v2_browser
...
async def test_ironclaw_legacy_oauth_callback_for_other_gate_keeps_prompt_visible(
    ironclaw_v2_server, ironclaw_v2_browser
):
    context, page, _manual_token_requests, _resolve_requests = await _open_stubbed_auth_thread(
        ironclaw_v2_server, ironclaw_v2_browser
...
async def test_ironclaw_legacy_oauth_prompt_rejects_non_https_authorization_url(
    ironclaw_v2_server, ironclaw_v2_browser
):
    context, page, _manual_token_requests, _resolve_requests = await _open_stubbed_auth_thread(
        ironclaw_v2_server, ironclaw_v2_browser
