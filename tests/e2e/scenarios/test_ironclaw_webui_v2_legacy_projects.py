"""Legacy project overview coverage ported to IronClaw WebChat v2."""
...
async def _open_mocked_projects_page(ironclaw_v2_server, ironclaw_v2_browser):
    ...
    try:
        ...
        await page.goto(
            f"{ironclaw_v2_server}/projects?token={IRONCLAW_V2_AUTH_TOKEN}"
        )
...
async def test_ironclaw_legacy_projects_overview_search_and_open_workspace(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_projects_page(ironclaw_v2_server, ironclaw_v2_browser)
    try:
        page = harness["page"]
...
async def test_ironclaw_legacy_projects_search_no_match_can_be_cleared(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_projects_page(ironclaw_v2_server, ironclaw_v2_browser)
    try:
...
async def test_ironclaw_legacy_project_creation_opens_seeded_chat_thread(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_projects_page(ironclaw_v2_server, ironclaw_v2_browser)
    try:
...
async def test_ironclaw_legacy_project_workspace_starts_scoped_chat_thread(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_projects_page(ironclaw_v2_server, ironclaw_v2_browser)
    try:
...
async def test_ironclaw_legacy_project_workspace_lists_and_downloads_files(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_projects_page(ironclaw_v2_server, ironclaw_v2_browser)
    try:
