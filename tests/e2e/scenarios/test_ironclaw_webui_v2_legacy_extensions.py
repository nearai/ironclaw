"""Legacy extension lifecycle coverage ported to IronClaw WebChat v2."""
...
async def _open_mocked_extensions_page(
    ...
    *,
    ...
    await page.goto(f"{ironclaw_v2_server}/extensions/{tab}?token={IRONCLAW_V2_AUTH_TOKEN}")
...
async def test_ironclaw_legacy_extensions_registry_search_and_install(
...
async def test_ironclaw_v2_extension_registry_renders_while_installed_list_is_pending(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_extensions_page_refetches_on_revisit(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_extensions_catalog_failure_shows_retry(
    ironclaw_v2_server, ironclaw_v2_browser
):
    context = await ironclaw_v2_browser.new_context(viewport={"width": 1280, "height": 720})
    page = await context.new_page()
    ...
    try:
        await page.goto(
            f"{ironclaw_v2_server}/extensions/registry?token={IRONCLAW_V2_AUTH_TOKEN}"
        )
        ...
        await page.goto(
            f"{ironclaw_v2_server}/extensions/channels?token={IRONCLAW_V2_AUTH_TOKEN}"
        )
...
async def test_ironclaw_legacy_extensions_enrichment_failure_preserves_registry(
    ironclaw_v2_server, ironclaw_v2_browser
):
    context = await ironclaw_v2_browser.new_context(viewport={"width": 1280, "height": 720})
    page = await context.new_page()
...
async def test_ironclaw_legacy_extensions_offline_attempts_catalog_requests(
    ironclaw_v2_server, ironclaw_v2_browser
):
    context = await ironclaw_v2_browser.new_context(viewport={"width": 1280, "height": 720})
    page = await context.new_page()
    ...
    try:
        async with page.expect_response("**/api/webchat/v2/llm/providers"):
            await page.goto(
                f"{ironclaw_v2_server}/settings?token={IRONCLAW_V2_AUTH_TOKEN}"
            )
        await expect(
            page.locator(
...
async def test_ironclaw_legacy_extensions_registry_search_no_match(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_extensions_multiple_installs_remain_listed(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_extensions_install_failure_keeps_registry_entry_available(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_extensions_install_auth_url_opens_popup(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_extensions_install_auth_url_requires_https(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_install_setup_required_channel_opens_setup_modal(
    ironclaw_v2_server, ironclaw_v2_browser
):
    setup_channel = {
        **AVAILABLE_CHANNEL,
...
async def test_ironclaw_legacy_extensions_installed_actions(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_activate_success_marks_extension_active_with_capabilities(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_extensions_remove_cancel_keeps_card(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_extensions_remove_failure_keeps_card(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_extensions_remove_clears_installed_state(
    ironclaw_v2_server, ironclaw_v2_browser
):
...
async def test_ironclaw_legacy_extensions_reinstall_after_remove_requires_setup_again(
    ironclaw_v2_server, ironclaw_v2_browser
):
    configured_tool = {
        **CONFIG_TOOL,
...
async def test_ironclaw_legacy_extensions_null_tools_render_no_capabilities(
    ironclaw_v2_server, ironclaw_v2_browser
):
...
async def test_ironclaw_legacy_activate_failure_keeps_extension_inactive(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_activate_auth_url_requires_https(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_activate_auth_url_accepts_uppercase_https(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_channel_connect_label_depends_on_authentication(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_channel_setup_required_has_single_connect_action(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_channel_reconnect_opens_setup_modal_without_activate(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_channel_pairing_redeems_trimmed_code(
    ironclaw_v2_server, ironclaw_v2_browser
):
...
async def test_ironclaw_legacy_channel_pairing_enter_key_submits_code(
    ironclaw_v2_server, ironclaw_v2_browser
):
    # Pairing is a connect affordance on the channel surface (strategy
    # `inbound_proof_code`), not a lifecycle state: the bot token is saved
...
async def test_ironclaw_legacy_channel_pairing_failure_keeps_code_for_retry(
    ironclaw_v2_server, ironclaw_v2_browser
):
    # Pairing is a connect affordance on the channel surface (strategy
    # `inbound_proof_code`), not a lifecycle state: the bot token is saved
...
async def test_ironclaw_legacy_configure_modal_saves_manual_secret_and_fields(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_configure_modal_renders_field_variants(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_configure_modal_setup_url_requires_https(
    ironclaw_v2_server, ironclaw_v2_browser
):
...
async def test_ironclaw_legacy_configure_handles_selector_sensitive_package_ids(
    ironclaw_v2_server, ironclaw_v2_browser
):
...
async def test_ironclaw_legacy_configure_modal_blank_existing_secret_is_not_submitted(
    ironclaw_v2_server, ironclaw_v2_browser
):
    configured_tool = {
        **CONFIG_TOOL,
...
async def test_ironclaw_legacy_configure_modal_save_failure_stays_open(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_configure_modal_setup_load_failure_is_visible(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_configure_modal_auto_resolved_setup_has_no_manual_fields(
    ironclaw_v2_server, ironclaw_v2_browser
):
    auto_resolved_tool = {
        **OAUTH_TOOL,
...
async def test_ironclaw_legacy_configure_modal_dismisses_without_saving(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_configure_modal_enter_key_submits(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_telegram_configure_hosts_pairing_panel(
    ironclaw_v2_server, ironclaw_v2_browser
):
...
async def test_ironclaw_legacy_configure_oauth_localizes_https_authorization_error(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_configure_oauth_start_failure_stays_visible(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
...
async def test_ironclaw_legacy_configure_oauth_accepts_uppercase_https_url(
    ironclaw_v2_server, ironclaw_v2_browser
):
    authorization_url = (
...
async def test_ironclaw_legacy_extensions_channels_and_mcp_tabs_render(
    ironclaw_v2_server, ironclaw_v2_browser
):
    harness = await _open_mocked_extensions_page(
        ironclaw_v2_server,
    ...
    try:
        ...
        await page.goto(f"{ironclaw_v2_server}/extensions/mcp?token={IRONCLAW_V2_AUTH_TOKEN}")
        await page.wait_for_function(
