...
CHAT_PROMPT = (
    ...
    "  goal = 'IMPORTANT: Before calling the gmail tool you MUST first "
    "call tool_activate(name=\"gmail\") so the credentials get registered. "
    "After tool_activate succeeds, use the gmail tool with action "
    "create_draft to send a draft to owner@example.com with subject "
    "\"Test mission #3133\" and body \"Mock draft from the IronClaw e2e "
    "test.\". Always call tool_activate first.'\n"
