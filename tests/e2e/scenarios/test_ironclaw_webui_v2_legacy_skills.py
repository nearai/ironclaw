"""Legacy Skills settings lifecycle coverage ported to IronClaw WebChat v2."""
...
async def _open_mocked_skills_page(ironclaw_v2_server, ironclaw_v2_browser, *, initial_skills=None):
    ...
    await page.goto(f"{ironclaw_v2_server}/settings/skills?token={IRONCLAW_V2_AUTH_TOKEN}")
...
async def test_ironclaw_legacy_skills_tab_visible(ironclaw_v2_server, ironclaw_v2_browser):
    harness = await _open_mocked_skills_page(ironclaw_v2_server, ironclaw_v2_browser)
    try:
        page = harness["page"]
...
async def test_ironclaw_legacy_skills_add_edit_delete(ironclaw_v2_server, ironclaw_v2_browser):
    harness = await _open_mocked_skills_page(ironclaw_v2_server, ironclaw_v2_browser)
    try:
        page = harness["page"]
...
async def test_ironclaw_legacy_skills_read_only_sources_hide_edit_and_delete(
