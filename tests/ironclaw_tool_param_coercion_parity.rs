...
use parity_qa_support::{
    binary_e2e::IronClawBinaryE2EHarness,
    model_replay::{
...
#[tokio::test]
async fn ironclaw_provider_tool_arguments_are_schema_coerced_before_http_dispatch() {
    ...
    let mut harness =
        IronClawBinaryE2EHarness::with_host_runtime_core_builtin_capabilities_network_policy(
...
#[tokio::test]
async fn ironclaw_provider_tool_scalar_arguments_are_schema_coerced_before_file_dispatch() {
    ...
    let mut harness = IronClawBinaryE2EHarness::with_host_runtime_file_capabilities(
