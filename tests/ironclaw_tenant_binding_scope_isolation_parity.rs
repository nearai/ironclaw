...
#[tokio::test]
async fn ironclaw_tenant_binding_scope_isolation_parity() {
    ...
    let mut tenant_a = IronClawBinaryE2EHarness::with_model_gateway_scope_shared_storage(
        "room-shared-tenant",
    ...
    let mut tenant_b = IronClawBinaryE2EHarness::with_model_gateway_scope_shared_storage(
        "room-shared-tenant",
        IronClawTraceReplayModelGateway::with_responses([
