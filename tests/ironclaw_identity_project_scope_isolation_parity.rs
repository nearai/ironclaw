...
#[tokio::test]
async fn ironclaw_identity_project_scope_isolation_parity() {
    ...
    let mut alpha = IronClawBinaryE2EHarness::with_model_gateway_scope_identity_source_trigger_installation_shared_storage(
        ROOM,
        IronClawTraceReplayModelGateway::with_responses([HostManagedModelResponse::assistant_reply(
    ...
    let mut beta = IronClawBinaryE2EHarness::with_model_gateway_scope_identity_source_trigger_installation_shared_storage(
        ROOM,
        IronClawTraceReplayModelGateway::with_responses([HostManagedModelResponse::assistant_reply(
