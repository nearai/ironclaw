...
#[tokio::test]
async fn ironclaw_http_network_scope_isolation_parity() {
...
) -> IronClawTraceReplayModelGateway {
    IronClawTraceReplayModelGateway::with_scripted_steps([
...
fn tool_result_text(harness: &IronClawBinaryE2EHarness) -> String {
    harness
        .model_requests()
        .iter()
...
fn capability_result_text(harness: &IronClawBinaryE2EHarness) -> String {
    harness
        .capability_results()
        .iter()
