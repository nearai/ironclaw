...
| Opt into the debug inspector and inspect the bounded host-resolved prompt and model-call statistics for a completed run | `test_reborn_webui_v2_smoke.py::test_inspector_debug_activation_and_responsive_shell`, `…::test_inspector_prompt_and_stats_render_host_diagnostics` |
