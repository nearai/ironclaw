...
| Ask a natural punctuated question in a new chat and receive explicitly saved memory through the proactive prompt lane on the shipping libSQL backend | `scenario_proactive_prompt_recall_libsql.rs` |
