...
//!
//! Models the manual QA connect flows on the IronClaw binary-E2E harness:
...
#[tokio::test]
async fn ironclaw_qa_connect_gmail_auth_flow() {
...
#[tokio::test]
async fn ironclaw_qa_connect_google_calendar_auth_flow() {
    run_connect_flow(ConnectFlowCase {
...
#[tokio::test]
async fn ironclaw_qa_connect_google_drive_auth_flow() {
    run_connect_flow(ConnectFlowCase {
...
#[tokio::test]
async fn ironclaw_qa_connect_google_sheets_auth_flow() {
    run_connect_flow(ConnectFlowCase {
...
#[tokio::test]
async fn ironclaw_qa_connect_slack_auth_flow() {
    run_connect_flow(ConnectFlowCase {
...
#[tokio::test]
async fn ironclaw_qa_connect_slack_channel_auth_flow() {
    run_connect_flow(ConnectFlowCase {
...
#[tokio::test]
async fn ironclaw_qa_connect_github_auth_flow() {
    run_connect_flow(ConnectFlowCase {
...
/// flow is the WebGeneratedCode pairing gate owned by the IronClaw channel
...
/// `docs/ironclaw/contracts/telegram-v2.md`.
...
#[tokio::test]
async fn ironclaw_qa_connect_telegram_auth_flow() {
    run_connect_flow(ConnectFlowCase {
