...
| One-shot/recurring jobs | ✅ | ✅ | - | Manual + cron triggers; Reborn one-shot uses first-class `TriggerSchedule::Once` (`schedule.kind = once`) with local-time or RFC3339-offset input; completion is derived from the schedule |
