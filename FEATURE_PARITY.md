...
| Skills (modular capabilities) | ✅ | ✅ | Prompt-based skills with trust gating, attenuation, activation criteria, catalog, selector; Reborn local-dev uses catalog/list-first model-selected activation with canonical source-qualified IDs before loading full skill context |
