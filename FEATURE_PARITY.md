...
| `traces` | ➖ | 🚧 | - | IronClaw-native Trace Commons MVP: opt-in local redaction, autonomous submission, private ingest/review/export/credit/admin helpers, optional DB dual-write/backfill with contributor, reviewer metadata, replay selection, audit reads/mirroring with source-hashed exports, retention expiry maintenance, vector-entry metadata/indexing, encrypted artifact sidecar, and delayed credit notices. Not an OpenClaw parity feature. |
