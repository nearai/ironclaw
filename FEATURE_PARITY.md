...
| `doctor` diagnostics | ✅ | 🚧 | Reborn validates boot files, driver readiness, LLM/provider credentials, and opt-in live storage/secrets initialization; MCP, skills, channels, service, Docker, and tunnel checks remain |
...
| `doctor` | ✅ | 🚧 | P2 | Boot/driver checks plus LLM credentials and `--live` storage/secrets readiness; remaining subsystem packs tracked above |
