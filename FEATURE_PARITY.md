...
| `traces` | ➖ | 🚧 | - | IronClaw-native Trace Commons MVP: opt-in local redaction, autonomous submission, private ingest/review/export/credit/admin helpers, optional DB dual-write/backfill with contributor and reviewer metadata reads, encrypted artifact sidecar, and delayed credit notices. Not an OpenClaw parity feature. |
