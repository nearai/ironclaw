...
| Multi-agent routing | ✅ | 🚧 | Patch-bus primitives for isolated agent envelopes, deterministic role routing, stale-base and file-overlap conflict detection; caller/tool wiring still pending |
