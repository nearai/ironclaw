...
| `doctor` diagnostics | ✅ | 🚧 | Reborn validates boot files, driver readiness, LLM/provider credentials, and opt-in live storage/secrets initialization; MCP, extensions, skills, hooks, channels, service, Docker, and tunnel checks remain |
