...
| Feature | OpenClaw | IronClaw | Notes |
|---------|----------|----------|-------|
| DM pairing codes | ✅ | ✅ | `ironclaw-v1 pairing list/approve`, host APIs |
...
| DM pairing verification | ✅ | ✅ | ironclaw-v1 pairing approve, host APIs |
...
- ✅ DM pairing (ironclaw-v1 pairing list/approve, host APIs)
- ✅ WASM tool sandbox
