...
| `traces` | ➖ | 🚧 | - | IronClaw-native Trace Commons MVP: opt-in local redaction, autonomous submission, private ingest/review/export/credit/admin helpers, optional DB dual-write mirror, encrypted artifact sidecar, and delayed credit notices. Not an OpenClaw parity feature. |
