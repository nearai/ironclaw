...
| `import` | ✅ | 🚧 | P1 | Generic conversation import infra + onboarding integration; Codex CLI + ChatGPT history importers implemented, onboarding only surfaces implemented sources, legacy `openclaw` source retained, Claude/Gemini parsers pending |
