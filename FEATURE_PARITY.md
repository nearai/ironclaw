...
| Feishu/Lark | ✅ | 🚧 | P3 | WASM channel with Event Subscription v2.0 via long-connection websocket by default, webhook fallback supported; Bitable/Docx tools planned |
