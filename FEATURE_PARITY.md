...
| `traces` | ➖ | 🚧 | - | IronClaw-native Trace Commons MVP: opt-in local redaction, autonomous submission, private ingest/review/export/credit/admin helpers, optional DB dual-write/backfill with redaction and derived metadata reads, encrypted artifact sidecar, and delayed credit notices. Not an OpenClaw parity feature. |
