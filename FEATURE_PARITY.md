...
| `traces` | ➖ | 🚧 | - | IronClaw-native Trace Commons MVP: opt-in local redaction, autonomous submission, private ingest/review/export/credit/admin helpers. Not an OpenClaw parity feature. |
