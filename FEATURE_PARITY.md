...
| WeCom | ✅ | 🚧 | P2 | New standalone WASM channel started; current MVP path is self-built app callback + Agent API, with bot websocket transport deferred pending a more generic WASM websocket runtime |
| LINE | ✅ | ❌ | P3 | |
