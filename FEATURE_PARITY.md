...
| Feishu/Lark | ✅ | 🚧 | P3 | WASM channel with Event Subscription v2.0 via long-connection websocket by default, setup UI mode selector for webhook fallback, image send/receive; Bitable/Docx tools planned |
