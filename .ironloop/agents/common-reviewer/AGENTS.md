...
runtime behavior, weaken security, create data loss, introduce unsafe authority flow, or leave
changed behavior effectively untested. Call out product, rollout, or architecture decisions that
cannot be validated from the diff alone.
