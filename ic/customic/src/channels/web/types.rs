...
impl From<ironclaw_common::AppEvent> for SseEvent {
    fn from(ev: ironclaw_common::AppEvent) -> Self {
        ...
        match ev {
            ...
            AE::JobMessage { job_id, role, content } => SseEvent::JobMessage { job_id, role, content },
            AE::JobToolUse { job_id, tool_name, input } => SseEvent::JobToolUse { job_id, tool_name, input },
            AE::JobToolResult { job_id, tool_name, output } => SseEvent::JobToolResult { job_id, tool_name, output },
