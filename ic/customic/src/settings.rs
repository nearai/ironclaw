...
fn default_routine_cron_interval() -> u64 { 15 }
fn default_routine_max_concurrent() -> usize { 10 }
fn default_routine_cooldown() -> u64 { 300 }
fn default_routine_max_tokens() -> u32 { 4096 }
fn default_routine_max_iterations() -> u32 { 3 }
...
fn default_skills_max_active() -> usize { 3 }
fn default_skills_max_context_tokens() -> usize { 4000 }
...
fn default_hygiene_daily_retention() -> u32 { 30 }
fn default_hygiene_conversation_retention() -> u32 { 7 }
fn default_hygiene_version_keep_count() -> u32 { 50 }
fn default_hygiene_cadence_hours() -> u32 { 12 }
...
fn default_search_fusion_strategy() -> String { "rrf".to_string() }
fn default_search_rrf_k() -> u32 { 60 }
