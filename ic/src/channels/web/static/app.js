...
function loadChannelsStatus() {
  ...
  container.innerHTML = renderCardsSkeleton(6);
  ...
  Promise.all([
    ...
    builtinList.appendChild(renderBuiltinChannelCard(
      I18n.t('channels.signal'),
      I18n.t('channels.signalDesc'),
      enabledChannels.indexOf('signal') !== -1,
      I18n.t('channels.configureVia', { env: 'SIGNAL_HTTP_URL, SIGNAL_ACCOUNT' })
    ));
