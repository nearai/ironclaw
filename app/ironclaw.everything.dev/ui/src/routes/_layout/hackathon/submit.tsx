    ...
    return (
      <div className="mx-auto max-w-lg px-4 py-10">
        <Card className="space-y-4 p-8 text-center">
          ...
          <p className="text-xs text-muted-foreground">CID: {result.cid}</p>
          <Button
            onClick={() => {
    ...
    <div className="mx-auto max-w-lg px-4 py-10">
      <Card className="space-y-6 p-8">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">Encrypt and upload via NOVA.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="novaAccountId"
              value={form.novaAccountId}
              onChange={handleChange("novaAccountId")}
              required
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              id="novaApiKey"
              type="password"
              value={form.novaApiKey}
              onChange={handleChange("novaApiKey")}
              required
            />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={handleChange("skillsList")}
