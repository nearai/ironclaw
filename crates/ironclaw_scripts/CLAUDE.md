...
- Own the IronClaw script runtime lane: manifest-derived script execution requests, backend abstraction, Docker CLI backend, output parsing, and script resource accounting.
