// 中文语言包 for BastionClaw

I18n.register('zh-CN', {
  // 认证页面
  'auth.title': 'BastionClaw',
  ...
  // 重启弹窗
  'restart.title': '重启 BastionClaw 实例',
  'restart.description': '确定要重启 BastionClaw 实例吗？这将优雅地重启进程。',
  'restart.warning': '正在运行的任务可能会中断。重启将在几秒钟内完成。',
  'restart.cancel': '取消',
  'restart.confirm': '确认重启',
  'restart.progressTitle': '正在重启 BastionClaw',
  ...
  'users.activate': '启用',
  'users.addToken': '+ 令牌',
  'users.getLoginLink': '获取登录链接',
  'users.loginLinkReady': '登录链接已就绪！',
  'users.failedGetLoginLink': '获取登录链接失败',
  ...
  'welcome.description': 'BastionClaw 是您的安全 AI 助手。选择下方的建议或输入您自己的消息。',
