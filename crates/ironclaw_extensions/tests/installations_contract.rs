...
use ironclaw_extensions::{
    CapabilityProviderHostApiContract, ExtensionActivationState, ExtensionHealthMessage,
    ...
    InMemoryExtensionInstallationStore, MANIFEST_SCHEMA_VERSION, ManifestHash, ManifestSource,
    ManifestV2Error,
};
