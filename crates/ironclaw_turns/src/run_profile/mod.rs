...
pub use host::{
    ...
    LoopGateKind, LoopInlineMessage, LoopInlineMessageRole, LoopInput, LoopInputBatch,
    ...
    ParentLoopOutput, ProcessHandleSummary, PromptMode, StageCheckpointPayloadRequest,
