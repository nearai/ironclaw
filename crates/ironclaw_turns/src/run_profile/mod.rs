...
pub use host::{
    ...
    CapabilityBatchOutcome, CapabilityCallCandidate, CapabilityConcurrency, CapabilityDenied,
    ...
    LoopDriverNoteKind, LoopInlineMessage, LoopInlineMessageRole, LoopInput, LoopInputBatch,
    LoopInputCursor, LoopInputCursorToken, LoopInputPort, LoopInterruptKind, LoopModelMessage,
    LoopModelPort, LoopModelRequest, LoopModelResponse, LoopModelRouteSnapshot, LoopProcessRef,
