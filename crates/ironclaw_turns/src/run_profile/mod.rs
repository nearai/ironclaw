...
pub use host::{
    ...
    AppendCapabilityResultRef, AssistantReply, BatchExecutionPolicy, BeginAssistantDraft,
    CapabilityBatchInvocation, CapabilityBatchOutcome, CapabilityCallCandidate,
    CapabilityConcurrency, CapabilityDenied, CapabilityDeniedReasonKind,
    ...
    PromptMode, StoreLoopCheckpointPayload, UpdateAssistantDraft, VisibleCapabilityRequest,
