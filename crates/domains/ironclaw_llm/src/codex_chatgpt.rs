// arch-exempt: large_file, Responses API transport, conversion, and protocol tests still lack a separate ChatGPT-provider sub-owner; one match arm was forced by Role::HostReminder (#6985), plan #6985
