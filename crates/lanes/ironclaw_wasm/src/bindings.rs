...
/// already-bundled 0.3.0 guest components (e.g. the committed `github.wasm`)
/// keep working while guests migrate to the typed 0.4.0 response. Removed in
/// PR 4, once every guest has migrated.
