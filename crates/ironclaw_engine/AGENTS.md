...
- Learning missions (`self-improvement`, `skill-repair`, `skill-extraction`, `conversation-insights`) fire on thread completion via `MissionManager::ensure_learning_missions()`.
