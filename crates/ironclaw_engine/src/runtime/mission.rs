...
impl MissionManager {
    ...
    pub async fn fire_mission(
        ...
        // is stale — reset it so the mission gets a fresh daily budget. The UTC
        // boundary is deliberate: a mission capped at 5/day for a user in a late
        // timezone only resets around mid-afternoon local time, which is
        // acceptable for learning-mission cadence.
        //
