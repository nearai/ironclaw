...
pub struct ActionCall {
    ...
    /// Optional human-readable display hint for UIs (e.g.
    /// "Searching your memories for 'last week'"). Generated by the
    /// bridge adapter from the tool's `ActionDef.description` plus its
    /// parameters. UIs prefer this over the bare action name when
