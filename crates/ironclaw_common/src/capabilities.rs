...
use crate::credential_mapping::CredentialMapping;
...
pub use crate::rate_limit::ToolRateLimitConfig as RateLimitConfig;
...
#[cfg(test)]
mod tests {
    use super::{Capabilities, EndpointPattern, SecretsCapability};
