...
append-log substrate for IronClaw.
...
IronClaw-owned production backend selection lives in
...
`crates/ironclaw_architecture/tests/ironclaw_dependency_boundaries.rs`; if the
