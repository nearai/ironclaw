...
//!
//! Prompt templates live in `crates/t3claw_engine/prompts/` as plain
...
impl PlatformInfo {
    ...
    pub fn to_prompt_section(&self) -> String {
        ...
        lines.push("You are **T3Claw**, a secure autonomous AI assistant platform.".into());
