...
//!
//! Thin adapter over the canonical IronClaw identity resolver
//! ([`IronClawIdentityResolver`](ironclaw_composition::IronClawIdentityResolver),
...
use ironclaw_composition::{
    ExternalSubjectId, IronClawIdentityError, IronClawIdentityResolver, ProviderKind,
...
pub(crate) struct WebuiUserDirectory {
    resolver: Arc<dyn IronClawIdentityResolver>,
    ...
    async fn resolve(
        ...
        let user_id = self
            ...
            .map_err(|err| match err {
                ...
                IronClawIdentityError::UserSuspended(_) => UserDirectoryError::Unknown,
...
mod tests {
    ...
    // substrate handle (`IronClawRuntime::open_ironclaw_identity_resolver`); here
    ...
    fn shared_resolver() -> Arc<dyn IronClawIdentityResolver> {
        ...
        ironclaw_composition::open_ironclaw_identity_resolver(
