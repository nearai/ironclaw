...
/// failure(guest-failure) case (near:agent@0.4.0 typed variant, layout note
/// on HTTP_TOOL_WAT above): discriminant@48=1 (failure); guest-failure fields
/// at payload offset 8 (record base 56): kind@56 (error-kind ordinal — 6 is
/// `operation-failed`), code discriminant@60=0 (None), message
/// discriminant@72=0 (None), retry-after-ms discriminant@88=0 (None). The
...
(module
  ...
  ;; typed variant (align 8, size 56 bytes): discriminant@0 (0=success),
  ;; success payload ptr@8, len@12.
...
(module
  ...
  (import "near:agent/host@0.4.0" "log" (func $log (type 0)))
  (import "near:agent/host@0.4.0" "secret-exists" (func $secret_exists (type 1)))
  (memory (export "memory") 1)
  (global $heap (mut i32) (i32.const 4096))
