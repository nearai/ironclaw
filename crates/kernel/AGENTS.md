...
- **The evidence-mint seal.** `reborn_sealed_evidence_mint_ratchet.rs`
  (re-derive test count: `grep -c '#[test]' crates/app/ironclaw_architecture_tests/tests/reborn_sealed_evidence_mint_ratchet.rs`)
