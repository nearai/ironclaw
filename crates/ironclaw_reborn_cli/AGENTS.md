...
- Do not add workspace dependencies beyond `ironclaw_reborn_composition` and `ironclaw_reborn_config` without an architecture test update and explicit PR rationale.
