...
- Depend only on neutral substrate (`ironclaw_host_api`). Do **not** depend on
  `ironclaw_filesystem`, `ironclaw_safety`, host composition, dispatch,
  approvals, run-state, secrets, network, process, events, or extension crates.
