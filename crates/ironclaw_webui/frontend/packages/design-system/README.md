...
- **`DESIGN_SYSTEM.md`** (in `crates/ironclaw_webui/`): rules, provenance,
...
```jsonc
// crates/ironclaw_webui/frontend/package.json
...
pnpm add "https://gitpkg.vercel.app/nearai/ironclaw/crates/ironclaw_webui/frontend/packages/design-system?main"
