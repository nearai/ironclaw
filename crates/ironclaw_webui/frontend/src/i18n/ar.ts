...
registerPack("ar", {
  ...
  "automations.delivery.unavailableNotice": "رسالة Slack المباشرة — غير متاحة",
  "automations.delivery.unavailableDesc": "اربط حساب Slack الخاص بك لتمكين التسليم عبر الرسائل المباشرة.",
...
registerPack("ar", {
  ...
  "slackSetup.saved": "تم حفظ إعداد Slack.",
  "slackSetup.saveFailed": "فشل تحديث إعداد Slack.",
  "slackSetup.field.installationId": "معرّف التثبيت",
  "slackSetup.field.teamId": "معرّف الفريق",
  "slackSetup.field.appId": "معرّف التطبيق",
  "slackSetup.field.botUser": "مستخدم البوت",
  "slackSetup.field.sharedSubject": "الموضوع المشترك",
  "slackSetup.field.botToken": "رمز البوت",
  "slackSetup.field.signingSecret": "سر التوقيع",
  "slackSetup.help.installationId": "اسم IronClaw المحلي لهذا تثبيت Slack. اختر اسمًا وابقه ثابتًا.",
  "slackSetup.help.teamId": "معرّف مساحة عمل/فريق Slack الذي ثبّت التطبيق.",
  "slackSetup.help.appId": "Slack app Basic Information > App Credentials.",
  "slackSetup.help.botUser": "مستخدم Reborn اختياري. اتركه فارغًا لاستخدام مشغّل WebUI الحالي.",
  "slackSetup.help.sharedSubject": "وكيل فريق افتراضي اختياري لدورات القنوات المشتركة. عادة يُترك فارغًا.",
  ...
  "slackSetup.example.localSlack": "مثال: local-slack",
  "slackSetup.example.teamId": "مثال: T0123456789",
  "slackSetup.example.appId": "مثال: A0123456789",
  "slackSetup.example.botUser": "مثال: user:operator",
