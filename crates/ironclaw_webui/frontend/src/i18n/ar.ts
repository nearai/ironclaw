...
registerPack("ar", {
  ...
  "admin.users.newManagedAgent": "وكيل مُدار جديد",
  "admin.users.createManagedAgent": "إنشاء وكيل مُدار",
  "admin.users.managedAgent": "وكيل مُدار",
  "admin.users.emptyDescription":
    "ادعُ شخصًا لتسجيل الدخول أو أنشئ وكيلاً بلا تسجيل دخول يديره مسؤولو مساحة العمل.",
  "admin.users.issueLoginToken": "إصدار رمز تسجيل دخول",
  "admin.users.issueLoginTokenDesc": "اختياري. يُعرض الرمز مرة واحدة ويمكن استخدامه لتسجيل الدخول كمستخدم خاص.",
  "admin.users.loginTokenReady": "تم إنشاء رمز تسجيل الدخول",
  "admin.users.loginTokenOnce": "انسخ هذا الرمز الآن. لن يُعرض مرة أخرى.",
  ...
  "admin.user.managedRoleLocked":
    "تظل الوكلاء المُدارة أعضاء دائمًا ولا يمكن تمكين تسجيل الدخول لها.",
  ...
  "admin.user.secrets.adminRequired": "يلزم تسجيل الدخول كمسؤول مساحة العمل",
  "admin.user.secrets.adminRequiredDesc":
    "يمكن لمشغّل المضيف إدارة دورة حياة هذا الوكيل، لكن بيانات اعتماد الهوية متاحة فقط لمسؤول نشط في مساحة العمل.",
