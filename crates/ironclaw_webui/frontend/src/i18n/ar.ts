...
registerPack("ar", {
  ...
  "tool.errorBackend": "فشل الواجهة الخلفية للأداة.",
  "tool.errorSecurity": "تم حظر استجابة الأداة بواسطة فحص أمني.",
  "tool.errorCancelled": "تم إلغاء استدعاء الأداة.",
  "tool.errorTimeout": "انتهت مهلة استدعاء الأداة.",
  "tool.errorInvalidRequest": "كان طلب الأداة غير صالح.",
  "tool.errorAuth": "تحتاج الأداة إلى مصادقة.",
  "tool.errorPermission": "لم يُسمح باستدعاء الأداة.",
  "tool.errorGateDeclined": "تم رفض استدعاء الأداة.",
  ...
  "tools.description.builtin.outbound_delivery_target_set": "تعيين هدف تسليم الرد النهائي الصادر للمستخدم الحالي، مثل رسالة مباشرة أو قناة في امتداد مراسلة متصل",
  ...
  "automations.delivery.unavailableNotice": "الرسالة المباشرة — غير متاحة",
  "automations.delivery.unavailableDesc": "اربط حساب المراسلة الخاص بك لتمكين التسليم عبر الرسائل المباشرة.",
  ...
  "automations.delivery.footnote": "تتم الإجابة على طلبات الموافقة المُرسَلة إلى رسالتك المباشرة بالرد بـ {command} في القناة المتصلة.",
  ...
  "projects.summary.threadsActiveToday": "{count} خيوط نشطة اليوم",
  "projects.summary.attentionQueue": "قائمة الانتباه",
  "projects.summary.attentionBadge": "انتباه",
  "projects.summary.failures24h": "{count} إخفاقات خلال آخر 24 ساعة",
  "projects.summary.spendToday": "إنفاق اليوم",
  "projects.summary.spendBadge": "الإنفاق",
  "projects.summary.acrossEveryProject": "عبر كل المشاريع",
  "projects.summary.waitingForActivity": "بانتظار النشاط",
  ...
  "extensions.customMcpSetupRequiredHint": "Credentials can be added later from this extension's Setup action in the Extensions list.",
