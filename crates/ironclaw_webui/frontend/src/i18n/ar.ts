...
registerPack("ar", {
  ...
  "tools.description.builtin.memory_search": "البحث في مستندات ذاكرة IronClaw الدائمة ضمن النطاق الحالي",
  "tools.description.builtin.memory_write": "كتابة مستندات ذاكرة IronClaw الدائمة أو إلحاقها أو ترقيعها ضمن النطاق الحالي",
  "tools.description.builtin.memory_read": "قراءة مستند ذاكرة IronClaw دائم ضمن النطاق الحالي",
  "tools.description.builtin.memory_tree": "عرض مستندات ذاكرة IronClaw الدائمة كشجرة مضغوطة",
  ...
  "tools.description.builtin.skill_list": "عرض مهارات نظام ملفات IronClaw المرئية للوكيل المحلي الحالي",
  ...
  "tools.description.builtin.skill_remove": "إزالة مهارة نظام ملفات IronClaw ثبّتها المستخدم",
  ...
  "tools.description.builtin.extension_search": "البحث في فهرس امتدادات IronClaw المحلي حسب الامتداد أو المنتج أو المزوّد أو اسم الخدمة",
  "tools.description.builtin.extension_install": "تثبيت امتداد IronClaw تم العثور عليه في حالة دورة حياة local-dev الدائمة",
  "tools.description.builtin.extension_activate": "تفعيل امتداد IronClaw مثبت لسطح قدرات local-dev المرئي للنموذج",
  "tools.description.builtin.extension_remove": "إزالة امتداد IronClaw مثبت من حالة دورة حياة local-dev الدائمة",
  ...
  "extensions.activatedSuccess": "تم تنشيط {name}",
  "extensions.removedSuccess": "تمت إزالة {name}",
  "extensions.installFailed": "فشل التثبيت",
  "extensions.activationFailed": "فشل التنشيط",
