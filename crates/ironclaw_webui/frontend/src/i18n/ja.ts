...
registerPack("ja", {
  ...
  "admin.users.newManagedAgent": "新しい管理対象エージェント",
  "admin.users.createManagedAgent": "管理対象エージェントを作成",
  "admin.users.managedAgent": "管理対象エージェント",
  "admin.users.emptyDescription":
    "サインインするユーザーを招待するか、テナント管理者が管理するログイン不可のエージェントを作成します。",
  "admin.users.issueLoginToken": "ログイントークンを発行",
  "admin.users.issueLoginTokenDesc": "任意。このトークンは一度だけ表示され、この非公開ユーザーとしてのサインインに使用できます。",
  "admin.users.loginTokenReady": "ログイントークンを作成しました",
  "admin.users.loginTokenOnce": "今すぐこのトークンをコピーしてください。再表示はできません。",
  ...
  "admin.user.managedRoleLocked":
    "管理対象エージェントは常にメンバーのままで、サインインを有効にすることはできません。",
  ...
  "admin.user.secrets.adminRequired": "テナント管理者としてのサインインが必要です",
  "admin.user.secrets.adminRequiredDesc":
    "ホストオペレーターはこのエージェントのライフサイクルを管理できますが、対象の認証情報を利用できるのは有効なテナント管理者だけです。",
