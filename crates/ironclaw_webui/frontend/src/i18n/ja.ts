...
registerPack("ja", {
  ...
  "tools.description.builtin.memory_search": "現在のスコープ内の IronClaw 永続メモリ文書を検索します",
  "tools.description.builtin.memory_write": "現在のスコープ内の IronClaw 永続メモリ文書を書き込み、追記、またはパッチします",
  "tools.description.builtin.memory_read": "現在のスコープ内の IronClaw 永続メモリ文書を読み取ります",
  "tools.description.builtin.memory_tree": "IronClaw 永続メモリ文書をコンパクトなツリーとして一覧表示します",
  ...
  "tools.description.builtin.skill_list": "現在のローカル開発エージェントに見える IronClaw ファイルシステムスキルを一覧表示します",
  "tools.description.builtin.skill_install": "SKILL.md 文書、URL、ZIP、または GitHub スキルリポジトリを現在のユーザーのスキルルートにインストールします",
  "tools.description.builtin.skill_remove": "ユーザーがインストールした IronClaw ファイルシステムスキルを削除します",
  ...
  "tools.description.builtin.extension_search": "拡張機能、製品、プロバイダー、サービス名でローカルの IronClaw 拡張カタログを検索します",
  "tools.description.builtin.extension_install": "検索した IronClaw 拡張機能を永続的な local-dev ライフサイクル状態にインストールします",
  "tools.description.builtin.extension_activate": "インストール済みの IronClaw 拡張機能を、モデルに見える local-dev 能力面で有効化します",
  "tools.description.builtin.extension_remove": "インストール済みの IronClaw 拡張機能を永続的な local-dev ライフサイクル状態から削除します",
