...
registerPack("zh-CN", {
  ...
  "admin.users.newManagedAgent": "新建托管代理",
  "admin.users.createManagedAgent": "创建托管代理",
  "admin.users.managedAgent": "托管代理",
  "admin.users.emptyDescription":
    "邀请用户登录，或创建由租户管理员管理且无法登录的代理。",
  "admin.users.issueLoginToken": "签发登录令牌",
  "admin.users.issueLoginTokenDesc": "可选。令牌仅显示一次，可用于以此私有用户身份登录。",
  "admin.users.loginTokenReady": "登录令牌已创建",
  "admin.users.loginTokenOnce": "请立即复制此令牌。之后将不会再次显示。",
  ...
  "admin.user.secrets.adminRequired": "需要以租户管理员身份登录",
  "admin.user.secrets.adminRequiredDesc":
    "主机操作员可以管理此代理的生命周期，但只有活跃的租户管理员才能访问主体凭据。",
