...
registerPack("zh-CN", {
  ...
  "tools.description.builtin.memory_search": "在当前作用域中搜索 IronClaw 持久记忆文档",
  "tools.description.builtin.memory_write": "在当前作用域中写入、追加或修补 IronClaw 持久记忆文档",
  "tools.description.builtin.memory_read": "读取当前作用域中的 IronClaw 持久记忆文档",
  "tools.description.builtin.memory_tree": "以紧凑树形列出 IronClaw 持久记忆文档",
  ...
  "tools.description.builtin.skill_list": "列出当前本地开发代理可见的 IronClaw 文件系统技能",
  "tools.description.builtin.skill_install": "将 SKILL.md 文档、URL、ZIP 包或 GitHub 技能仓库安装到当前用户的技能根目录",
  "tools.description.builtin.skill_remove": "移除用户安装的 IronClaw 文件系统技能",
  ...
  "tools.description.builtin.extension_search": "搜索本地 IronClaw 扩展目录，可按扩展、产品、提供方或服务名称查询",
  "tools.description.builtin.extension_install": "将搜索到的 IronClaw 扩展安装到持久本地开发生命周期状态",
  "tools.description.builtin.extension_activate": "激活已安装的 IronClaw 扩展，使模型可见的本地开发能力可用",
  "tools.description.builtin.extension_remove": "从持久本地开发生命周期状态中移除已安装的 IronClaw 扩展",
