...
registerPack("zh-CN", {
  ...
  "automations.delivery.unavailableNotice": "Slack 私信 — 不可用",
  "automations.delivery.unavailableDesc": "绑定你的 Slack 账户以启用私信投递。",
  ...
  "extensions.activatedSuccess": "已激活 {name}",
...
registerPack("zh-CN", {
  ...
  "slackSetup.saved": "Slack 设置已保存。",
  "slackSetup.saveFailed": "Slack 设置更新失败。",
  "slackSetup.field.installationId": "安装 ID",
  "slackSetup.field.teamId": "团队 ID",
  "slackSetup.field.appId": "应用 ID",
  "slackSetup.field.botUser": "机器人用户",
  "slackSetup.field.sharedSubject": "共享主体",
  "slackSetup.field.botToken": "机器人令牌",
  "slackSetup.field.signingSecret": "签名密钥",
  "slackSetup.help.installationId": "此 Slack 安装在本地 IronClaw 中的名称。请选择一个并保持稳定。",
  "slackSetup.help.teamId": "安装此应用的 Slack 工作区/团队 ID。",
  "slackSetup.help.appId": "Slack 应用 Basic Information > App Credentials。",
  "slackSetup.help.botUser": "可选的 Reborn 用户。留空则使用当前 WebUI 操作者。",
  "slackSetup.help.sharedSubject": "共享频道回合的可选默认团队代理。通常留空。",
  "slackSetup.help.botToken": "Slack 应用 OAuth & Permissions > Bot User OAuth Token。",
  "slackSetup.help.signingSecret": "Slack 应用 Basic Information > App Credentials > Signing Secret。",
  "slackSetup.example.localSlack": "示例：local-slack",
  "slackSetup.example.teamId": "示例：T0123456789",
  "slackSetup.example.appId": "示例：A0123456789",
  "slackSetup.example.botUser": "示例：user:operator",
