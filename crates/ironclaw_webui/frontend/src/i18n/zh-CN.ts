...
registerPack("zh-CN", {
  ...
  "tool.riskExec": "运行命令",
  "tool.riskNetwork": "网络",
  "tool.errorBackend": "工具后端发生故障。",
  "tool.errorSecurity": "工具响应被安全检查拦截。",
  "tool.errorCancelled": "工具调用已取消。",
  "tool.errorTimeout": "工具调用超时。",
  "tool.errorInvalidRequest": "工具请求无效。",
  "tool.errorAuth": "工具需要身份验证。",
  "tool.errorPermission": "工具调用未被允许。",
  "tool.errorGateDeclined": "工具调用被拒绝。",
  "authGate.title": "需要验证",
  ...
  "tools.description.builtin.outbound_delivery_target_set": "设置当前用户最终回复的出站投递目标，例如已连接消息扩展的私信或频道",
  ...
  "automations.delivery.unavailableNotice": "私信 — 不可用",
  "automations.delivery.unavailableDesc": "绑定你的消息账户以启用私信投递。",
  "automations.delivery.save": "保存",
  "automations.delivery.clear": "清除",
  "automations.delivery.saved": "已保存",
  "automations.delivery.saveFailed":
    "无法保存投递目标，请重试。",
  "automations.delivery.footnote": "发送到你私信的审批请求，可在已连接的频道中回复 {command} 来处理。",
  ...
  "projects.summary.threadsActiveToday": "今日活跃线程 {count} 个",
  "projects.summary.attentionQueue": "关注队列",
  "projects.summary.attentionBadge": "关注",
  "projects.summary.failures24h": "过去 24 小时失败 {count} 次",
  "projects.summary.spendToday": "今日花费",
  "projects.summary.spendBadge": "花费",
  "projects.summary.acrossEveryProject": "跨所有项目",
  "projects.summary.waitingForActivity": "等待活动",
