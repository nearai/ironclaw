...
registerPack("en", {
  ...
  "extensions.addCustomMcp": "Add custom MCP",
  "extensions.customMcpPhase.connection": "Connection · Step 1 of 3",
  "extensions.customMcpPhase.authentication": "Authentication · Step 2 of 3",
  "extensions.customMcpPhase.result": "Result / Setup · Step 3 of 3",
  "extensions.customMcpPhase.connectionLabel": "Connection",
  "extensions.customMcpPhase.authenticationLabel": "Authentication",
  "extensions.customMcpPhase.resultLabel": "Result / Setup",
  "extensions.customMcpProgress": "Custom MCP registration progress",
  "extensions.customMcpName": "Extension name",
  "extensions.customMcpId": "Extension ID",
  "extensions.customMcpEndpoint": "HTTPS endpoint",
  "extensions.customMcpRequired": "Name, ID, and endpoint are required.",
  "extensions.customMcpHttpsOnly": "The endpoint must use HTTPS.",
  "extensions.customMcpAuthHint": "Choose how this server authenticates. Credentials are configured only after registration.",
  ...
  "extensions.customMcpRegister": "Register server",
  "extensions.customMcpRegistered": "{name} registered",
  "extensions.customMcpRegisterFailed": "Could not register custom MCP",
  "extensions.customMcpSetupRequired": "Registration complete — setup required",
  "extensions.customMcpSetupRequiredHint": "Continue into the existing extension setup flow to add credentials or complete OAuth. Closing leaves the extension in setup needed.",
  "extensions.customMcpReady": "Registration complete",
  "extensions.customMcpReadyHint": "This no-auth server is active and ready to use.",
  "extensions.customMcpFinishLater": "Finish later",
  "extensions.customMcpContinueSetup": "Continue setup",
  "extensions.customMcpProjectionMissing": "The server was registered, but its authoritative extension state is not available yet. Try again.",
  ...
  "extensions.state.setup_needed": "setup needed",
