...
registerPack("en", {
  ...
  "admin.users.newManagedAgent": "New managed agent",
  "admin.users.createManagedAgent": "Create managed agent",
  "admin.users.managedAgent": "Managed agent",
  "admin.users.emptyDescription":
    "Invite a person to sign in, or create a non-login agent managed by tenant administrators.",
  "admin.users.issueLoginToken": "Issue a login token",
  "admin.users.issueLoginTokenDesc": "Optional. The token is shown once and can be used to sign in as this private user.",
  "admin.users.loginTokenReady": "Login token created",
  "admin.users.loginTokenOnce": "Copy this token now. It will not be shown again.",
  ...
  "admin.user.secrets.adminRequired": "Tenant admin sign-in required",
  "admin.user.secrets.adminRequiredDesc":
    "The host operator can manage this agent’s lifecycle, but subject credentials are available only to an active tenant administrator.",
