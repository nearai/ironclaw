...
registerPack("en", {
  ...
  "extensions.customMcpPhase.connection": "Connection · Step 1 of 3",
  "extensions.customMcpPhase.authentication": "Review · Step 2 of 3",
  "extensions.customMcpPhase.review": "Review · Step 2 of 3",
  "extensions.customMcpPhase.result": "Result · Step 3 of 3",
  ...
  "extensions.customMcpIdHint": "A unique ID for this server. Start with a lowercase letter or number, then use lowercase letters, numbers, underscores, hyphens, or dots (128 characters maximum).",
  ...
  "extensions.customMcpIdInvalid": "Server ID must start with a lowercase letter or number, then use only lowercase letters, numbers, underscores, hyphens, or dots (128 characters maximum).",
  "extensions.customMcpEndpointRequired": "Enter a server address.",
  "extensions.customMcpEndpointHttps": "Enter a public HTTPS URL without embedded credentials, fragments, credential query parameters, localhost, or an IP address.",
  "extensions.customMcpAuthHint": "IronClaw will connect without credentials first and detect whether the server needs OAuth or a bearer token. Manual overrides are available under Advanced options.",
  "extensions.customMcpReviewHint": "Add this server now. To use it, find it in Extensions and install it. If it needs access, connect an account or add a token.",
  ...
  "extensions.customMcpAuth.auto": "Automatic authentication detection",
  ...
  "extensions.customMcpSetupRequiredHint": "Find it in Extensions, then connect an account or add a token if it asks for access.",
  "extensions.customMcpReady": "Server added",
  "extensions.customMcpReadyHint": "Find it in Extensions. Install it before using it. If it asks for access, connect an account or add a token.",
  "extensions.customMcpFinishLater": "Finish later",
  "extensions.customMcpContinueSetup": "Continue setup",
  "extensions.customMcpProjectionMissing": "The server was added, but it is not showing in Extensions yet. Try again.",
