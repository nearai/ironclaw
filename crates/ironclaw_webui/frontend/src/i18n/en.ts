...
registerPack("en", {
  ...
  "chat.commandListTitle": "Available commands",
  ...
  // Chat — automations (OOBE carousel + inline calendar preview)
  "automation.carousel.title": "Done for you",
  "automation.carousel.subtitle": "Completed automatically — review or undo anytime",
  "automation.carousel.scrollPrev": "Scroll to previous automations",
  "automation.carousel.scrollNext": "Scroll to more automations",
  "automation.launch": "Open in {app}",
  "automation.app.gmail": "Gmail",
  "automation.app.calendar": "Google Calendar",
  "automation.app.docs": "Google Docs",
  "automation.app.slack": "Slack",
  "automation.app.notion": "Notion",
  "automation.app.unknown": "App",
  "automation.state.suggested": "Suggested",
  "automation.state.automated": "Automated",
  "automation.state.reverted": "Reverted",
  "automation.state.cancelled": "Dismissed",
  "automation.action.approve": "Approve",
  "automation.action.modify": "Modify",
  "automation.action.cancel": "Cancel",
  "automation.action.revert": "Revert",
  "automation.action.revertedNote": "Reverted — the change was undone.",
  "automation.action.cancelledNote": "Dismissed — nothing was done.",
  "automation.action.rerunning": "Re-running…",
  "automation.action.approving": "Approving…",
  "automation.action.cancelling": "Cancelling…",
  "automation.action.reverting": "Reverting…",
  "plan.allDone": "All done",
  "plan.remaining": "{count} to approve",
  "plan.approveAll": "Approve all ({count})",
  "plan.dismiss": "Dismiss",
  "plan.finished": "Plan complete — everything's been handled.",
  "plan.running": "Running your plan…",
  "automation.metric.replied": "replied",
  "automation.metric.archived": "archived",
  "automation.metric.flagged": "kept for you",
  "automation.metric.accepted": "accepted",
  "automation.metric.conflicts": "conflicts",
  "automation.metric.docs": "docs",
  "automation.metric.insights": "insights",
  "automation.email.rationaleAccess": "Routine doc-access request from a known teammate.",
  "automation.email.rationaleNewsletter": "Recurring newsletter — no action needed.",
  "automation.email.rationaleConfirm": "Simple scheduling confirmation.",
  "automation.modify.title": "Modify automation",
  "automation.modify.chooseSlot": "Choose a new time",
  "automation.modify.chooseReplies": "Choose which replies to send",
  "automation.modify.note": "Note for the agent (optional)",
  "automation.modify.notePlaceholder": "e.g. keep it brief, or CC my manager",
  "automation.modify.save": "Save changes",
  "automation.reschedule.proposeLine":
    "“{meeting}” overlaps your “{conflict}”. I can move it to a slot that works for everyone.",
  "automation.reschedule.doneLine":
    "Moved “{meeting}” so it no longer overlaps your “{conflict}”.",
  "automation.reschedule.was": "Was",
  "automation.reschedule.now": "Now",
  "automation.reschedule.proposed": "Proposed",
  "automation.reschedule.conflictWith": "Conflicts with {conflict}",
  "automation.reschedule.attendees": "Attendees",
  // Chat — agent mode selector (composer pill)
  "mode.menuLabel": "Agent mode",
  "mode.ariaLabel": "Agent mode: {mode}. Change autonomy level",
  "mode.suggest.label": "Suggest",
  "mode.suggest.desc": "Always ask before taking any action.",
  "mode.plan.label": "Plan",
  "mode.plan.desc": "Draft a plan of tasks and wait for your approval.",
  "mode.auto.label": "Auto",
  "mode.auto.desc": "Auto-run approved task types (email triage, invite accepts) without asking.",
  "mode.bypass.label": "Bypass",
  "mode.bypass.desc": "Full automation — act without any approvals. Use with care.",
  // Chat — tool activity
  ...
  "authGate.unsupportedChallengeNeutral":
    "This authentication method is not available in this view. Cancel this step and retry from the place that requested it.",
  ...
  "tools.description.builtin.echo": "Echo a message",
  "tools.description.builtin.time": "Get, parse, format, convert, or diff timestamps",
  "tools.description.builtin.json": "Parse, query, stringify, and validate JSON",
  "tools.description.builtin.http": "Perform an outbound HTTP request through host egress. Redirect responses are returned; the host transport does not follow them. Prefer GitHub extension capabilities for GitHub repository, issue, pull request, release, or workflow data when available.",
  "tools.description.builtin.http.save": "Perform an outbound HTTP request through host egress and save the sanitized response body through scoped filesystem authority. Prefer GitHub extension capabilities for GitHub repository, issue, pull request, release, or workflow data when available.",
  "tools.description.builtin.shell": "Execute shell commands with validation and saved-file references for large local output",
  "tools.description.builtin.spawn_subagent": "Authorize a scoped child subagent run",
  "tools.description.builtin.trace_commons.onboard": "Enroll this IronClaw in Trace Commons using an operator-issued invite link after explicit user consent.",
  "tools.description.builtin.trace_commons.status": "Report Trace Commons enrollment state for the current user.",
  ...
  "tools.description.builtin.memory_tree": "List Reborn persistent memory documents as a compact tree",
  "tools.description.builtin.read_file": "Read text files and extract text from supported document files through scoped mounts",
  "tools.description.builtin.write_file": "Write content through scoped mounts",
  "tools.description.builtin.list_dir": "List directory contents through scoped mounts",
  "tools.description.builtin.glob": "Find files under a scoped directory with a glob pattern",
  "tools.description.builtin.grep": "Search scoped file contents with grep output modes",
  "tools.description.builtin.apply_patch": "Apply exact or fuzzy search-replace edits through scoped mounts",
  "tools.description.builtin.skill_list": "List Reborn filesystem skills visible to the current local-dev agent",
  "tools.description.builtin.skill_install": "Install a SKILL.md document, URL, ZIP bundle, or GitHub skill repository into the current user's skill root",
  "tools.description.builtin.skill_remove": "Remove a user-installed Reborn filesystem skill",
  "tools.description.builtin.trigger_create": "Create a caller-scoped scheduled trigger, either one-time or recurring",
  "tools.description.builtin.trigger_list": "List scheduled triggers owned by the current caller scope",
  ...
  "projects.card.threadsToday": "Threads today: {count}",
  "projects.card.pendingGates": "Pending gates: {count}",
  "projects.card.failures24h": "Failures in 24h: {count}",
  "projects.card.spendToday": "{value} spend today",
  "projects.explorer": "Explorer",
  "projects.summary.projects": "Projects",
  "projects.summary.projectsBadge": "Projects",
  "projects.summary.threadsActiveToday": "{count} threads active today",
  "projects.summary.attentionQueue": "Attention queue",
  "projects.summary.attentionBadge": "Attention",
  "projects.summary.failures24h": "{count} failures in the last 24h",
  "projects.summary.spendToday": "Spend today",
  "projects.summary.spendBadge": "Spend",
  "projects.summary.acrossEveryProject": "Across every project",
  "projects.summary.waitingForActivity": "Waiting for activity",
  "projects.general.threadsToday": "Threads today: {count}",
  "projects.health.green": "Healthy",
  "projects.health.yellow": "Needs review",
  "projects.health.red": "At risk",
  "projects.health.muted": "Archived",
  "projects.health.steady": "Steady",
  "projects.health.unknown": "Unknown",
  "projects.status.active": "Active",
  "projects.status.paused": "Paused",
  "projects.status.completed": "Completed",
  "projects.status.failed": "Failed",
  "projects.status.unknown": "Unknown",
  "projects.threadState.running": "Running",
  "projects.threadState.done": "Done",
  "projects.threadState.completed": "Completed",
  "projects.threadState.failed": "Failed",
  "projects.threadState.unknown": "Unknown",
  "projects.role.system": "System",
  "projects.role.user": "User",
  "projects.role.assistant": "Assistant",
  "projects.role.tool": "Tool",
  "projects.date.notAvailable": "Not available",
  "projects.relative.noActivity": "No recent activity",
  "projects.relative.inUnderMinute": "in under a minute",
  "projects.relative.justNow": "just now",
  "projects.relative.inMinutes": "in {count}m",
  "projects.relative.minutesAgo": "{count}m ago",
  "projects.relative.inHours": "in {count}h",
  "projects.relative.hoursAgo": "{count}h ago",
  "projects.relative.inDays": "in {count}d",
  "projects.relative.daysAgo": "{count}d ago",
  "projects.thread.missionRun": "Mission run",
  "projects.thread.generic": "Thread",
  "projects.thread.generatedTitle": "Thread {id}",
  "projects.thread.type.missionRun": "Mission run",
  "projects.thread.brief": "Mission brief",
  "projects.thread.type": "Thread type",
  "projects.thread.steps": "Steps",
  "projects.thread.tokens": "Tokens",
  "projects.thread.spend": "Spend",
  "projects.thread.notMeasured": "Not measured",
  "projects.thread.created": "Created",
  "projects.thread.completed": "Completed",
  "projects.thread.stillRunning": "Still running",
  "projects.thread.timeline": "Timeline",
  "projects.thread.noMessages": "No messages were captured for this thread.",
  "projects.metric.notSet": "Not set",
  "projects.count.steps": "{count} steps",
  "projects.count.tokens": "{count} tokens",
  "projects.attention.title": "Needs attention",
  "projects.attention.desc": "Operator-visible gates and recent failures across your project workspace.",
  "projects.attention.failure": "Failure",
  "projects.attention.gate": "Gate",
  "projects.attention.threadLabel": "Thread {id}",
  "projects.attention.projectLabel": "Project",
  "projects.attention.openProject": "Open project",
  "projects.activity.label": "Conversations",
  "projects.activity.title": "Project conversations",
  "projects.activity.starting": "Starting...",
  "projects.activity.newConversation": "New conversation",
  ...
  "projects.missions.title": "Project execution plan",
  "projects.missions.activePaused": "{active} active / {paused} paused",
  "projects.missions.completedFailed": "{completed} completed / {failed} failed",
  "projects.missions.manual": "manual",
  "projects.missions.threadCount": "{count} threads",
  "projects.missions.updated": "Updated {date}",
  "projects.missions.empty":
  ...
  "projects.snapshot.goals": "Goals",
  "projects.snapshot.metrics": "Metrics",
  "projects.snapshot.updated": "Updated {date}",
  "projects.mission.dossier": "Mission dossier",
  "projects.mission.fireNow": "Fire now",
  "projects.mission.pause": "Pause",
  "projects.mission.resume": "Resume",
  "projects.mission.runOnce": "Run once",
  "projects.mission.runAgain": "Run again",
  "projects.mission.cadence": "Cadence",
  "projects.mission.threadsToday": "Threads today",
  "projects.mission.threadsTodayValue": "{count} / {max}",
  "projects.mission.nextFire": "Next fire",
  "projects.mission.notScheduled": "Not scheduled",
  "projects.mission.created": "Created",
  "projects.mission.brief": "Mission brief",
  "projects.mission.noGoal": "No mission goal set.",
  "projects.mission.currentFocus": "Current focus",
  "projects.mission.successCriteria": "Success criteria",
  "projects.mission.approachHistory": "Approach history",
  ...
  "projects.files.folderEmpty": "This folder is empty.",
  "projects.widgets.fallbackSlot": "Project widget",
  "projects.widgets.mountFailed": "Unable to mount {name}.",
  "projects.widgets.title": "Widgets",
  "projects.widgets.instrumentation": "Project instrumentation",
  "projects.feedback.dismiss": "Dismiss",
  "projects.action.missionFiredWithRun": "Mission fired and a new run is live.",
  "projects.action.missionFireAccepted": "Mission fire request accepted.",
  "projects.action.fireFailed": "Unable to fire mission",
  "projects.action.missionPaused": "Mission paused.",
  "projects.action.pauseFailed": "Unable to pause mission",
  "projects.action.missionResumed": "Mission resumed.",
  "projects.action.resumeFailed": "Unable to resume mission",
  ...
  "extensions.noCapabilities": "No capabilities",
  "extensions.defaultName": "Extension",
  "extensions.installedSuccess": "{name} installed",
  "extensions.removedSuccess": "{name} removed",
  "extensions.installFailed": "Install failed",
  "extensions.addCustomMcp": "Add MCP server",
  "extensions.customMcpPhase.connection": "Step 1 of 3",
  "extensions.customMcpPhase.authentication": "Step 2 of 3",
  "extensions.customMcpPhase.review": "Step 2 of 3",
  "extensions.customMcpPhase.result": "Step 3 of 3",
  "extensions.customMcpPhase.connectionLabel": "Connection",
  "extensions.customMcpPhase.authenticationLabel": "Review",
  "extensions.customMcpPhase.reviewLabel": "Review",
  "extensions.customMcpPhase.resultLabel": "Result",
  "extensions.customMcpProgress": "Add an MCP server in three steps",
  "extensions.customMcpName": "Server name",
  "extensions.customMcpNameHint": "Use a name you will recognize in Extensions.",
  "extensions.customMcpId": "Server ID",
  "extensions.customMcpIdGenerated": "ID: {id}",
  "extensions.customMcpIdHint": "A unique ID: lowercase letters, numbers, underscores, hyphens, or dots, starting with a letter or number (128 chars max).",
  "extensions.customMcpAdvanced": "Advanced options",
  "extensions.customMcpRecommended": "Recommended",
  "extensions.customMcpEndpoint": "Server address",
  "extensions.customMcpRequired": "Name, ID, and endpoint are required.",
  "extensions.customMcpHttpsOnly": "The endpoint must use HTTPS.",
  "extensions.customMcpNameRequired": "Enter a server name.",
  "extensions.customMcpNameTooLong": "Server name must be 256 characters or fewer.",
  "extensions.customMcpNameControls": "Server name cannot contain control characters.",
  "extensions.customMcpIdRequired": "Enter a server ID.",
  ...
  "extensions.customMcpAuth.auto": "Automatic detection",
  "extensions.customMcpRegister": "Add server",
  "extensions.customMcpRegistered": "{name} added",
  "extensions.customMcpRegisterFailed": "Could not add this server. Try again.",
  "extensions.customMcpSetupRequired": "Server added — finish setup",
  "extensions.customMcpSetupRequiredHint": "Find it in Extensions, then connect an account or add a token if needed.",
  "extensions.customMcpReady": "Server added",
  "extensions.customMcpReadyHint": "Find it in Extensions, install it, then connect an account or add a token if needed.",
  "extensions.customMcpFinishLater": "Finish later",
  "extensions.customMcpContinueSetup": "Continue setup",
  "extensions.customMcpProjectionMissing": "The server was added but isn't showing in Extensions yet. Try again.",
  ...
  "extensions.runtime.first_party": "First-party",
  "extensions.runtime.system": "System",
  "extensions.state.active": "active",
  "extensions.state.configured": "configured",
  "extensions.state.disabled": "disabled",
  "extensions.state.unsupported": "unsupported",
  "extensions.state.auth_required": "auth needed",
  "extensions.state.setup_needed": "finish setup",
  ...
  "extensions.accountRevoked": "Access was revoked — reconnect to continue.",
  "extensions.accountCredentialMissing": "No credential on file — reconnect to continue.",
  "extensions.accountFlowExpired": "Authorization didn't complete in time — reconnect to try again.",
  "extensions.accountVendorDenied": "Authorization was declined — reconnect to try again.",
  "extensions.accountExchangeFailed": "Authorization couldn't be completed — reconnect to try again.",
  "extensions.accountValidationFailed": "The saved key was rejected — reconnect to update it.",
...
registerPack("en", {
  ...
  "thread.state.needsAttention": "Needs your attention",
  "thread.state.running": "Running",
  "thread.state.failed": "Failed",
  "thread.deleteConfirm": "Delete this chat?",
  "command.newChat": "New chat",
  "command.goChat": "Go to Chat",
  "command.goExtensions": "Go to Extensions",
  ...
  "command.group.threads": "Threads",
  "command.dialogLabel": "Command palette",
  "command.noMatches": "No matches",
  "chat.attachmentLoadFailed": "Couldn't load this attachment.",
  "chat.attachmentPreviewTruncated": "Preview truncated - download the file to see the rest.",
  "chat.attachmentPreviewUnavailable": "This file type can't be previewed.",
  "chat.reasoning": "Reasoning",
  "chat.hideReasoning": "Hide reasoning",
  "chat.generatedImageAlt": "Generated result",
  ...
  "approval.detail.scope": "Scope",
  "markdown.codeCopied": "Code copied",
  "markdown.wrap": "Wrap",
  "markdown.noWrap": "No wrap",
  ...
  "pairing.web.title": "Connect {name}",
  ...
  "pairing.web.expired": "This pairing code expired.",
  "pairing.web.getNewCode": "Get a new code",
  "pairing.web.paired": "{name} paired",
  "pairing.web.disconnect": "Disconnect",
  "pairing.web.disconnectFailed": "Disconnecting {name} failed.",
  "pairing.web.loadFailed": "Could not get a {name} pairing code.",
