...
registerPack("uk", {
  ...
  "tools.description.builtin.memory_search": "Шукати постійні документи памʼяті IronClaw у поточній області",
  "tools.description.builtin.memory_write": "Записувати, додавати або патчити постійні документи памʼяті IronClaw у поточній області",
  "tools.description.builtin.memory_read": "Читати постійний документ памʼяті IronClaw у поточній області",
  "tools.description.builtin.memory_tree": "Показати постійні документи памʼяті IronClaw як компактне дерево",
  ...
  "tools.description.builtin.skill_list": "Перелічувати IronClaw filesystem skills, видимі поточному локальному dev-агенту",
  ...
  "tools.description.builtin.skill_remove": "Видалити встановлену користувачем IronClaw filesystem skill",
  ...
  "tools.description.builtin.extension_search": "Шукати в локальному каталозі розширень IronClaw за розширенням, продуктом, постачальником або назвою сервісу",
  "tools.description.builtin.extension_install": "Встановити знайдене розширення IronClaw у сталий стан життєвого циклу local-dev",
  "tools.description.builtin.extension_activate": "Активувати встановлене розширення IronClaw для видимої моделі поверхні можливостей local-dev",
  "tools.description.builtin.extension_remove": "Видалити встановлене розширення IronClaw зі сталого стану життєвого циклу local-dev",
