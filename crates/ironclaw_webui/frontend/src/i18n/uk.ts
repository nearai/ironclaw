...
registerPack("uk", {
  ...
  "admin.users.newManagedAgent": "Новий керований агент",
  "admin.users.createManagedAgent": "Створити керованого агента",
  "admin.users.managedAgent": "Керований агент",
  "admin.users.emptyDescription":
    "Запросіть людину ввійти або створіть агента без можливості входу, яким керують адміністратори робочого простору.",
  "admin.users.issueLoginToken": "Видати токен входу",
  "admin.users.issueLoginTokenDesc": "Необов’язково. Токен показується лише один раз і дає змогу ввійти як цей приватний користувач.",
  "admin.users.loginTokenReady": "Токен входу створено",
  "admin.users.loginTokenOnce": "Скопіюйте цей токен зараз. Він більше не відображатиметься.",
  ...
  "admin.user.managedRoleLocked":
    "Керовані агенти завжди залишаються учасниками й не можуть отримати можливість входу.",
  ...
  "admin.user.secrets.adminRequired": "Потрібен вхід адміністратора робочого простору",
  "admin.user.secrets.adminRequiredDesc":
    "Оператор хоста може керувати життєвим циклом цього агента, але облікові дані суб’єкта доступні лише активному адміністратору робочого простору.",
