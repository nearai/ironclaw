...
registerPack("hi", {
  ...
  "tools.description.builtin.memory_search": "वर्तमान scope में IronClaw persistent memory documents खोजें",
  "tools.description.builtin.memory_write": "वर्तमान scope में IronClaw persistent memory documents लिखें, append करें या patch करें",
  "tools.description.builtin.memory_read": "वर्तमान scope में IronClaw persistent memory document पढ़ें",
  "tools.description.builtin.memory_tree": "IronClaw persistent memory documents को compact tree के रूप में सूचीबद्ध करें",
  ...
  "tools.description.builtin.skill_list": "वर्तमान local-dev agent को दिखाई देने वाली IronClaw filesystem skills सूचीबद्ध करें",
  ...
  "tools.description.builtin.skill_remove": "user-installed IronClaw filesystem skill हटाएं",
  ...
  "tools.description.builtin.extension_search": "extension, product, provider या service name से local IronClaw extension catalog खोजें",
  "tools.description.builtin.extension_install": "खोजे गए IronClaw extension को durable local-dev lifecycle state में install करें",
  "tools.description.builtin.extension_activate": "installed IronClaw extension को model-visible local-dev capability surface के लिए activate करें",
  "tools.description.builtin.extension_remove": "installed IronClaw extension को durable local-dev lifecycle state से हटाएं",
