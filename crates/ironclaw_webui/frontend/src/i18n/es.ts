...
registerPack("es", {
  ...
  "admin.users.newManagedAgent": "Nuevo agente administrado",
  "admin.users.createManagedAgent": "Crear agente administrado",
  "admin.users.managedAgent": "Agente administrado",
  "admin.users.emptyDescription":
    "Invita a una persona a iniciar sesión o crea un agente sin inicio de sesión administrado por los administradores del espacio.",
  "admin.users.issueLoginToken": "Emitir un token de inicio de sesión",
  "admin.users.issueLoginTokenDesc": "Opcional. El token se muestra una sola vez y permite iniciar sesión como este usuario privado.",
  "admin.users.loginTokenReady": "Token de inicio de sesión creado",
  "admin.users.loginTokenOnce": "Copia este token ahora. No volverá a mostrarse.",
  ...
  "admin.user.managedRoleLocked":
    "Los agentes administrados siempre son miembros y no se pueden habilitar para iniciar sesión.",
  ...
  "admin.user.secrets.adminRequired": "Se requiere iniciar sesión como administrador del espacio",
  "admin.user.secrets.adminRequiredDesc":
    "El operador del host puede administrar el ciclo de vida de este agente, pero las credenciales del sujeto solo están disponibles para un administrador activo del espacio.",
