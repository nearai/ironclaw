...
registerPack("es", {
  ...
  "tools.description.builtin.memory_search": "Buscar documentos de memoria persistente de IronClaw en el ámbito actual",
  "tools.description.builtin.memory_write": "Escribir, anexar o parchear documentos de memoria persistente de IronClaw en el ámbito actual",
  "tools.description.builtin.memory_read": "Leer un documento de memoria persistente de IronClaw en el ámbito actual",
  "tools.description.builtin.memory_tree": "Listar documentos de memoria persistente de IronClaw como un árbol compacto",
  ...
  "tools.description.builtin.skill_list": "Listar skills de sistema de archivos IronClaw visibles para el agente local actual",
  ...
  "tools.description.builtin.skill_remove": "Eliminar una skill de sistema de archivos IronClaw instalada por el usuario",
  ...
  "tools.description.builtin.extension_search": "Buscar en el catálogo local de extensiones de IronClaw por extensión, producto, proveedor o nombre de servicio",
  "tools.description.builtin.extension_install": "Instalar una extensión de IronClaw encontrada en el estado duradero del ciclo de vida local-dev",
  "tools.description.builtin.extension_activate": "Activar una extensión de IronClaw instalada para la superficie de capacidades local-dev visible para el modelo",
  "tools.description.builtin.extension_remove": "Eliminar una extensión de IronClaw instalada del estado duradero del ciclo de vida local-dev",
