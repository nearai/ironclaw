...
use ironclaw_event_projections::{
    CapabilityActivityProjection, CapabilityActivityProjectionWindow, CapabilityActivityStatus,
    EventProjectionService, ProjectionCursor, ProjectionError, ProjectionReplay,
    ProjectionRequest, ProjectionScope, ProjectionSnapshot, RunProjectionStatus,
    RunStatusProjection, ThreadTimeline, TimelineEntry, TimelineEntryKind,
};
