...
`crates/events/ironclaw_event_store/`. Keep storage drivers out of this
...
`crates/app/ironclaw_architecture_tests/tests/reborn_dependency_boundaries.rs`; if the
