...
- Top-level factories for runtime/profile inputs, storage substrate wiring, and LLM catalog wiring: `RebornBuildInput`/`RebornBuildError` and the feature-gated LLM catalog resolvers (`llm_admin::llm_catalog`).
