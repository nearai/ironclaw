...
| Operator logs | `src/cli/logs.rs` command path | `POST /api/webchat/v2/operator/logs/query` | Route and facade shell mapped; default runtime returns unavailable until a log backend is wired |
