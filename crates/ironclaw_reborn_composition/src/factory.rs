...
mod tests {
    ...
    use ironclaw_auth::{
        ...
        NewAuthFlow, OAuthAuthorizationCode, OAuthProviderCallbackRequest, OpaqueStateHash,
        PkceVerifierHash, PkceVerifierSecret, TurnRunRef,
    };
    use ironclaw_host_api::{
        AgentId, InvocationId, ProjectId, ResourceScope, TenantId, ThreadId, UserId,
    };
    use ironclaw_turns::{
        AcceptedMessageRef, BlockedReason, GetRunStateRequest, IdempotencyKey,
        LoopCheckpointStateRef, ReplyTargetBindingRef, RunProfileRequest, SourceBindingRef,
        SubmitTurnRequest, SubmitTurnResponse, TurnActor, TurnCheckpointId, TurnLeaseToken,
    ...
    async fn local_dev_oauth_turn_gate_callback_resumes_default_turn_coordinator() {
        ...
        let submit = turn_coordinator
            .submit_turn(SubmitTurnRequest {
                ...
                reply_target_binding_ref: ReplyTargetBindingRef::new("reply-auth-callback")
                    .unwrap(),
            ...
            .handle_oauth_callback(crate::RebornOAuthCallbackRequest {
                ...
                outcome: crate::RebornOAuthCallbackOutcome::Authorized {
                    provider_request: OAuthProviderCallbackRequest {
                        ...
                        .unwrap(),
                        authorization_code_hash: AuthorizationCodeHash::new("code-hash").unwrap(),
    ...
    fn state_hash() -> OpaqueStateHash {
        OpaqueStateHash::new("state-hash").unwrap()
    }

    fn pkce_hash() -> PkceVerifierHash {
        PkceVerifierHash::new("pkce-hash").unwrap()
    }
}
