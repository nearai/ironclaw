// arch-exempt: large_file, mechanical extraction of factory.rs's `#[cfg(test)] mod tests` — behavior unchanged, shrinks factory.rs 8566->5599 and retires it from the deployment-mode branching ratchet, plan #6274
use super::*;
