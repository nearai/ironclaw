...
- Own network policy evaluation, DNS/private-IP enforcement, redirect policy, response limits, and outbound HTTP transport for host-mediated IronClaw runtime egress.
