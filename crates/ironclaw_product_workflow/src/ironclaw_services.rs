//! WebUI-facing IronClaw service facade.
//!
...
pub use admin_users::{
    ...
    AdminUserSecretMeta, AdminUserService, AdminUserStatus, IronClawAdminCreateUserRequest,
    ...
    IronClawAdminUserSecretsListResponse,
};
pub use error::{IronClawServicesError, IronClawServicesErrorCode, IronClawServicesErrorKind};
pub use trace_credits::{
    IronClawAccountLoginLinkResponse, IronClawAccountTrace, IronClawAccountTracesResponse,
    IronClawTraceCreditsResponse, IronClawTraceHoldAuthorizeResponse, TRACE_ACCOUNT_TRACES_VIEW,
    TRACE_CREDITS_VIEW,
};

pub use extensions::{EXTENSION_REGISTRY_VIEW, EXTENSIONS_VIEW};
pub use fs_browse::{
    FilesystemBrowseReader, FsMount, IronClawFsListRequest, IronClawFsListResponse,
    IronClawFsMountInfo, IronClawFsMountsRequest, IronClawFsMountsResponse, IronClawFsReadRequest,
    IronClawFsStatRequest, IronClawFsStatResponse,
};
...
pub use outbound_preferences::IronClawOutboundPreferencesFacade;
...
pub use project_fs::{
    ...
    IronClawProjectFsStatRequest, IronClawProjectFsStatResponse, ProjectFilesystemReader,
...
pub use run_artifact::{
    IronClawRunArtifact, IronClawRunArtifactRequest, RUN_ARTIFACT_SCHEMA, RUN_ARTIFACT_VIEW,
    RunArtifactLogs, RunArtifactMessage, RunArtifactRedaction, RunArtifactToolCall,
};
pub use types::{
    IronClawAccountBindingSource, IronClawAttachmentBytes, IronClawAttachmentRequest,
    ...
    IronClawChannelConnectAction, IronClawChannelConnectStrategy, IronClawCreateThreadResponse,
    ...
    IronClawExtensionSetupSecret, IronClawExtensionSurface, IronClawGetRunStateRequest,
    ...
    IronClawListThreadsResponse, IronClawLogEntry, IronClawLogLevel, IronClawLogQueryRequest,
    IronClawLogQueryResponse, IronClawOperatorArea, IronClawOperatorCommandPlaneResponse,
    IronClawOperatorConfigDiagnostic, IronClawOperatorConfigDiagnosticSeverity,
    IronClawOperatorConfigEntry, IronClawOperatorConfigGetResponse,
    ...
    IronClawOperatorServiceLifecycleAction, IronClawOperatorServiceLifecycleRequest,
    IronClawOperatorSetupRequest, IronClawOperatorSetupResponse, IronClawOperatorSetupStatus,
    IronClawOperatorSetupStep, IronClawOperatorSetupStepStatus, IronClawOperatorStatusCheck,
    IronClawOperatorStatusResponse, IronClawOperatorStatusSeverity, IronClawOperatorStatusState,
    IronClawOperatorSurfaceStatus, IronClawOutboundDeliveryModality,
    ...
    IronClawRenameAutomationProductRequest, IronClawResolveGateResponse,
    IronClawResumeGateResponse, IronClawRetryRunResponse, IronClawServiceLifecycleAction,
    IronClawServiceLifecycleRequest, IronClawServiceLifecycleResponse,
    IronClawServiceLifecycleState, IronClawSetOutboundPreferencesRequest,
    ...
    IronClawTimelineRequest, IronClawTimelineResponse, IronClawTraceHoldAuthorizeProductRequest,
    IronClawVendorAuthAccounts,
};
pub use views::{
    ...
    ProductOperationTypedInput, ProductView, UnavailableIronClawViewProvider,
};

type SkillActivationRecorder = dyn Fn(&TurnScope, &AcceptedMessageRef, &str) -> Result<(), IronClawServicesError>
    + Send
    + Sync;
type SkillActivationClearer =
    dyn Fn(&TurnScope, &AcceptedMessageRef) -> Result<(), IronClawServicesError> + Send + Sync;
...
pub const RESOLVE_GATE_OPERATION: ProductOperation<
    ...
    IronClawResolveGateResponse,
> = ProductOperation::new(ProductOperationId::ResolveGate);
pub const RETRY_RUN_OPERATION: ProductOperation<WebUiRetryRunRequest, IronClawRetryRunResponse> =
...
pub const PROJECT_CREATE_OPERATION: ProductOperation<
    ...
    IronClawProjectResponse,
> = ProductOperation::new(ProductOperationId::ProjectCreate);
pub const PROJECT_FS_READ_OPERATION: ProductOperation<IronClawProjectFsReadRequest, ProjectFsFile> =
    ProductOperation::new(ProductOperationId::ProjectFsRead);
pub const FS_READ_OPERATION: ProductOperation<IronClawFsReadRequest, ProjectFsFile> =
...
pub const OPERATOR_CONFIG_SET_KEY_OPERATION: ProductOperation<
    ...
    IronClawOperatorConfigGetResponse,
...
pub const OPERATOR_SERVICE_LIFECYCLE_OPERATION: ProductOperation<
    IronClawOperatorServiceLifecycleRequest,
...
pub const THREADS_VIEW: ProductView<WebUiListThreadsRequest, IronClawListThreadsResponse> =
    ProductView::paginated("threads");
pub const TIMELINE_VIEW: ProductView<IronClawTimelineRequest, IronClawTimelineResponse> =
    ProductView::paginated("timeline");
pub const GLOBAL_AUTO_APPROVE_VIEW: ProductView<
    IronClawGlobalAutoApproveRequest,
    IronClawGlobalAutoApproveResponse,
> = ProductView::unpaginated("global_auto_approve");
pub const AUTOMATIONS_VIEW: ProductView<
    WebUiListAutomationsRequest,
    IronClawListAutomationsResponse,
> = ProductView::unpaginated("automations");
pub const PROJECT_FS_LIST_VIEW: ProductView<
    IronClawProjectFsListRequest,
    IronClawProjectFsListResponse,
> = ProductView::unpaginated("project_fs_list");
pub const PROJECT_FS_STAT_VIEW: ProductView<
    IronClawProjectFsStatRequest,
    IronClawProjectFsStatResponse,
> = ProductView::unpaginated("project_fs_stat");
pub const FS_MOUNTS_VIEW: ProductView<IronClawFsMountsRequest, IronClawFsMountsResponse> =
    ProductView::unpaginated("fs_mounts");
pub const FS_LIST_VIEW: ProductView<IronClawFsListRequest, IronClawFsListResponse> =
    ProductView::unpaginated("fs_list");
pub const FS_STAT_VIEW: ProductView<IronClawFsStatRequest, IronClawFsStatResponse> =
    ProductView::unpaginated("fs_stat");
pub const PROJECTS_VIEW: ProductView<IronClawListProjectsRequest, IronClawListProjectsResponse> =
    ProductView::unpaginated("projects");
pub const PROJECT_VIEW: ProductView<IronClawGetProjectRequest, IronClawProjectResponse> =
    ProductView::unpaginated("project");
pub const PROJECT_MEMBERS_VIEW: ProductView<
    IronClawListMembersRequest,
    IronClawListMembersResponse,
> = ProductView::unpaginated("project_members");
pub const ADMIN_USERS_VIEW: ProductView<IronClawAdminUserListQuery, IronClawAdminUserListResponse> =
    ProductView::paginated("admin_users");
pub const ADMIN_USER_VIEW: ProductView<IronClawAdminUserRequest, IronClawAdminUserResponse> =
...
pub const SKILLS_VIEW: ProductView<serde_json::Value, IronClawSkillListResponse> =
    ProductView::unpaginated("skills");
pub const SKILL_SEARCH_VIEW: ProductView<serde_json::Value, IronClawSkillSearchResponse> =
    ProductView::unpaginated("skill_search");
pub const SKILL_CONTENT_VIEW: ProductView<serde_json::Value, IronClawSkillContentResponse> =
    ProductView::unpaginated("skill_content");

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct IronClawOperatorToolInfo {
...
#[async_trait]
pub trait IronClawOperatorToolCatalog: Send + Sync {
    ...
    async fn list_operator_tools(&self, caller: &UserId) -> Vec<IronClawOperatorToolInfo>;
}

#[derive(Clone)]
struct IronClawOperatorApprovalConfig {
...
pub trait ChannelConnectionFacade: Send + Sync {
    ...
    ) -> Result<std::collections::HashMap<String, ChannelAuthAccountState>, IronClawServicesError>
    {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct IronClawChannelConfigField {
...
pub trait ChannelConfigFacade: Send + Sync {
    ...
    ) -> Result<Vec<IronClawChannelConfigField>, IronClawServicesError>;
...
pub struct StaticOperatorStatusService {
    response: IronClawOperatorStatusResponse,
}

impl StaticOperatorStatusService {
    pub fn new(response: IronClawOperatorStatusResponse) -> Self {
        Self { response }
    }
}
...
pub trait OperatorLogsService: Send + Sync {
    async fn query_logs(
        &self,
        caller: WebUiAuthenticatedCaller,
        request: IronClawLogQueryRequest,
...
impl OperatorLogsService for UnsupportedOperatorLogsService {
    async fn query_logs(
        &self,
        _caller: WebUiAuthenticatedCaller,
        _request: IronClawLogQueryRequest,
    ) -> Result<IronClawLogQueryResponse, IronClawServicesError> {
        Err(operator_surface_unavailable())
    }
}
...
pub trait OutboundPreferencesProductFacade: Send + Sync {
    ...
    /// `IronClawServices` installs `UnsupportedOutboundPreferencesProductFacade`
    ...
    /// identity. `IronClawServices` installs
...
pub trait AutomationProductFacade: Send + Sync {
    ...
    /// `IronClawServicesError` so outages do not masquerade as authorization
    /// misses.
    ///
...
impl GateResolutionRoute {
    ...
    ) -> Result<Self, IronClawServicesError> {
        match status {
            TurnStatus::BlockedApproval => {
                validate_current_gate_ref(
                    parked_gate_ref,
                    requested_gate_ref,
                    IronClawServicesErrorKind::BlockedApproval,
                )?;
                Ok(Self::Approval)
            }
            TurnStatus::BlockedAuth => {
                validate_current_gate_ref(
                    parked_gate_ref,
                    requested_gate_ref,
                    IronClawServicesErrorKind::BlockedAuthentication,
                )?;
                Ok(Self::Auth)
            }
            status if status.is_terminal() => Err(IronClawServicesError::from_status_kind(
...
fn operator_setup_validation_error(field: &str) -> IronClawServicesError {
...
/// Stable WebUI-facing facade surface for beta IronClaw routes.
fn operator_setup_diagnostic(
    key: &str,
    severity: IronClawOperatorConfigDiagnosticSeverity,
    reason_code: &str,
    message: &str,
    remediation: &str,
    ...
    IronClawOperatorConfigDiagnostic {
        ...
        owning_area: IronClawOperatorArea::Setup,
...
) -> Result<Option<String>, IronClawServicesError> {
...
fn reject_unwired_operator_setup_host_mutation(
    ...
    if profile_id.is_some() || webui_access_token_updated {
        return Err(IronClawServicesError::service_unavailable(false));
    }
    Ok(())
}
...
fn setup_response_from_llm_snapshot(
    ...
    diagnostics: Vec<IronClawOperatorConfigDiagnostic>,
    host_state: OperatorSetupHostState,
) -> IronClawOperatorSetupResponse {
    ...
    let status = if provider_complete && model_complete {
        IronClawOperatorSetupStatus::Complete
    } else {
        IronClawOperatorSetupStatus::Incomplete
    };
    ...
    IronClawOperatorSetupResponse {
        ...
        active_model,
        steps: vec![
            IronClawOperatorSetupStep {
                name: "provider".to_string(),
                status: if provider_complete {
                    IronClawOperatorSetupStepStatus::Complete
                } else {
                    IronClawOperatorSetupStepStatus::Required
                },
                message: if provider_complete {
            ...
            IronClawOperatorSetupStep {
                ...
                status: IronClawOperatorSetupStepStatus::Complete,
...
fn operator_config_not_wired_response() -> IronClawOperatorConfigListResponse {
    IronClawOperatorConfigListResponse {
        entries: Vec::new(),
        precedence: Vec::new(),
...
fn operator_config_unknown_key_error(field: &'static str) -> IronClawServicesError {
...
fn operator_config_invalid_value(field: &'static str) -> IronClawServicesError {
    IronClawServicesError::validation(WebUiInboundValidationError::new(
        field,
...
fn operator_config_store_error(error: impl std::fmt::Display) -> IronClawServicesError {
    IronClawServicesError::internal_from(error)
}

fn operator_config_capability_forbidden() -> IronClawServicesError {
    IronClawServicesError::from_status(IronClawServicesErrorCode::Forbidden, 403, false)
}

fn product_view_forbidden() -> IronClawServicesError {
    IronClawServicesError::from_status(IronClawServicesErrorCode::Forbidden, 403, false)
}
...
fn operator_config_mutation_succeeded(resolution: Resolution) -> Result<(), IronClawServicesError> {
    match resolution {
        ...
        Resolution::Done(outcome) => match outcome.verdict.error_kind() {
            ...
            Some(FailureKind::Backend | FailureKind::Transient | FailureKind::Unavailable) => {
                Err(IronClawServicesError::service_unavailable(true))
            }
...
async fn auto_approve_config_entry(
    config: &IronClawOperatorApprovalConfig,
    scope: &ResourceScope,
) -> Result<IronClawOperatorConfigEntry, IronClawServicesError> {
    ...
    Ok(IronClawOperatorConfigEntry {
...
async fn find_operator_tool(
    ...
    caller: &UserId,
) -> Result<IronClawOperatorToolInfo, IronClawServicesError> {
...
async fn operator_tool_permission_context(
    config: &IronClawOperatorApprovalConfig,
    scope: &ResourceScope,
    tools: &[IronClawOperatorToolInfo],
) -> Result<OperatorToolPermissionContext, IronClawServicesError> {
    let operator_scope = operator_tool_permission_scope(scope);
...
async fn effective_tool_permission(
    context: &OperatorToolPermissionContext,
    tool: &IronClawOperatorToolInfo,
) -> Result<(ToolPermissionState, &'static str), IronClawServicesError> {
...
) -> Result<ToolPermissionUpdate, IronClawServicesError> {
    let raw = value
        .as_str()
...
/// screens literal IPs.
fn validate_llm_base_url(base_url: Option<&str>) -> Result<(), IronClawServicesError> {
...
fn operator_doctor_status_diagnostic(
    check: &IronClawOperatorStatusCheck,
) -> Option<IronClawOperatorConfigDiagnostic> {
    if check.status == IronClawOperatorStatusState::Ready {
        return None;
    }

    let severity = match check.severity {
        IronClawOperatorStatusSeverity::Info => IronClawOperatorConfigDiagnosticSeverity::Info,
        IronClawOperatorStatusSeverity::Warning => {
            IronClawOperatorConfigDiagnosticSeverity::Warning
        }
        IronClawOperatorStatusSeverity::Critical => IronClawOperatorConfigDiagnosticSeverity::Error,
    };
    let state = match check.status {
        IronClawOperatorStatusState::Ready => "ready",
        IronClawOperatorStatusState::Degraded => "degraded",
        IronClawOperatorStatusState::Blocked => "blocked",
        IronClawOperatorStatusState::Unsupported => "unsupported",
        IronClawOperatorStatusState::NotConfigured => "not_configured",
    };
...
fn operator_doctor_status_check(
    mut check: IronClawOperatorStatusCheck,
...
fn operator_doctor_setup_unavailable_diagnostic(
    ...
    operator_setup_diagnostic(
        "setup",
        IronClawOperatorConfigDiagnosticSeverity::Error,
        reason_code,
        message,
...
fn operator_doctor_status_unavailable_diagnostic() -> IronClawOperatorConfigDiagnostic {
    IronClawOperatorConfigDiagnostic {
...
fn operator_diagnostics_surface_status(
    diagnostics: &[IronClawOperatorConfigDiagnostic],
) -> IronClawOperatorSurfaceStatus {
    if diagnostics
        .iter()
        .any(|diagnostic| diagnostic.severity == IronClawOperatorConfigDiagnosticSeverity::Error)
    {
        IronClawOperatorSurfaceStatus::Unavailable
    } else {
        IronClawOperatorSurfaceStatus::Available
    }
}
...
pub trait ProductSurface: Send + Sync {
    ...
    async fn subscribe_events(
        ...
        Err(IronClawServicesError::from_status_kind(
            IronClawServicesErrorCode::Unavailable,
            IronClawServicesErrorKind::ReplayUnavailable,
            503,
            true,
        ))
    }
...
impl<Params> ProductOperation<Params, IronClawAttachmentBytes>
where
    Params: Serialize,
{
...
impl ProductCapabilityInput {
    ...
    pub fn into_json(self) -> Result<serde_json::Value, IronClawServicesError> {
        match self {
            Self::Json(input) => Ok(input),
            Self::LlmProviderUpsert(_) => Err(IronClawServicesError::internal_from(
...
impl ProductCapabilityDescriptor {
    ...
    pub fn capability_id(&self) -> Result<CapabilityId, IronClawServicesError> {
        CapabilityId::new(self.id).map_err(IronClawServicesError::internal_from)
    }
...
pub trait InboundAttachmentReader: Send + Sync {
    async fn read(
        ...
        thread_scope: &ThreadScope,
        storage_key: &str,
    ) -> Result<Vec<u8>, IronClawServicesError>;
}
...
#[derive(Clone)]
pub struct IronClawServices<
    I = UnavailableProductCapabilityInvoker,
    V = UnavailableIronClawViewProvider,
> {
    ...
    operator_approval_config: Option<IronClawOperatorApprovalConfig>,
    thread_operation_locks: Arc<ThreadOperationLocks>,
}

impl IronClawServices<UnavailableProductCapabilityInvoker, UnavailableIronClawViewProvider> {
    pub fn new(
        thread_service: Arc<dyn SessionThreadService>,
        turn_coordinator: Arc<dyn TurnCoordinator>,
    ) -> Self {
        Self::new_with_product_ports(
            ...
            UnavailableIronClawViewProvider,
        )
    }
}

impl<I> IronClawServices<I, UnavailableIronClawViewProvider>
where
    ...
    V: IronClawViewProvider + Clone + 'static,
{
    pub fn new_with_product_ports(
        ...
        Self {
            ...
            lifecycle_facade: Arc::new(UnsupportedLifecycleProductFacade::new_static(
                "ironclaw_lifecycle_facade_unwired",
            )),
    ...
    pub fn with_operator_approval_config(
        ...
        self.operator_approval_config = Some(IronClawOperatorApprovalConfig {
            overrides,
            auto_approve,
            persistent_policies,
            tool_catalog,
    ...
    fn api_capability_success(
        ...
        Ok(Resolution::Done(Outcome {
            ...
            summary: SafeSummary::new(summary).map_err(IronClawServicesError::internal_from)?,
    ...
    async fn invoke_operator_setup_run(
        ...
        let request: IronClawOperatorSetupRequest =
    ...
    async fn apply_operator_setup_request(
        &self,
        caller: WebUiAuthenticatedCaller,
        request: IronClawOperatorSetupRequest,
    ) -> Result<(), IronClawServicesError> {
    ...
    async fn build_automations_view(
    ...
    ) -> Result<IronClawListAutomationsResponse, IronClawServicesError> {
        let Some(caller) = product_agent_bound_caller_from_webui(caller) else {
            return Err(IronClawServicesError::from_status(
        ...
        let automations = self
            ...
            .await?;
        Ok(IronClawListAutomationsResponse {
            automations,
            scheduler_enabled,
        })
    }
    ...
    ) -> Result<IronClawListThreadsResponse, IronClawServicesError> {
    ...
    where
        F: Fn(&TurnScope, &AcceptedMessageRef, &str) -> Result<(), IronClawServicesError>
            + Send
            + Sync
            + 'static,
    {
    ...
    where
        R: Fn(&TurnScope, &AcceptedMessageRef, &str) -> Result<(), IronClawServicesError>
            + Send
            + Sync
            + 'static,
        C: Fn(&TurnScope, &AcceptedMessageRef) -> Result<(), IronClawServicesError>
            + Send
            + Sync
            + 'static,
    {
    ...
    async fn authorize_admin(
        ...
        match record {
            ...
            _ => Err(IronClawServicesError::from_status(
    ...
    async fn require_admin_target(
        ...
        tenant: &TenantId,
        user_id: &UserId,
    ) -> Result<AdminUserRecord, IronClawServicesError> {
        self.admin_users
            .get_user(tenant, user_id)
            .await
            .map_err(map_admin_user_error)?
            .ok_or_else(|| {
                IronClawServicesError::from_status(IronClawServicesErrorCode::NotFound, 404, false)
            })
    }
...
fn map_admin_user_error(error: AdminUserError) -> IronClawServicesError {
    match error {
        ...
        AdminUserError::InvalidInput => IronClawServicesError::from_status(
            IronClawServicesErrorCode::InvalidRequest,
            400,
            false,
        ),
        // Transient backend failure — the browser may retry.
        AdminUserError::Unavailable => IronClawServicesError::service_unavailable(true),
        AdminUserError::Internal => IronClawServicesError::internal(),
    }
}
...
fn last_admin_error() -> IronClawServicesError {
    ...
    V: IronClawViewProvider + Clone + 'static,
{
    async fn execute_product_surface_operation(
        ...
        let operation_id = ProductOperationId::parse(request.operation_id.as_str())
            .ok_or_else(|| IronClawServicesError::service_unavailable(false))?;
        match operation_id {
            ...
            ProductOperationId::TraceHoldAuthorize => {
                let request: IronClawTraceHoldAuthorizeProductRequest =
            ...
            ProductOperationId::AutomationPause => {
                let request: IronClawAutomationRequest = product_command_input(request.input)?;
                ProductOperationResponse::json(
    ...
    async fn authorize_trace_hold(
    ...
    ) -> Result<IronClawTraceHoldAuthorizeResponse, IronClawServicesError> {
        let actor = caller.actor();
        ...
        let scope = ironclaw_traces::contribution::trace_scope_key(
            caller.tenant_id.as_str(),
        ...
        let authorized =
            trace_credits::authorize_trace_hold_for_user(&scope, submission).map_err(|error| {
                ...
                IronClawServicesError::internal_invariant()
            })?;
        Ok(IronClawTraceHoldAuthorizeResponse { authorized })
    }
    ...
    pub async fn list_admin_users(
        &self,
        caller: WebUiAuthenticatedCaller,
        query: IronClawAdminUserListQuery,
    ) -> Result<IronClawAdminUserListResponse, IronClawServicesError> {
        ...
        let after = match query.cursor.as_deref() {
            Some(raw) => Some(UserId::new(raw).map_err(|_| {
                IronClawServicesError::from_status(
                    IronClawServicesErrorCode::InvalidRequest,
                    400,
                    false,
                )
        ...
        let next_cursor = (users.len() == limit)
            ...
            .flatten();
        Ok(IronClawAdminUserListResponse { users, next_cursor })
    }
    ...
    pub async fn get_admin_user(
        ...
        caller: WebUiAuthenticatedCaller,
        user_id: UserId,
    ) -> Result<IronClawAdminUserResponse, IronClawServicesError> {
        self.authorize_admin(&caller).await?;
        let user = self
            .require_admin_target(&caller.tenant_id, &user_id)
            .await?;
        Ok(IronClawAdminUserResponse { user })
    }

    pub async fn create_admin_user(
        &self,
        caller: WebUiAuthenticatedCaller,
        request: IronClawAdminCreateUserRequest,
    ) -> Result<IronClawAdminUserCreatedResponse, IronClawServicesError> {
        self.authorize_admin(&caller).await?;
        let created = self
            .admin_users
            .create_user(
            ...
            .await
            .map_err(map_admin_user_error)?;
        Ok(IronClawAdminUserCreatedResponse {
            user: created.record,
    ...
    pub async fn update_admin_user(
        ...
        caller: WebUiAuthenticatedCaller,
        user_id: UserId,
        request: IronClawAdminUpdateUserRequest,
    ) -> Result<IronClawAdminUserResponse, IronClawServicesError> {
        self.authorize_admin(&caller).await?;
    ...
    pub async fn set_admin_user_status(
        ...
        caller: WebUiAuthenticatedCaller,
        user_id: UserId,
        request: IronClawAdminSetStatusRequest,
    ) -> Result<IronClawAdminUserResponse, IronClawServicesError> {
        self.authorize_admin(&caller).await?;
    ...
    pub async fn set_admin_user_role(
        ...
        caller: WebUiAuthenticatedCaller,
        user_id: UserId,
        request: IronClawAdminSetRoleRequest,
    ) -> Result<IronClawAdminUserResponse, IronClawServicesError> {
        self.authorize_admin(&caller).await?;
        // Serialize with concurrent role/status/delete on this tenant so the
        // last-admin count read below reflects any in-flight demotion.
    ...
    pub async fn delete_admin_user(
        ...
        caller: WebUiAuthenticatedCaller,
        user_id: UserId,
    ) -> Result<IronClawAdminUserDeletedResponse, IronClawServicesError> {
        self.authorize_admin(&caller).await?;
        // Serialize with concurrent role/status/delete on this tenant so the
        // last-admin count read below reflects any in-flight demotion.
        let _admin_guard = self.lock_admin_mutation(&caller.tenant_id).await;
        ...
        self.admin_users
            ...
            .await
            .map_err(map_admin_user_error)?;
        Ok(IronClawAdminUserDeletedResponse {
            user_id,
            deleted: true,
        })
    }
    ...
    pub async fn list_admin_user_secrets(
        ...
        caller: WebUiAuthenticatedCaller,
        user_id: UserId,
    ) -> Result<IronClawAdminUserSecretsListResponse, IronClawServicesError> {
        self.authorize_admin(&caller).await?;
        self.require_admin_target(&caller.tenant_id, &user_id)
            .await?;
        let secrets = self
            ...
            .await
            .map_err(map_admin_user_error)?;
        Ok(IronClawAdminUserSecretsListResponse { secrets })
    }
    ...
    pub async fn put_admin_user_secret(
        ...
        user_id: UserId,
        handle: SecretHandle,
        request: IronClawAdminPutSecretRequest,
    ) -> Result<IronClawAdminSecretResponse, IronClawServicesError> {
        self.authorize_admin(&caller).await?;
        self.require_admin_target(&caller.tenant_id, &user_id)
            .await?;
        let secret = self
            ...
            .await
            .map_err(map_admin_user_error)?;
        Ok(IronClawAdminSecretResponse { secret })
    }
    ...
    pub async fn delete_admin_user_secret(
        ...
        user_id: UserId,
        handle: SecretHandle,
    ) -> Result<IronClawAdminSecretDeletedResponse, IronClawServicesError> {
        self.authorize_admin(&caller).await?;
        self.require_admin_target(&caller.tenant_id, &user_id)
            .await?;
        ...
        let deleted = self
            ...
            .await
            .map_err(map_admin_user_error)?;
        Ok(IronClawAdminSecretDeletedResponse {
            handle: handle_str,
            deleted,
        })
    }
    ...
    pub async fn set_operator_config_key(
        ...
        Ok(IronClawOperatorConfigGetResponse { entry })
    }
    ...
    pub async fn create_thread(
        ...
        let WebUiInboundCommand::CreateThread {
            ...
            return Err(IronClawServicesError::internal_invariant());
        };
        ...
        Ok(IronClawCreateThreadResponse { thread })
    }
    ...
    pub async fn submit_turn(
        ...
        .await?
        {
            if replay.thread_id != scope.thread_id {
                return Err(IronClawServicesError::from_status_kind(
                    IronClawServicesErrorCode::Conflict,
                    IronClawServicesErrorKind::Duplicate,
                    409,
                    false,
                ));
            }
            match replay.status {
                MessageStatus::Submitted => {
                    ...
                    return Ok(IronClawSubmitTurnResponse::AlreadySubmitted {
                ...
                MessageStatus::RejectedBusy => {
                    ...
                    return Ok(IronClawSubmitTurnResponse::RejectedBusy {
                        thread_id: replay.thread_id,
                        accepted_message_ref: accepted_message_ref(replay.message_id.to_string())?,
                        active_run_id: None,
                        status: None,
        ...
        match self.turn_coordinator.submit_turn(submit).await {
            ...
            Err(TurnError::ThreadBusy(busy)) => {
                ...
                Ok(IronClawSubmitTurnResponse::RejectedBusy {
                    thread_id: handoff.thread_id,
                    accepted_message_ref,
    ...
    pub async fn delete_thread(
        &self,
        caller: WebUiAuthenticatedCaller,
        request: IronClawDeleteThreadRequest,
    ) -> Result<IronClawDeleteThreadResponse, IronClawServicesError> {
        ...
        Ok(IronClawDeleteThreadResponse {
            thread_id,
            deleted: true,
        })
    }
    ...
    async fn query(
        ...
        match query.view_id.as_str() {
            ...
            id if id == GLOBAL_AUTO_APPROVE_VIEW.id => {
                let _: IronClawGlobalAutoApproveRequest = serde_json::from_value(query.params)
                    .map_err(IronClawServicesError::internal_from)?;
                let enabled = self.global_auto_approve_enabled(caller).await?;
                views::view_page(IronClawGlobalAutoApproveResponse { enabled })
            }
            id if id == TIMELINE_VIEW.id => {
                let mut request: IronClawTimelineRequest = serde_json::from_value(query.params)
                    .map_err(IronClawServicesError::internal_from)?;
                request.cursor = query.cursor.or(request.cursor);
            ...
            id if id == FS_MOUNTS_VIEW.id => {
                let _: IronClawFsMountsRequest = serde_json::from_value(query.params)
                    .map_err(IronClawServicesError::internal_from)?;
            ...
            id if id == ADMIN_USERS_VIEW.id => {
                let mut request: IronClawAdminUserListQuery = serde_json::from_value(query.params)
                    .map_err(IronClawServicesError::internal_from)?;
                request.cursor = query.cursor.or(request.cursor);
            ...
            id if id == ADMIN_USER_VIEW.id => {
                let request: IronClawAdminUserRequest = serde_json::from_value(query.params)
                    .map_err(IronClawServicesError::internal_from)?;
            ...
            _ => Err(IronClawServicesError::not_found()),
        }
    }
    ...
    async fn list_project_dir(
        &self,
        caller: WebUiAuthenticatedCaller,
        request: IronClawProjectFsListRequest,
    ) -> Result<IronClawProjectFsListResponse, IronClawServicesError> {
        ...
        Ok(IronClawProjectFsListResponse { entries })
    }

    async fn stat_project_path(
        &self,
        caller: WebUiAuthenticatedCaller,
        request: IronClawProjectFsStatRequest,
    ) -> Result<IronClawProjectFsStatResponse, IronClawServicesError> {
        let reader = self.require_project_filesystem()?;
        let thread_scope = self
            .authorize_project_fs_access(caller, request.thread_id)
            .await?;
        ...
        let stat = reader
            ...
            .await
            .map_err(map_project_fs_error)?;
        Ok(IronClawProjectFsStatResponse { stat })
    }

    pub async fn read_project_file(
        &self,
        caller: WebUiAuthenticatedCaller,
        request: IronClawProjectFsReadRequest,
    ) -> Result<ProjectFsFile, IronClawServicesError> {
        let reader = self.require_project_filesystem()?;
        let thread_scope = self
            .authorize_project_fs_access(caller, request.thread_id)
    ...
    async fn list_fs_mounts(
        &self,
        _caller: WebUiAuthenticatedCaller,
    ) -> Result<IronClawFsMountsResponse, IronClawServicesError> {
        ...
        let mounts = self
            ...
            .unwrap_or_default();
        Ok(IronClawFsMountsResponse { mounts })
    }

    pub async fn browse_fs_dir(
        &self,
        caller: WebUiAuthenticatedCaller,
        request: IronClawFsListRequest,
    ) -> Result<IronClawFsListResponse, IronClawServicesError> {
    ...
    async fn stat_fs_path(
        &self,
        caller: WebUiAuthenticatedCaller,
        request: IronClawFsStatRequest,
    ) -> Result<IronClawFsStatResponse, IronClawServicesError> {
        let browser = self.require_filesystem_browser(request.mount)?;
        let scope = self
            .authorize_browse_scope(caller, request.project_id)
            .await?;
        ...
        let stat = browser
            ...
            .await
            .map_err(map_project_fs_error)?;
        Ok(IronClawFsStatResponse { stat })
    }
    ...
    ) -> Result<IronClawListProjectsResponse, IronClawServicesError> {
    ...
    ) -> Result<IronClawProjectResponse, IronClawServicesError> {
        let service = self.require_project_service()?;
        service
    ...
    ) -> Result<IronClawListMembersResponse, IronClawServicesError> {
        let service = self.require_project_service()?;
        service
    ...
    ) -> Result<IronClawProjectMemberInfo, IronClawServicesError> {
        let service = self.require_project_service()?;
        service
    ...
    async fn stream_events(
        ...
        Ok(IronClawStreamEventsResponse { events })
    }
    ...
    async fn subscribe_events(
        ...
        Ok(IronClawStreamEventsSubscription::new(receiver))
    }
    ...
    async fn get_run_state(
        ...
        Ok(IronClawGetRunStateResponse::from_run_state(
            state,
    ...
    pub async fn run_operator_service_lifecycle(
        ...
        let request = IronClawServiceLifecycleRequest {
            action: match request.action {
                IronClawOperatorServiceLifecycleAction::Install => {
                    IronClawServiceLifecycleAction::Install
                }
                IronClawOperatorServiceLifecycleAction::Start => {
                    IronClawServiceLifecycleAction::Start
                }
                IronClawOperatorServiceLifecycleAction::Stop => {
                    IronClawServiceLifecycleAction::Stop
                }
                IronClawOperatorServiceLifecycleAction::Status => {
                    IronClawServiceLifecycleAction::Status
                }
            },
        };
        ...
        let status = match service_lifecycle.state {
            IronClawServiceLifecycleState::Installed
            | IronClawServiceLifecycleState::Running
            | IronClawServiceLifecycleState::Stopped
            | IronClawServiceLifecycleState::Unknown => IronClawOperatorSurfaceStatus::Available,
            IronClawServiceLifecycleState::Unsupported | IronClawServiceLifecycleState::Failed => {
                IronClawOperatorSurfaceStatus::Unavailable
            }
        };
        Ok(IronClawOperatorCommandPlaneResponse {
            area: IronClawOperatorArea::ServiceLifecycle,
            status,
    ...
    ) -> Result<NearAiLoginStart, IronClawServicesError> {
        let service = self
            .llm_config
            .as_ref()
            .ok_or_else(llm_config::llm_config_unavailable)?;
    ...
    pub async fn start_codex_login(
        &self,
        caller: WebUiAuthenticatedCaller,
    ) -> Result<CodexLoginStart, IronClawServicesError> {
        let service = self
            .llm_config
            .as_ref()
            .ok_or_else(llm_config::llm_config_unavailable)?;
    ...
    ) -> Result<NearAiWalletLoginResult, IronClawServicesError> {
        let service = self
            .llm_config
            .as_ref()
            .ok_or_else(llm_config::llm_config_unavailable)?;
...
#[async_trait]
impl<I, V> ProductSurface for IronClawServices<I, V>
where
    I: ProductCapabilityInvoker + Clone + 'static,
    V: IronClawViewProvider + Clone + 'static,
{
    async fn create_thread(
        ...
        IronClawServices::create_thread(self, caller, request).await
    }
    ...
    async fn submit_turn(
        ...
        IronClawServices::submit_turn(self, caller, request).await
    }
    ...
    async fn cancel_run(
        ...
        IronClawServices::cancel_run(self, caller, request).await
    }
    ...
    async fn invoke(
        ...
        IronClawServices::invoke(self, caller, capability, input, activity_id).await
    }
    ...
    async fn query(
        ...
        IronClawServices::query(self, caller, query).await
    }
    ...
    async fn stream_events(
        ...
        IronClawServices::stream_events(self, caller, request).await
    }

    fn supports_stream_events_subscription(&self) -> bool {
        IronClawServices::supports_stream_events_subscription(self)
    }
    ...
    async fn subscribe_events(
        ...
        IronClawServices::subscribe_events(self, caller, request).await
    }
    ...
    async fn get_run_state(
        ...
        IronClawServices::get_run_state(self, caller, request).await
    }
    ...
    V: IronClawViewProvider,
{
    async fn list_visible_threads_for_scope(
        ...
        Ok(IronClawListThreadsResponse {
    ...
    ) -> Result<Option<SessionThreadRecord>, IronClawServicesError> {
    ...
    ///
    /// Scope of the guarantee: this lock lives in the current `IronClawServices`
...
fn automation_unavailable() -> IronClawServicesError {
    IronClawServicesError::service_unavailable(true)
}
...
fn outbound_preferences_unavailable() -> IronClawServicesError {
    IronClawServicesError::service_unavailable(false)
}

fn operator_surface_unavailable() -> IronClawServicesError {
    IronClawServicesError::service_unavailable(false)
}
...
) -> Result<Option<(AcceptedInboundMessageReplay, String)>, IronClawServicesError> {
    let source_binding_id = webui_source_binding_id(scope, actor);
...
async fn replay_accepted_message(
    ...
    external_event_id: &str,
) -> Result<Option<AcceptedInboundMessageReplay>, IronClawServicesError> {
    thread_service
        .replay_accepted_inbound_message(ReplayAcceptedInboundMessageRequest {
            scope: thread_scope.clone(),
            actor_id: actor.user_id.as_str().to_string(),
    ...
    V: IronClawViewProvider + Clone + 'static,
{
    ...
    async fn check_automation_trigger_access(
        ...
        caller: WebUiAuthenticatedCaller,
        scope: &TurnScope,
        original_not_found_error: IronClawServicesError,
    ) -> Result<ResolvedThreadAccess, IronClawServicesError> {
    ...
    async fn resolve_thread_history_for_caller(
        ...
        caller: WebUiAuthenticatedCaller,
        scope: &TurnScope,
    ) -> Result<(ThreadScope, ThreadHistory), IronClawServicesError> {
        let thread_scope =
            ...
            .await
        {
            ...
            Err(
                ...
                let original_error = IronClawServicesError::from_status(
    ...
    fn require_project_filesystem(
        &self,
    ) -> Result<&Arc<dyn ProjectFilesystemReader>, IronClawServicesError> {
    ...
    fn require_filesystem_browser(
        &self,
        mount: FsMount,
    ) -> Result<&Arc<dyn FilesystemBrowseReader>, IronClawServicesError> {
        let browser = self
            .filesystem_browser
            .as_ref()
            .ok_or_else(|| IronClawServicesError::service_unavailable(false))?;
    ...
    fn require_project_service(&self) -> Result<&Arc<dyn ProjectService>, IronClawServicesError> {
    ...
    ) -> Result<WebUiAuthenticatedCaller, IronClawServicesError> {
    ...
    async fn authorize_browse_scope(
        ...
        caller: WebUiAuthenticatedCaller,
        project_id: Option<ProjectId>,
    ) -> Result<ResourceScope, IronClawServicesError> {
    ...
    async fn authorize_project_fs_access(
        ...
        caller: WebUiAuthenticatedCaller,
        thread_id: String,
    ) -> Result<ThreadScope, IronClawServicesError> {
    ...
    async fn resolve_webui_thread_metadata(
        ...
        scope: TurnScope,
        actor: &TurnActor,
    ) -> Result<(TurnScope, ThreadScope), IronClawServicesError> {
        let thread_scope = thread_scope_from_turn_scope(&scope, Some(actor.user_id.clone()))?;
    ...
    async fn resolve_approval_gate(
        ...
        match response {
            ...
            | ResolveApprovalInteractionResponse::Resumed(response) => {
                Ok(IronClawResolveGateResponse::Resumed(response.into()))
            }
        }
    }
    ...
    async fn gate_resolution_route(
        ...
        gate_ref: &GateRef,
        resolution: &WebUiGateResolution,
    ) -> Result<GateResolutionRoute, IronClawServicesError> {
    ...
    async fn resolve_auth_gate(
        ...
        match response {
            ...
            ResolveAuthInteractionResponse::Canceled(response) => {
                Ok(IronClawResolveGateResponse::Cancelled(response.into()))
            }
        }
    }
...
fn map_ownership_probe_error(error: SessionThreadError) -> IronClawServicesError {
    match &error {
        SessionThreadError::ThreadScopeMismatch { .. } => {
            IronClawServicesError::from_status(IronClawServicesErrorCode::NotFound, 404, false)
        }
...
fn map_project_fs_error(error: ProjectFsError) -> IronClawServicesError {
    match error {
        ...
        ProjectFsError::TooLarge { .. } => IronClawServicesError::from_status(
            IronClawServicesErrorCode::InvalidRequest,
            413,
            false,
        ),
        ProjectFsError::Unavailable => IronClawServicesError::service_unavailable(true),
        ProjectFsError::Internal => IronClawServicesError::internal(),
    }
}
...
fn product_capability_input_error(field: &'static str) -> IronClawServicesError {
    IronClawServicesError::validation(WebUiInboundValidationError::new(
        field,
        WebUiInboundValidationCode::InvalidValue,
    ))
...
fn product_command_input<T>(input: serde_json::Value) -> Result<T, IronClawServicesError>
where
    T: DeserializeOwned,
{
    serde_json::from_value(input).map_err(|error| {
...
fn product_secret_handle(handle: String) -> Result<SecretHandle, IronClawServicesError> {
...
fn map_project_service_error(error: ProjectServiceError) -> IronClawServicesError {
    match error {
        ...
        ProjectServiceError::InvalidInput { field } => {
            let mut error = IronClawServicesError::from_status(
                IronClawServicesErrorCode::InvalidRequest,
                400,
                false,
            );
        ...
        ProjectServiceError::Conflict => {
            IronClawServicesError::from_status(IronClawServicesErrorCode::Conflict, 409, false)
        }
        ProjectServiceError::Unavailable => IronClawServicesError::service_unavailable(true),
        ProjectServiceError::Internal => IronClawServicesError::internal(),
    }
}
...
fn validate_current_gate_ref(
    ...
    match parked_gate_ref {
        ...
        _ => Err(IronClawServicesError::from_status_kind(
            IronClawServicesErrorCode::Conflict,
            kind,
            409,
            false,
...
fn participant_denied() -> IronClawServicesError {
    IronClawServicesError::from_status_kind(
        IronClawServicesErrorCode::Forbidden,
...
fn parse_thread_id_field(
    field: &'static str,
    value: String,
) -> Result<ThreadId, IronClawServicesError> {
...
fn parse_run_id_field(
    field: &'static str,
    value: String,
) -> Result<TurnRunId, IronClawServicesError> {
...
fn parse_persisted_turn_run_id(value: &str) -> Result<TurnRunId, IronClawServicesError> {
    TurnRunId::parse(value).map_err(|_| IronClawServicesError::internal_invariant())
}

fn accepted_message_ref(message_id: String) -> Result<AcceptedMessageRef, IronClawServicesError> {
    AcceptedMessageRef::new(format!("msg:{message_id}")).map_err(|_| {
        IronClawServicesError::from_status(IronClawServicesErrorCode::Internal, 500, false)
    })
}

fn parse_replay_run_id(value: Option<String>) -> Result<TurnRunId, IronClawServicesError> {
...
fn webui_source_binding_ref_from_raw(
    prefix: &str,
    raw: &str,
) -> Result<ironclaw_turns::SourceBindingRef, IronClawServicesError> {
...
fn webui_reply_target_binding_ref_from_raw(
    prefix: &str,
    raw: &str,
) -> Result<ironclaw_turns::ReplyTargetBindingRef, IronClawServicesError> {
...
fn parse_automation_name(
    request: WebUiRenameAutomationRequest,
) -> Result<AutomationName, IronClawServicesError> {
    let Some(raw_name) = request.name else {
        return Err(IronClawServicesError::validation(
...
fn automation_name_validation_error(error: AutomationNameError) -> IronClawServicesError {
    IronClawServicesError::validation(WebUiInboundValidationError::new("name", error.into()))
}

fn notification_approval_timeout_error() -> IronClawServicesError {
    IronClawServicesError::service_unavailable(true)
}
...
fn parse_timeline_cursor(
    raw: Option<&str>,
) -> Result<Option<TimelineCursor>, IronClawServicesError> {
...
fn persistent_approval_unavailable() -> IronClawServicesError {
    IronClawServicesError::from_status_kind(
        IronClawServicesErrorCode::Unavailable,
        IronClawServicesErrorKind::BlockedApproval,
        503,
...
fn blocked_approval_unavailable() -> IronClawServicesError {
    persistent_approval_unavailable()
}

fn blocked_authentication_unavailable() -> IronClawServicesError {
    IronClawServicesError::from_status_kind(
        IronClawServicesErrorCode::Unavailable,
        IronClawServicesErrorKind::BlockedAuthentication,
        503,
...
fn map_timeline_probe_error(error: SessionThreadError) -> IronClawServicesError {
    match error {
        SessionThreadError::Serialization(_)
        | SessionThreadError::Deserialization(_)
        | SessionThreadError::InvalidMessageTimestamp { .. }
        | SessionThreadError::Backend(_) => IronClawServicesError::from_status_kind(
            IronClawServicesErrorCode::Unavailable,
            IronClawServicesErrorKind::TimelineUnavailable,
            503,
            true,
        ),
...
fn map_thread_error(error: SessionThreadError) -> IronClawServicesError {
    match error {
        ...
        SessionThreadError::InvalidAttachment(_) => IronClawServicesError::from_status_kind(
            IronClawServicesErrorCode::InvalidRequest,
        ...
        | SessionThreadError::Deserialization(_)
        | SessionThreadError::InvalidMessageTimestamp { .. }
        | SessionThreadError::Backend(_) => IronClawServicesError::service_unavailable(true),
    }
}

fn delete_thread_busy() -> IronClawServicesError {
    IronClawServicesError::from_status_kind(
        IronClawServicesErrorCode::Conflict,
        IronClawServicesErrorKind::Busy,
        409,
        false,
    )
}

fn map_turn_error(error: TurnError) -> IronClawServicesError {
    if matches!(error, TurnError::RunNotRetryable { .. }) {
        return IronClawServicesError::from_status_kind(
            IronClawServicesErrorCode::Conflict,
            IronClawServicesErrorKind::Conflict,
            409,
            false,
    ...
    let (code, kind, status_code, retryable) = match error.category() {
        ...
        ironclaw_turns::TurnErrorCategory::AdmissionRejected => (
            IronClawServicesErrorCode::RateLimited,
            IronClawServicesErrorKind::Busy,
            429,
            true,
        ),
    ...
    IronClawServicesError::from_status_kind(code, kind, status_code, retryable)
}

fn map_adapter_error(error: ProductAdapterError) -> IronClawServicesError {
    match error {
        ...
        ProductAdapterError::Authentication(_) => IronClawServicesError::from_status(
            IronClawServicesErrorCode::Unauthenticated,
            401,
            false,
        ),
        ProductAdapterError::MalformedInboundPayload { .. }
        | ProductAdapterError::InvalidIdentifier { .. } => IronClawServicesError::from_status(
            IronClawServicesErrorCode::InvalidRequest,
            400,
            false,
        ),
        ...
        | ProductAdapterError::EgressUndeclaredHost { .. } => {
            IronClawServicesError::from_status_kind(
                IronClawServicesErrorCode::Forbidden,
                IronClawServicesErrorKind::BlockedResource,
                403,
                false,
            )
        }
...
fn map_auth_interaction_error(error: ProductWorkflowError) -> IronClawServicesError {
    match error {
...
fn map_projection_error(error: ProductAdapterError) -> IronClawServicesError {
    match error {
        ProductAdapterError::WorkflowRejected {
        ...
        ProductAdapterError::WorkflowTransient { .. }
        | ProductAdapterError::EgressTransient { .. } => IronClawServicesError::from_status_kind(
            IronClawServicesErrorCode::Unavailable,
            IronClawServicesErrorKind::ReplayUnavailable,
            503,
            true,
...
fn code_for_status(status_code: u16) -> IronClawServicesErrorCode {
    match status_code {
        400 => IronClawServicesErrorCode::InvalidRequest,
        401 => IronClawServicesErrorCode::Unauthenticated,
        403 => IronClawServicesErrorCode::Forbidden,
        404 => IronClawServicesErrorCode::NotFound,
        409 => IronClawServicesErrorCode::Conflict,
        429 => IronClawServicesErrorCode::RateLimited,
        503 => IronClawServicesErrorCode::Unavailable,
        _ => IronClawServicesErrorCode::Internal,
    }
}

fn kind_for_workflow_rejection(kind: ProductWorkflowRejectionKind) -> IronClawServicesErrorKind {
    match kind {
        ProductWorkflowRejectionKind::ThreadBusy
        | ProductWorkflowRejectionKind::AdmissionRejected => IronClawServicesErrorKind::Busy,
        ProductWorkflowRejectionKind::ScopeNotFound => IronClawServicesErrorKind::NotFound,
        ProductWorkflowRejectionKind::Unauthorized => IronClawServicesErrorKind::ParticipantDenied,
        ProductWorkflowRejectionKind::InvalidRequest => IronClawServicesErrorKind::Validation,
        ProductWorkflowRejectionKind::Unavailable => IronClawServicesErrorKind::ServiceUnavailable,
...
fn validate_log_query_modes(tail: bool, follow: bool) -> Result<(), IronClawServicesError> {
    if tail && follow {
        return Err(IronClawServicesError::validation(
...
fn bounded_operator_logs_query(query: IronClawOperatorLogsQuery) -> IronClawLogQueryRequest {
    bounded_log_query(IronClawLogQueryRequest {
        limit: query.limit,
        cursor: query.cursor,
        level: query.level,
        target: query.target,
...
fn bounded_log_query(query: IronClawLogQueryRequest) -> IronClawLogQueryRequest {
    IronClawLogQueryRequest {
        limit: query
            .limit
...
mod tests {
    ...
    fn project_service_error_maps_to_sanitized_facade_error() {
        ...
        assert_eq!(not_found.code, IronClawServicesErrorCode::NotFound);
        assert_eq!(not_found.status_code, 404);

        let denied = map_project_service_error(ProjectServiceError::Denied);
        assert_eq!(denied.kind, IronClawServicesErrorKind::ParticipantDenied);
        assert_eq!(denied.status_code, 403);

        let invalid = map_project_service_error(ProjectServiceError::InvalidInput {
            field: "project_id".to_string(),
        });
        assert_eq!(invalid.code, IronClawServicesErrorCode::InvalidRequest);
        ...
        assert_eq!(conflict.code, IronClawServicesErrorCode::Conflict);
        assert_eq!(conflict.status_code, 409);

        let unavailable = map_project_service_error(ProjectServiceError::Unavailable);
        assert_eq!(unavailable.code, IronClawServicesErrorCode::Unavailable);
        ...
        assert_eq!(internal.code, IronClawServicesErrorCode::Internal);
    ...
    fn unwired_project_service_sentinel_is_503() {
        let unavailable = IronClawServicesError::service_unavailable(false);
        assert_eq!(unavailable.code, IronClawServicesErrorCode::Unavailable);
        assert_eq!(unavailable.status_code, 503);
        assert!(
