...
use ironclaw_host_api::{
    ActivityId, Blocked, CapabilitySurfaceKind, ExtensionId, FailureKind, Resolution,
};
...
use crate::{
    ...
    LifecycleProductResponse, LifecycleProductSurfaceContext, LifecyclePublicState, ProductSurface,
    ProductView, RebornAccountBindingSource, RebornAuthAccount, RebornExtensionActionResponse,
    ...
    RebornServicesErrorCode, RebornServicesErrorKind, RebornVendorAuthAccounts, RebornViewQuery,
...
pub async fn install_extension_on_surface<S>(
    surface: &S,
    ...
    S: ProductSurface + ?Sized,
{
    ...
    let page = surface
        ...
        .await?;
    let installed: RebornExtensionListResponse =
...
fn install_mutation_succeeded(resolution: Resolution) -> Result<(), RebornServicesError> {
    match resolution {
...
fn extension_install_forbidden() -> RebornServicesError {
    RebornServicesError {
...
fn extension_install_unavailable(retryable: bool) -> RebornServicesError {
    RebornServicesError {
