...
pub struct IronClawFsMountInfo {
    pub mount: FsMount,
    pub label: String,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawFsMountsResponse {
    pub mounts: Vec<IronClawFsMountInfo>,
}

/// Request to list browsable mounts.
#[derive(Debug, Clone, Copy, Default, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawFsMountsRequest {}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawFsListRequest {
    pub mount: FsMount,
    #[serde(default)]
    pub path: String,
...
/// entry paths.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawFsListResponse {
    pub mount: FsMount,
    pub path: String,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawFsStatRequest {
    pub mount: FsMount,
    #[serde(default)]
    pub path: String,
