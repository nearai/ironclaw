...
use super::{
    IronClawOperatorToolInfo, IronClawOutboundDeliveryTargetId,
    IronClawOutboundDeliveryTargetListResponse, IronClawOutboundPreferencesResponse,
    IronClawServicesError, IronClawSetOutboundPreferencesRequest, OutboundPreferencesProductFacade,
...
) -> Result<IronClawOperatorToolInfo, HostApiError> {
    Ok(IronClawOperatorToolInfo {
...
impl OutboundDeliveryTargetSetInput {
    pub fn target_id(&self) -> &IronClawOutboundDeliveryTargetId {
        &self.target_id
    }
}
...
pub async fn set_outbound_delivery_target_for_model(
    ...
    facade
        .set_outbound_preferences(
            caller,
            IronClawSetOutboundPreferencesRequest {
...
pub fn parse_outbound_delivery_target_set_input(
    ...
    let target_id = IronClawOutboundDeliveryTargetId::new(value).map_err(|reason| {
