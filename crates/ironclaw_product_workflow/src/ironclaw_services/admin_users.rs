...
//! implemented by an adapter in `ironclaw_composition` that wraps the
...
//! dependency on `ironclaw_identity` (the crate boundary the
//! architecture tests enforce) — this is dependency inversion, a single-impl
//! trait by design.
//!
//! The `IronClaw*` request/response types are the stable HTTP wire contract the
...
/// these, and the facade maps these into the sanitized `IronClawServicesError`
...
/// Fail-closed default wired into `IronClawServices` before composition installs
...
/// used for the other optional-but-live services on `IronClawServices`.
...
pub struct IronClawAdminUserListQuery {
    #[serde(default)]
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawAdminUserRequest {
    pub user_id: UserId,
}

/// Response for `GET /admin/users`.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminUserListResponse {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminCreateUserRequest {
    #[serde(default)]
    pub email: Option<String>,
    #[serde(default)]
    pub display_name: Option<String>,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminUserCreatedResponse {
...
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct IronClawAdminUpdateUserRequest {
    #[serde(default)]
    pub display_name: Option<String>,
    #[serde(default)]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminUpdateUserProductRequest {
    pub user_id: UserId,
    #[serde(default)]
    pub display_name: Option<String>,
    #[serde(default)]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminSetStatusRequest {
    pub status: AdminUserStatus,
}

/// ProductSurface mutation input for `POST /admin/users/{id}/status`.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminSetStatusProductRequest {
    pub user_id: UserId,
    pub status: AdminUserStatus,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminSetRoleRequest {
    pub role: AdminUserRole,
}

/// ProductSurface mutation input for `POST /admin/users/{id}/role`.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminSetRoleProductRequest {
    pub user_id: UserId,
    pub role: AdminUserRole,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminUserResponse {
    pub user: AdminUserRecord,
}

/// Response for `DELETE /admin/users/{id}`.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminUserDeletedResponse {
    pub user_id: UserId,
    pub deleted: bool,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminDeleteSecretProductRequest {
    pub user_id: UserId,
    pub handle: String,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminSecretResponse {
    pub secret: AdminUserSecretMeta,
}

/// Response for `DELETE /admin/users/{id}/secrets/{handle}`.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IronClawAdminSecretDeletedResponse {
    pub handle: String,
    pub deleted: bool,
}
