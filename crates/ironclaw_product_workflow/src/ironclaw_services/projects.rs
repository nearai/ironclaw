...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum IronClawProjectMemberStatus {
    Active,
    Revoked,
}
...
pub struct IronClawProjectInfo {
    ...
    pub state: IronClawProjectState,
    /// The calling user's effective role on this project.
    pub role: IronClawProjectRole,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawProjectMemberInfo {
    pub user_id: String,
    pub role: IronClawProjectRole,
    pub status: IronClawProjectMemberStatus,
...
pub struct IronClawListProjectsRequest {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// List response.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawListProjectsResponse {
    pub projects: Vec<IronClawProjectInfo>,
}

/// Single-project response (create / get / update).
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawProjectResponse {
    pub project: IronClawProjectInfo,
}

/// Browser body for creating a project.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawCreateProjectRequest {
    pub name: String,
    #[serde(default)]
    pub description: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawGetProjectRequest {
    pub project_id: String,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawUpdateProjectRequest {
    #[serde(default)]
    pub project_id: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub metadata: Option<JsonValue>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<IronClawProjectState>,
}

/// Path/body for deleting a project.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawDeleteProjectRequest {
    pub project_id: String,
}

/// Path/body for listing a project's members.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawListMembersRequest {
    pub project_id: String,
}

/// Members list response.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawListMembersResponse {
    pub members: Vec<IronClawProjectMemberInfo>,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawAddMemberRequest {
    #[serde(default)]
    pub project_id: String,
    pub user_id: String,
    pub role: IronClawProjectRole,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawUpdateMemberRoleRequest {
    #[serde(default)]
    pub project_id: String,
    #[serde(default)]
    pub user_id: String,
...
/// both carry `#[serde(default)]` like [`IronClawUpdateMemberRoleRequest`].
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawRemoveMemberRequest {
    #[serde(default)]
    pub project_id: String,
    #[serde(default)]
    pub user_id: String,
...
/// maps each variant to a sanitized [`IronClawServicesError`](crate::IronClawServicesError)
