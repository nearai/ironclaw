//! Contract tests for WebUI-facing IronClawServices facade.
...
use ironclaw_product_workflow::{
    ...
    InboundAttachmentReader, IronClawAccountTracesResponse, IronClawAddMemberRequest,
    IronClawAttachmentRequest, IronClawAutomationInfo, IronClawAutomationMutationResponse,
    IronClawAutomationRecentRunInfo, IronClawAutomationRecentRunStatus, IronClawAutomationRequest,
    ...
    IronClawCreateProjectRequest, IronClawDeleteProjectRequest, IronClawDeleteThreadRequest,
    IronClawExtensionListResponse, IronClawExtensionOnboardingState, IronClawExtensionSurface,
    IronClawFsListRequest, IronClawFsListResponse, IronClawFsMountsRequest,
    IronClawFsMountsResponse, IronClawFsStatRequest, IronClawFsStatResponse,
    IronClawGetProjectRequest, IronClawGetRunStateRequest, IronClawGlobalAutoApproveRequest,
    IronClawGlobalAutoApproveResponse, IronClawListAutomationsResponse, IronClawListMembersRequest,
    IronClawListMembersResponse, IronClawListProjectsRequest, IronClawListProjectsResponse,
    IronClawListThreadsResponse, IronClawLogLevel, IronClawLogQueryRequest,
    IronClawLogQueryResponse, IronClawOperatorCommandPlaneResponse,
    IronClawOperatorConfigDiagnosticSeverity, IronClawOperatorConfigGetResponse,
    IronClawOperatorConfigListResponse, IronClawOperatorConfigSetRequest,
    IronClawOperatorConfigValidateResponse, IronClawOperatorLogsQuery,
    IronClawOperatorSetupRequest, IronClawOperatorSetupStatus, IronClawOperatorStatusCheck,
    IronClawOperatorStatusResponse, IronClawOperatorStatusSeverity, IronClawOperatorStatusState,
    IronClawOperatorSurfaceStatus, IronClawOperatorToolCatalog, IronClawOperatorToolInfo,
    IronClawOutboundDeliveryModality, IronClawOutboundDeliveryTargetCapabilities,
    IronClawOutboundDeliveryTargetDescription, IronClawOutboundDeliveryTargetId,
    ...
    IronClawProjectFsListResponse, IronClawProjectFsStatRequest, IronClawProjectFsStatResponse,
    IronClawProjectInfo, IronClawProjectMemberInfo, IronClawProjectMemberStatus,
    IronClawProjectResponse, IronClawProjectRole, IronClawProjectState,
    IronClawRemoveMemberRequest, IronClawRenameAutomationProductRequest,
    IronClawResolveGateResponse, IronClawRunArtifact, IronClawRunArtifactRequest,
    IronClawServiceLifecycleAction, IronClawServiceLifecycleRequest,
    IronClawServiceLifecycleResponse, IronClawServiceLifecycleState, IronClawServices,
    IronClawServicesError, IronClawServicesErrorCode, IronClawServicesErrorKind,
    IronClawSetOutboundPreferencesRequest, IronClawSetupExtensionResponse,
    IronClawSkillContentResponse, IronClawSkillInfo, IronClawSkillListResponse,
    IronClawSkillSearchResponse, IronClawSkillSourceKind, IronClawSkillTrustLevel,
    IronClawStreamEventsRequest, IronClawSubmitTurnResponse, IronClawTimelineRequest,
    IronClawTimelineResponse, IronClawTraceCreditsResponse, IronClawUpdateMemberRoleRequest,
    IronClawUpdateProjectRequest, IronClawViewPage, IronClawViewQuery,
    ...
    ProjectServiceError, RUN_ARTIFACT_VIEW, ResolveApprovalInteractionRequest,
...
use ironclaw_product_workflow::{
    ...
    IronClawAdminPutSecretRequest, IronClawAdminSetRoleProductRequest, IronClawAdminSetRoleRequest,
    ...
    IronClawAdminUserListQuery, IronClawAdminUserListResponse, IronClawAdminUserRequest,
    IronClawAdminUserResponse, IronClawAdminUserSecretsListResponse,
};
...
impl FakeTurnCoordinator {
    ...
    /// cancelled paths now that `IronClawServices` verifies the run is parked
...
impl AutomationProductFacade for RecordingAutomationFacade {
    async fn list_automations(
        ...
        Ok(vec![automation_info(
            ...
            "Daily status",
            "0 9 * * *",
            Some(IronClawAutomationRunStatus::Ok),
        )])
    }
...
struct StaticAutomationFacade {
    output: Vec<IronClawAutomationInfo>,
...
impl StaticAutomationFacade {
    fn new(output: Vec<IronClawAutomationInfo>) -> Self {
        Self {
            output,
...
fn automation_info(
    ...
    last_status: Option<IronClawAutomationRunStatus>,
    ...
    IronClawAutomationInfo {
        ...
        recent_runs: vec![IronClawAutomationRecentRunInfo {
            ...
            status: IronClawAutomationRecentRunStatus::Ok,
...
async fn default_invoke_uses_canonical_host_types_and_fails_closed() {
    ...
    let result: Result<Resolution, IronClawServicesError> = services
        .invoke(
            caller(),
...
struct RecordingProjectService {
    ...
    updated: Mutex<Vec<IronClawUpdateProjectRequest>>,
    deleted: Mutex<Vec<String>>,
    listed_members: Mutex<Vec<String>>,
    added_members: Mutex<Vec<IronClawAddMemberRequest>>,
    updated_members: Mutex<Vec<IronClawUpdateMemberRoleRequest>>,
    removed_members: Mutex<Vec<IronClawRemoveMemberRequest>>,
}
...
impl ProjectService for RecordingProjectService {
    async fn list_projects(
        ...
        *self.listed.lock().expect("lock") += 1;
        Ok(IronClawListProjectsResponse {
            projects: vec![sample_ironclaw_project("project-alpha")],
        })
    }
    ...
    async fn create_project(
        ...
        Ok(IronClawProjectResponse {
            project: sample_ironclaw_project(&request.name),
        })
    }
    ...
    async fn get_project(
        ...
        Ok(IronClawProjectResponse {
            project: sample_ironclaw_project(&request.project_id),
        })
    }
    ...
    async fn list_members(
        ...
        Ok(IronClawListMembersResponse {
            members: vec![sample_ironclaw_project_member("user-beta")],
        })
    }
    ...
    async fn add_member(
        ...
        self.added_members
            ...
            .expect("lock")
            .push(request.clone());
        Ok(sample_ironclaw_project_member(&request.user_id))
    }
...
fn sample_ironclaw_project(project_id: &str) -> IronClawProjectInfo {
    IronClawProjectInfo {
...
fn sample_ironclaw_project_member(user_id: &str) -> IronClawProjectMemberInfo {
...
async fn project_and_filesystem_reads_are_available_as_product_views() {
    ...
    let services = IronClawServices::new(thread_service, Arc::new(FakeTurnCoordinator::default()))
    ...
    let project_fs_list: IronClawProjectFsListResponse =
    ...
    let project_fs_stat: IronClawProjectFsStatResponse =
    ...
    let mounts = services
        .query(
            caller(),
            FS_MOUNTS_VIEW
                .query(IronClawFsMountsRequest {}, None)
                .expect("fs mounts query"),
        )
        .await
        .expect("fs mounts view");
    let mounts: IronClawFsMountsResponse =
    ...
    let fs_list = services
        ...
        .await
        .expect("fs list view");
    let fs_list: IronClawFsListResponse =
    ...
    let fs_stat = services
        ...
        .await
        .expect("fs stat view");
    let fs_stat: IronClawFsStatResponse =
    ...
    let projects = services
        .query(
            caller(),
            PROJECTS_VIEW
                .query(IronClawListProjectsRequest { limit: Some(10) }, None)
                .expect("projects query"),
        )
        .await
        .expect("projects view");
    let projects: IronClawListProjectsResponse =
    ...
    let project = services
        ...
        .await
        .expect("project view");
    let project: IronClawProjectResponse =
    ...
    let members: IronClawListMembersResponse =
...
async fn project_mutations_are_available_as_product_capabilities() {
    ...
    let add_member_resolution = services
        .invoke(
            ...
            ProductCapabilityInput::json(
                serde_json::to_value(IronClawAddMemberRequest {
                    project_id: "project-alpha".to_string(),
    ...
    let update_member_resolution = services
        .invoke(
            ...
            ProductCapabilityInput::json(
                serde_json::to_value(IronClawUpdateMemberRoleRequest {
                    project_id: "project-alpha".to_string(),
                    user_id: "user-beta".to_string(),
                    role: IronClawProjectRole::Editor,
                })
    ...
    let remove_member_resolution = services
        .invoke(
            ...
            ProductCapabilityInput::json(
                serde_json::to_value(IronClawRemoveMemberRequest {
                    project_id: "project-alpha".to_string(),
                    user_id: "user-beta".to_string(),
                })
...
async fn session_timeline_and_thread_delete_are_available_as_product_surface() {
    ...
    let global_auto_approve = services
        .query(
            ...
            GLOBAL_AUTO_APPROVE_VIEW
                .query(IronClawGlobalAutoApproveRequest {}, None)
                .expect("global auto approve query"),
        )
        .await
        .expect("global auto approve view");
    let global_auto_approve: IronClawGlobalAutoApproveResponse =
    ...
    let timeline = services
        .query(
            ...
            TIMELINE_VIEW
                .query(
                    IronClawTimelineRequest::new("thread-session-product-surface").set_limit(10),
                    None,
                )
    ...
    let delete_resolution = services
        .invoke(
            ...
            ProductCapabilityInput::json(
                serde_json::to_value(IronClawDeleteThreadRequest {
...
async fn browse_fs_authorizes_project_selector_and_fails_closed() {
    ...
    assert_eq!(error.code, IronClawServicesErrorCode::NotFound);
}
...
fn facade_error_taxonomy_serializes_all_stable_wire_names() {
    let error = IronClawServicesError {
    ...
    let cases = [
        (IronClawServicesErrorKind::Validation, "validation"),
        (IronClawServicesErrorKind::Duplicate, "duplicate"),
        (IronClawServicesErrorKind::Busy, "busy"),
        (
        ...
        (IronClawServicesErrorKind::NotFound, "not_found"),
        (IronClawServicesErrorKind::Conflict, "conflict"),
        (IronClawServicesErrorKind::Internal, "internal"),
    ];
...
async fn submit_turn_uses_facade_and_thread_history_without_route_store_access() {
    ...
    let services = IronClawServices::new(threads, coordinator.clone());
    ...
    let timeline = services
        .get_timeline(caller(), IronClawTimelineRequest::new("thread-alpha"))
        .await
        .expect("timeline");
...
async fn busy_submit_clears_skill_activation_message() {
    ...
    let services = IronClawServices::new(threads, coordinator.clone()).with_skill_activation_hooks(
...
async fn submit_turn_returns_internal_when_skill_activation_recorder_fails() {
    ...
    let services = IronClawServices::new(threads, coordinator.clone())
        .with_skill_activation_recorder(|_, _, _| {
            Err(ironclaw_product_workflow::IronClawServicesError {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::Internal);
    assert_eq!(coordinator.submission_count(), 0);
    let timeline = services
        .get_timeline(caller(), IronClawTimelineRequest::new("thread-alpha"))
        .await
...
async fn m2_facade_timeline_contract_uses_fake_thread_port_with_authenticated_scope() {
    ...
    let timeline = services
        .get_timeline(
            web_caller.clone(),
            IronClawTimelineRequest::new("thread-alpha"),
        )
        .await
...
async fn submitted_replay_with_missing_or_invalid_run_id_maps_to_replay_unavailable() {
    for turn_run_id in [None, Some("not-a-uuid".to_string())] {
        ...
        assert_eq!(err.code, IronClawServicesErrorCode::Conflict);
        assert_eq!(err.kind, IronClawServicesErrorKind::ReplayUnavailable);
...
async fn submit_turn_maps_capacity_exceeded_to_non_retryable_rate_limit() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::RateLimited);
...
async fn same_thread_retry_replays_legacy_submitted_message_after_binding_key_change() {
    ...
    let coordinator = Arc::new(FakeTurnCoordinator::default());
    let services = IronClawServices::new(thread_service.clone(), coordinator.clone());
    ...
    let IronClawSubmitTurnResponse::AlreadySubmitted {
...
async fn same_thread_retry_reuses_legacy_accepted_message_without_creating_duplicate() {
    ...
    let timeline = services
        .get_timeline(
            caller,
            IronClawTimelineRequest::new(thread_id.as_str().to_string()),
        )
        .await
        .expect("timeline");
    assert_eq!(timeline.messages.len(), 1);
...
async fn duplicate_submit_rejects_cross_thread_reuse_maps_to_duplicate_kind() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::Conflict);
    assert_eq!(err.kind, IronClawServicesErrorKind::Duplicate);
    assert_eq!(err.status_code, 409);
    assert_eq!(coordinator.submission_count(), 1);
    ...
    let alpha_timeline = services
        .get_timeline(
            caller(),
            IronClawTimelineRequest::new("thread-alpha".to_string()),
        )
        .await
    ...
    let beta_timeline = services
        .get_timeline(
            caller(),
            IronClawTimelineRequest::new("thread-beta".to_string()),
        )
        .await
...
async fn concurrent_duplicate_submit_creates_one_message_and_replays_outcome() {
    ...
    let services = IronClawServices::new(threads, coordinator);
    create_thread_for(&services, caller(), "thread-alpha").await;
    ...
    let first_run_id = match &first {
        IronClawSubmitTurnResponse::Submitted { run_id, .. }
        | IronClawSubmitTurnResponse::AlreadySubmitted { run_id, .. } => *run_id,
        IronClawSubmitTurnResponse::RejectedBusy { .. } => {
...
async fn delete_thread_rejects_thread_with_active_run() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::Conflict);
    assert_eq!(err.kind, IronClawServicesErrorKind::Busy);
    assert_eq!(err.status_code, 409);
...
async fn validation_errors_are_stable_and_sanitized() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::InvalidRequest);
    assert_eq!(err.kind, IronClawServicesErrorKind::Validation);
...
async fn turn_unauthorized_maps_to_forbidden() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::Forbidden);
    assert_eq!(err.kind, IronClawServicesErrorKind::ParticipantDenied);
...
async fn stream_events_without_projection_stream_maps_to_replay_unavailable_taxonomy() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::Unavailable);
    assert_eq!(err.kind, IronClawServicesErrorKind::ReplayUnavailable);
...
async fn adapter_authentication_maps_to_unauthenticated() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::Unauthenticated);
    assert_eq!(err.kind, IronClawServicesErrorKind::ParticipantDenied);
...
async fn projection_egress_denied_maps_to_blocked_resource_taxonomy() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::Forbidden);
    assert_eq!(err.kind, IronClawServicesErrorKind::BlockedResource);
    assert_eq!(err.status_code, 403);
    let rendered = format!("{err:?} {}", serde_json::to_string(&err).expect("json"));
    assert!(!rendered.contains("secret-token"));
}
...
async fn timeline_backend_failure_maps_to_timeline_unavailable_taxonomy() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::Unavailable);
    assert_eq!(err.kind, IronClawServicesErrorKind::TimelineUnavailable);
    assert_eq!(err.status_code, 503);
    assert!(err.retryable);
    let rendered = format!("{err:?} {}", serde_json::to_string(&err).expect("json"));
    assert!(!rendered.contains("secret-token"));
...
async fn retry_run_maps_not_retryable_to_non_retryable_conflict() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::Conflict);
    assert_eq!(err.kind, IronClawServicesErrorKind::Conflict);
    assert_eq!(err.status_code, 409);
    assert!(!err.retryable);
...
async fn approved_gate_resolution_resumes_turn() {
    ...
    assert!(matches!(response, IronClawResolveGateResponse::Resumed(_)));
...
async fn blocked_auth_run_routes_non_prefixed_gate_to_auth_interaction_service() {
    ...
    assert!(matches!(
        response,
        IronClawResolveGateResponse::Cancelled(_)
    ));
...
async fn blocked_approval_run_with_stale_gate_ref_returns_conflict() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::Conflict);
    assert_eq!(err.kind, IronClawServicesErrorKind::BlockedApproval);
    assert_eq!(err.status_code, 409);
    assert_eq!(coordinator.resumption_count(), 0);
    assert_eq!(coordinator.cancellation_count(), 0);
...
#[tokio::test]
async fn hook_auth_gate_denial_maps_to_ironclaw_resumed() {
    // Verifies that a Deny decision (which produces `Resumed` from
    // `resume_denied_auth`) maps to `IronClawResolveGateResponse::Resumed`
    // through the facade.
    let coordinator = Arc::new(FakeTurnCoordinator::default());
    ...
    let response = services
        ...
        .await
        .expect(
            "Resumed from auth-interaction service must map to IronClawResolveGateResponse::Resumed",
        );

    assert!(
        matches!(response, IronClawResolveGateResponse::Resumed(_)),
...
async fn cancel_run_remaps_thread_scope_mismatch_to_not_found() {
    let coordinator = Arc::new(FakeTurnCoordinator::default());
    let services = IronClawServices::new(Arc::new(ScopeMismatchThreadStub), coordinator.clone());
...
async fn approval_gate_resolution_with_persistent_flag_uses_approval_interaction_service() {
    ...
    assert!(matches!(
        response,
        IronClawResolveGateResponse::Resumed(response) if response.status == TurnStatus::Queued
    ));
    assert_eq!(approval_interactions.resolution_count(), 1);
    assert_eq!(
        approval_interactions
...
#[tokio::test]
async fn list_extensions_projects_onboarding_payload_through_ironclaw_services() {
    let services = IronClawServices::new(
        Arc::new(InMemorySessionThreadService::default()),
        Arc::new(FakeTurnCoordinator::default()),
    )
...
async fn list_automation_dispatches_through_product_facade() {
    ...
    assert_eq!(listed.automations[0].state, IronClawAutomationState::Active);
    assert_eq!(
    ...
    assert_eq!(
        ...
        IronClawAutomationRecentRunStatus::Ok
    );
    assert_eq!(
...
async fn list_extensions_projects_channel_surface_with_directions_and_connection() {
    ...
    summary.channel_connection = Some(ChannelConnectionRequirement {
        ...
        strategy: IronClawChannelConnectStrategy::OAuth,
    ...
    let channel = info
        ...
        .find_map(|surface| match surface {
            IronClawExtensionSurface::Channel {
                inbound,
                outbound,
                connection,
                ..
    ...
    assert_eq!(connection.strategy, IronClawChannelConnectStrategy::OAuth);
...
fn channel_connect_action_serializes_neutral_input_placeholder() {
    let action = IronClawChannelConnectAction {
...
async fn get_outbound_preferences_unwired_returns_empty_projection() {
    ...
    let response: IronClawOutboundPreferencesResponse =
    ...
    assert_eq!(
        ...
        IronClawOutboundDeliveryModality::Text
    );
}

#[test]
fn outbound_delivery_modality_text_round_trips_as_text() {
    let serialized = serde_json::to_value(IronClawOutboundDeliveryModality::Text)
        .expect("serialize text modality");
    assert_eq!(serialized, json!("text"));

    let deserialized: IronClawOutboundDeliveryModality =
        serde_json::from_value(serialized).expect("deserialize text modality");
    assert_eq!(deserialized, IronClawOutboundDeliveryModality::Text);
}

#[test]
fn set_outbound_preferences_empty_json_defaults_final_target_to_none() {
    let request: IronClawSetOutboundPreferencesRequest =
...
fn outbound_preferences_response_preserves_client_json_shape() {
    ...
    let deserialized: IronClawOutboundPreferencesResponse =
...
fn outbound_preferences_response_empty_json_defaults_to_text_without_target() {
    ...
    assert_eq!(
        ...
        IronClawOutboundDeliveryTargetStatus::NoneConfigured
    );
    assert_eq!(
        response.default_modality,
        IronClawOutboundDeliveryModality::Text
...
fn outbound_preferences_response_missing_status_defaults_to_available_when_target_present() {
    let response: IronClawOutboundPreferencesResponse = serde_json::from_value(json!({
        "final_reply_target": {
            "target_id": "slack-dm-alpha",
            "channel": "slack",
            "display_name": "Slack DM",
    ...
    assert_eq!(
        response.final_reply_target_status,
        IronClawOutboundDeliveryTargetStatus::Available
    );
...
fn outbound_target_summary_preserves_client_json_shape() {
    ...
    let deserialized: IronClawOutboundDeliveryTargetSummary =
...
fn outbound_target_list_response_preserves_empty_json_shape_without_cursor() {
    let response = IronClawOutboundDeliveryTargetListResponse {
        targets: Vec::new(),
        next_cursor: None,
    };
    ...
    let deserialized: IronClawOutboundDeliveryTargetListResponse =
...
fn outbound_target_summary_rejects_malformed_display_fields() {
    for (field, invalid_value) in [
        ...
        serde_json::from_value::<IronClawOutboundDeliveryTargetSummary>(payload)
...
fn outbound_target_id_and_display_fields_reject_unicode_line_separators() {
    for target_id in [
        ...
        IronClawOutboundDeliveryTargetId::new(target_id)
            .expect_err("target id rejects unicode line separators");
        serde_json::from_value::<IronClawSetOutboundPreferencesRequest>(json!({
...
fn outbound_target_empty_description_is_accepted() {
    let description =
        IronClawOutboundDeliveryTargetDescription::new("").expect("empty description is allowed");
    assert_eq!(description.as_str(), "");

    let summary = IronClawOutboundDeliveryTargetSummary::new(
        outbound_target_id("slack-dm-alpha"),
        "slack",
        "Slack DM",
        Some("".to_string()),
    ...
    assert_eq!(
        summary
            .description
            .as_ref()
            .map(IronClawOutboundDeliveryTargetDescription::as_str),
        Some("")
    );
}
...
async fn outbound_preferences_unwired_mutations_and_target_listing_fail_closed() {
    ...
    assert_eq!(set_error.code, IronClawServicesErrorCode::Unavailable);
    ...
    assert_eq!(list_error.code, IronClawServicesErrorCode::Unavailable);
...
async fn outbound_preferences_facade_forwards_caller_and_request() {
    ...
    let services = IronClawServices::new_with_product_capability_invoker(
        Arc::new(InMemorySessionThreadService::default()),
        Arc::new(FakeTurnCoordinator::default()),
        invoker.clone(),
    )
    ...
    let get_response: IronClawOutboundPreferencesResponse =
    ...
    let set_response: IronClawOutboundPreferencesResponse =
    ...
    let targets: IronClawOutboundDeliveryTargetListResponse =
...
async fn outbound_preferences_reads_are_available_as_product_views() {
    ...
    let preferences: IronClawOutboundPreferencesResponse =
...
async fn trace_reads_are_available_as_product_views() {
    ...
    let credits: IronClawTraceCreditsResponse =
    ...
    let traces: IronClawAccountTracesResponse =
...
async fn automation_mutations_are_available_as_product_capabilities() {
    ...
    for (capability_id, input) in [
        (
            AUTOMATION_PAUSE_CAPABILITY_ID,
            serde_json::to_value(IronClawAutomationRequest {
                automation_id: "trigger-alpha".to_string(),
            })
            .expect("pause input"),
        ),
        ...
        (
            AUTOMATION_RENAME_CAPABILITY_ID,
            serde_json::to_value(IronClawRenameAutomationProductRequest {
                automation_id: "trigger-alpha".to_string(),
                name: Some("Renamed status".to_string()),
            })
            .expect("rename input"),
...
#[test]
fn ironclaw_automation_state_round_trips_serde_for_every_variant() {
    let cases = [
        (IronClawAutomationState::Active, "\"active\""),
        (IronClawAutomationState::Scheduled, "\"scheduled\""),
        (IronClawAutomationState::Paused, "\"paused\""),
        (IronClawAutomationState::Disabled, "\"disabled\""),
        (IronClawAutomationState::Inactive, "\"inactive\""),
        (IronClawAutomationState::Completed, "\"completed\""),
        (IronClawAutomationState::Unknown, "\"unknown\""),
    ];
    ...
    for (state, expected_wire) in cases {
        ...
        let deserialized: IronClawAutomationState =
...
#[test]
fn ironclaw_automation_recent_run_info_round_trips_typed_ids_and_preserves_unknown_status() {
    let recent_run = IronClawAutomationRecentRunInfo {
        run_id: Some(automation_run_id()),
        thread_id: Some(ThreadId::new("thread-listed").expect("valid thread id")),
        fire_slot: Some("2026-06-03T09:00:00Z".parse().expect("fire slot")),
    ...
    let deserialized: IronClawAutomationRecentRunInfo =
        serde_json::from_value(serialized).expect("deserialize recent run");
    assert_eq!(deserialized, recent_run);

    let future_status: IronClawAutomationRecentRunInfo = serde_json::from_value(json!({
        "run_id": "11111111-1111-1111-1111-111111111111",
        "thread_id": "thread-listed",
        "status": "cancelled",
        "submitted_at": "2026-06-03T09:00:01Z",
    ...
    assert_eq!(
        ...
        IronClawAutomationRecentRunStatus::Unknown
    );

    let defaulted_status: IronClawAutomationRecentRunInfo = serde_json::from_value(json!({
        "run_id": "11111111-1111-1111-1111-111111111111",
        "thread_id": "thread-listed",
        "submitted_at": "2026-06-03T09:00:01Z",
    }))
    ...
    serde_json::from_value::<IronClawAutomationRecentRunInfo>(json!({
        "run_id": "11111111-1111-1111-1111-111111111111",
        "thread_id": "thread-listed",
...
struct RecordingOperatorLogsService {
    requests: Mutex<Vec<IronClawLogQueryRequest>>,
}

impl RecordingOperatorLogsService {
    fn requests(&self) -> Vec<IronClawLogQueryRequest> {
...
async fn query_operator_logs_view(
    services: &IronClawServices,
    caller: WebUiAuthenticatedCaller,
    mut request: IronClawOperatorLogsQuery,
...
async fn query_operator_logs_bounds_query_before_logs_service() {
    ...
    let response = query_operator_logs_view(
        ...
        IronClawOperatorLogsQuery {
            limit: Some(u32::MAX),
            cursor: Some(oversized_cursor),
            level: Some(IronClawLogLevel::Warn),
    ...
    assert_eq!(response.status, IronClawOperatorSurfaceStatus::Available);
    ...
    assert_eq!(requests[0].level, Some(IronClawLogLevel::Warn));
...
async fn query_operator_logs_forwards_follow_mode_to_logs_service() {
    ...
    query_operator_logs_view(
        ...
        IronClawOperatorLogsQuery {
            ...
            level: Some(IronClawLogLevel::Info),
    ...
    assert_eq!(requests[0].level, Some(IronClawLogLevel::Info));
...
async fn query_logs_requires_thread_scope() {
    ...
    let err = query_logs_view(&services, caller(), IronClawLogQueryRequest::default())
        .await
    ...
    let page = services
        .query(
            ...
            IronClawViewQuery {
                ...
                params: serde_json::to_value(IronClawRunArtifactRequest {
...
async fn run_artifact_rejects_another_user_before_querying_logs() {
    ...
    assert_eq!(error.kind, IronClawServicesErrorKind::NotFound);
    assert!(operator_logs.requests().is_empty());
}
...
async fn operator_service_lifecycle_contract_is_implementable_from_crate_root() {
    ...
    assert_eq!(response.action, IronClawServiceLifecycleAction::Status);
...
async fn get_timeline_succeeds_for_own_automation_trigger_thread() {
    ...
    let automation_facade = Arc::new(
        StaticAutomationFacade::new(vec![IronClawAutomationInfo {
            ...
            next_run_at: None,
            last_run_at: None,
            last_status: Some(IronClawAutomationRunStatus::Ok),
            recent_runs: vec![IronClawAutomationRecentRunInfo {
                run_id: Some(automation_run_id()),
                thread_id: Some(trigger_thread_id.clone()),
                fire_slot: None,
    ...
    let response = services
        .get_timeline(
            caller,
            IronClawTimelineRequest::new(trigger_thread_id.as_str().to_string()),
        )
        .await
...
async fn resolve_gate_approval_succeeds_for_own_automation_trigger_thread() {
    ...
    let services = IronClawServices::new(thread_service, coordinator.clone())
...
async fn cancel_run_succeeds_for_own_automation_trigger_thread() {
    ...
    let services =
        IronClawServices::new(thread_service, coordinator.clone()).with_automation_product_facade(
...
async fn get_timeline_rejects_thread_id_absent_from_callers_automations() {
    ...
    let err = services
        .get_timeline(
            caller,
            IronClawTimelineRequest::new("thread-absent-from-automations".to_string()),
        )
        .await
...
struct RecordingChannelConfigFacade {
    fields: Vec<IronClawChannelConfigField>,
    saves: Mutex<Vec<RecordedChannelConfigSave>>,
}

impl RecordingChannelConfigFacade {
    fn with_fields(fields: Vec<IronClawChannelConfigField>) -> Self {
        Self {
            fields,
...
fn channel_config_field(name: &str, label: &str, secret: bool) -> IronClawChannelConfigField {
    IronClawChannelConfigField {
        name: name.to_string(),
...
impl RecordingOperatorStatusService {
    fn new(response: IronClawOperatorStatusResponse) -> Self {
        Self {
            response,
...
struct StaticOperatorToolCatalogForTest {
    tools: Vec<IronClawOperatorToolInfo>,
}

#[async_trait]
impl IronClawOperatorToolCatalog for StaticOperatorToolCatalogForTest {
...
type OperatorConfigServices = IronClawServices<OperatorConfigAutoApproveInvoker>;
...
struct OperatorConfigAutoApproveInvoker {
    ...
    tools: Arc<Vec<IronClawOperatorToolInfo>>,
}
...
impl OperatorConfigAutoApproveInvoker {
    ...
    async fn invoke_tool_permission(
        ...
        match state {
            ...
            "always_allow" => {
                ...
                {
                    return Err(IronClawServicesError::from(
    ...
    async fn revoke_tool_policy(
        ...
        match self.persistent_policies.revoke(policy_key).await {
            ...
            Err(error) => Err(IronClawServicesError::internal_from(error)),
        }
    }
}
...
fn services_with_operator_approval_config_stores(
    ...
    IronClawServices::new_with_product_capability_invoker(
        Arc::new(InMemorySessionThreadService::default()),
        Arc::new(FakeTurnCoordinator::default()),
...
fn operator_config_test_tools() -> Vec<IronClawOperatorToolInfo> {
    vec![
        IronClawOperatorToolInfo {
...
fn operator_config_entry_value<'a>(
    response: &'a ironclaw_product_workflow::IronClawOperatorConfigListResponse,
    key: &str,
) -> &'a serde_json::Value {
    &response
        .entries
...
async fn query_operator_setup<S: ProductSurface + ?Sized>(
    services: &S,
    caller: WebUiAuthenticatedCaller,
) -> Result<ironclaw_product_workflow::IronClawOperatorSetupResponse, IronClawServicesError> {
    let page = services
        .query(
            caller,
            IronClawViewQuery {
...
async fn query_extension_setup<S: ProductSurface + ?Sized>(
    ...
    caller: WebUiAuthenticatedCaller,
    package_id: &str,
) -> Result<IronClawSetupExtensionResponse, IronClawServicesError> {
    let page = services
        .query(
            caller,
            IronClawViewQuery {
...
async fn invoke_extension_setup_submit<S: ProductSurface + ?Sized>(
    ...
    let mut input = serde_json::to_value(request).map_err(IronClawServicesError::internal_from)?;
    input
        .as_object_mut()
...
async fn skill_reads_are_available_as_product_views() {
    ...
    let list_page = services
        ...
        .await
        .expect("skills view");
    let listed: IronClawSkillListResponse =
    ...
    let searched: IronClawSkillSearchResponse =
    ...
    let content: IronClawSkillContentResponse =
...
fn skill_info(name: &str) -> IronClawSkillInfo {
    IronClawSkillInfo {
        name: name.to_string(),
        description: format!("{name} skill"),
        version: "1.0.0".to_string(),
        trust: IronClawSkillTrustLevel::Installed,
        source: IronClawSkillSourceKind::User,
        source_kind: IronClawSkillSourceKind::User,
        keywords: Vec::new(),
        usage_hint: None,
        setup_hint: None,
        bundle_path: None,
...
async fn operator_config_reads_and_writes_auto_approve_and_tool_permissions() {
    ...
    assert_eq!(financial_error.kind, IronClawServicesErrorKind::Validation);
    assert_eq!(
    ...
    services
        .set_operator_config_key(
            ...
            IronClawOperatorConfigSetRequest { value: json!(true) },
        )
        .await
...
async fn operator_config_reads_are_available_as_product_views() {
    ...
    let list_page = services
        ...
        .await
        .expect("operator config list view");
    let list: IronClawOperatorConfigListResponse =
    ...
    let key: IronClawOperatorConfigGetResponse =
    ...
    let validate: IronClawOperatorConfigValidateResponse =
...
async fn operator_config_preserves_override_when_always_allow_policy_write_fails() {
    ...
    assert_eq!(error.code, IronClawServicesErrorCode::Internal);
...
async fn operator_diagnostics_aggregates_status_setup_and_config_reasons() {
    ...
    let status_service = Arc::new(RecordingOperatorStatusService::new(
        IronClawOperatorStatusResponse {
            ...
            overall: IronClawOperatorStatusState::Blocked,
            checks: vec![
                IronClawOperatorStatusCheck {
                    id: "storage".to_string(),
                    status: IronClawOperatorStatusState::Blocked,
                    severity: IronClawOperatorStatusSeverity::Critical,
                ...
                IronClawOperatorStatusCheck {
                    ...
                    status: IronClawOperatorStatusState::Ready,
                    severity: IronClawOperatorStatusSeverity::Info,
                ...
                IronClawOperatorStatusCheck {
                    ...
                    status: IronClawOperatorStatusState::Blocked,
                    severity: IronClawOperatorStatusSeverity::Warning,
    ...
    let response: IronClawOperatorCommandPlaneResponse =
        serde_json::from_value(page.payload).expect("operator diagnostics payload");

    assert_eq!(response.area.as_str(), "diagnostics");
    assert_eq!(response.status, IronClawOperatorSurfaceStatus::Unavailable);
...
async fn operator_command_plane_reads_are_available_as_product_views() {
    ...
    let services =
        services_with_setup_llm_config(llm_config).with_operator_status_service(Arc::new(
            StaticOperatorStatusService::new(IronClawOperatorStatusResponse {
                generated_at: Utc::now(),
                overall: IronClawOperatorStatusState::Ready,
                checks: Vec::new(),
            }),
        ));
    ...
    let diagnostics: IronClawOperatorCommandPlaneResponse =
    ...
    let status: IronClawOperatorCommandPlaneResponse =
        serde_json::from_value(status_page.payload).expect("status payload");
    assert_eq!(status.area.as_str(), "status");
    assert_eq!(status.status, IronClawOperatorSurfaceStatus::Available);
...
async fn operator_diagnostics_reports_setup_service_absence_without_failing_route() {
    ...
    assert!(response.diagnostics.iter().any(|diagnostic| {
        diagnostic.reason_code == "operator_setup_service_not_wired"
            && diagnostic.severity == IronClawOperatorConfigDiagnosticSeverity::Error
    }));
}
...
async fn get_operator_setup_returns_snapshot_from_llm_config() {
    ...
    assert_eq!(response.status, IronClawOperatorSetupStatus::Complete);
    assert!(response.diagnostics.is_empty());
    assert!(response.steps.iter().any(|step| {
        step.name == "profile"
            && step.status == ironclaw_product_workflow::IronClawOperatorSetupStepStatus::Complete
    }));
    assert!(response.steps.iter().any(|step| {
...
async fn get_operator_setup_without_llm_config_returns_service_unavailable() {
    ...
    assert_eq!(err.code, IronClawServicesErrorCode::Unavailable);
    assert_eq!(err.kind, IronClawServicesErrorKind::ServiceUnavailable);
    assert_eq!(err.status_code, 503);
}
...
async fn setup_response_reflects_active_provider_and_model() {
    ...
    let response = services
        .run_operator_setup(caller(), IronClawOperatorSetupRequest::default())
        .await
        .expect("setup response");
...
async fn run_operator_setup_requires_provider_id_for_provider_changes() {
    ...
    let err = services
        .run_operator_setup(
            caller(),
            IronClawOperatorSetupRequest::default()
...
async fn run_operator_setup_rejects_model_without_provider_id() {
    ...
    let err = services
        .run_operator_setup(
            caller(),
            IronClawOperatorSetupRequest::default().set_model("gpt-5-mini"),
        )
        .await
...
async fn run_operator_setup_ignores_redacted_webui_access_token_sentinel() {
    ...
    assert_eq!(
        webui_step.status,
        ironclaw_product_workflow::IronClawOperatorSetupStepStatus::Complete
    );
    assert_eq!(
        llm_config.set_active_calls.lock().expect("lock").as_slice(),
        [SetupSetActiveCall {
...
async fn run_operator_setup_propagates_llm_config_service_error() {
    ...
    assert_eq!(upsert_err.code, IronClawServicesErrorCode::Unavailable);
    ...
    let set_active_err = set_active_services
        .run_operator_setup(
            caller(),
            IronClawOperatorSetupRequest::default().set_provider_id("openai"),
        )
        .await
        .expect_err("set_active error propagates");
    assert_eq!(set_active_err.code, IronClawServicesErrorCode::Unavailable);
    ...
    assert_eq!(snapshot_err.code, IronClawServicesErrorCode::Unavailable);
...
async fn get_timeline_pages_messages_with_cursor() {
    ...
    let coordinator = Arc::new(FakeTurnCoordinator::default());
    let services = IronClawServices::new(threads.clone(), coordinator);
    let alice = caller();
    ...
    let first = services
        .get_timeline(
            alice.clone(),
            IronClawTimelineRequest::new("thread-paginate".to_string()).set_limit(10),
        )
        .await
        .expect("first page");
    assert_eq!(
...
async fn get_timeline_clamps_oversize_limit_to_hard_ceiling() {
    ...
    let response = services
        .get_timeline(
            alice,
            IronClawTimelineRequest::new("thread-cap".to_string()).set_limit(u32::MAX),
        )
        .await
...
fn facade_source_avoids_forbidden_runtime_dependencies() {
    let source = std::fs::read_to_string("src/ironclaw_services.rs").expect("facade source");
    for forbidden in [
        "CapabilityHost",
        ...
        assert!(
            ...
            "IronClawServices facade must not expose route handlers to {forbidden}"
        );
    }
...
async fn replayed_rejected_busy_returns_rejected_busy_without_new_submission() {
    ...
    assert!(
        matches!(response, IronClawSubmitTurnResponse::RejectedBusy { .. }),
...
async fn submit_turn_lands_attachments_and_persists_refs_on_the_user_message() {
    ...
    let services = IronClawServices::new(Arc::clone(&threads), coordinator.clone())
...
fn admin_services(fake: FakeAdminUsers) -> IronClawServices {
    IronClawServices::new(
        Arc::new(InMemorySessionThreadService::default()),
        Arc::new(FakeTurnCoordinator::default()),
    )
...
fn assert_forbidden(err: IronClawServicesError) {
...
async fn admin_users_are_available_as_product_views_and_capabilities() {
    ...
    let users: IronClawAdminUserListResponse =
    ...
    let user: IronClawAdminUserResponse =
    ...
    let secrets: IronClawAdminUserSecretsListResponse =
    ...
    let update_resolution = services
        .invoke(
            ...
            ProductCapabilityInput::json(
                serde_json::to_value(IronClawAdminUpdateUserProductRequest {
                    user_id: target.clone(),
    ...
    let updated: IronClawAdminUserResponse =
    ...
    let put_secret_resolution = services
        .invoke(
            ...
            ProductCapabilityInput::json(
                serde_json::to_value(IronClawAdminPutSecretProductRequest {
                    user_id: target.clone(),
    ...
    let delete_secret_resolution = services
        .invoke(
            ...
            ProductCapabilityInput::json(
                serde_json::to_value(IronClawAdminDeleteSecretProductRequest {
                    user_id: target.clone(),
                    handle: "openai_api_key".to_string(),
                })
    ...
    let status_resolution = services
        .invoke(
            ...
            ProductCapabilityInput::json(
                serde_json::to_value(IronClawAdminSetStatusProductRequest {
                    user_id: target.clone(),
    ...
    let suspended: IronClawAdminUserResponse =
    ...
    let role_resolution = services
        .invoke(
            ...
            ProductCapabilityInput::json(
                serde_json::to_value(IronClawAdminSetRoleProductRequest {
                    user_id: target.clone(),
    ...
    let promoted: IronClawAdminUserResponse =
    ...
    let delete_resolution = services
        .invoke(
            ...
            ProductCapabilityInput::json(
                serde_json::to_value(IronClawAdminUserRequest {
                    user_id: target.clone(),
                })
    ...
    let deleted = services
        .query(
            caller(),
            ADMIN_USER_VIEW
                .query(IronClawAdminUserRequest { user_id: target }, None)
                .expect("admin user query"),
        )
        .await
        .expect_err("deleted user is no longer readable");
    assert_eq!(deleted.code, IronClawServicesErrorCode::NotFound);
}
...
async fn assert_every_admin_verb_forbidden(services: &IronClawServices) {
    let target = UserId::new("some-target").expect("user");
    assert_forbidden(
        services
            .list_admin_users(caller(), IronClawAdminUserListQuery::default())
            .await
            .expect_err("list"),
    );
    assert_forbidden(
    ...
    assert_forbidden(
        services
            .update_admin_user(
                caller(),
                target.clone(),
                IronClawAdminUpdateUserRequest::default(),
            )
            .await
            .expect_err("update"),
    );
...
async fn admin_list_forwards_status_filter_to_the_port() {
    ...
    let all = services
        .list_admin_users(
            caller().with_operator_webui_config(true),
            IronClawAdminUserListQuery::default(),
        )
        .await
        .expect("list all");
...
async fn admin_operator_bypasses_role_check() {
    ...
    let operator = caller().with_operator_webui_config(true);
    services
        .list_admin_users(operator, IronClawAdminUserListQuery::default())
        .await
