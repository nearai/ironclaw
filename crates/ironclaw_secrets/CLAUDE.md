...
- Preserve tenant/user/agent/project isolation; never add global handle lookup. Admin provisioning must stay behind an explicit composition-owned API that supplies the complete trusted target-user runtime scope.
