...
- Accepted inbound messages must snapshot message-scoped reply targets; stable conversation bindings ignore per-message IDs, but egress routing must preserve them.
