...
- Source binding and reply target binding refs are distinct. Egress paths must validate reply targets before sending to external destinations, and validation must preserve adapter kind, adapter installation, and full external route fields.
