...
use ironclaw_event_store::{
    IronClawEventStoreConfig, IronClawEventStores, IronClawProfile, build_ironclaw_event_stores,
};
use ironclaw_events::{
...
fn base_services(
    engine_root: &Path,
    event_stores: IronClawEventStores,
...
async fn jsonl_event_stores(event_root: &Path) -> IronClawEventStores {
    build_ironclaw_event_stores(
