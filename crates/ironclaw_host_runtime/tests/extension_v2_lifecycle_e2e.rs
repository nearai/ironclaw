...
use ironclaw_host_api::{
    AuthorizedDispatchRequest, CapabilityId, DispatchAuthorityProof, ExtensionId, HostPath,
    MountView, ReservationStatus, ResourceEstimate, ResourceReservationId, ResourceScope,
...
async fn extension_v2_lifecycle_discovers_installs_publishes_and_dispatches_host_api_capability() {
    ...
    let result = dispatch_port
        .dispatch_json(AuthorizedDispatchRequest::new(
            ironclaw_host_api::CapabilityDispatchRequest {
