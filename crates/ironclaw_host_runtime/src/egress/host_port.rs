...
#[cfg(feature = "test-support")]
use ironclaw_capabilities::CapabilityObligationError;
...
impl HostRuntimeHttpEgressPort {
    ...
    #[cfg(feature = "test-support")]
    pub fn test_support_with_allow_all_obligations(
        runtime_http_egress: Arc<dyn RuntimeHttpEgress>,
    ) -> Self {
        Self {
            runtime_http_egress,
            obligation_handler: Arc::new(TestSupportAllowAllObligations),
            secret_stager: RuntimeSecretMaterialStager::new(Arc::new(
...
#[cfg(feature = "test-support")]
struct TestSupportAllowAllObligations;

#[cfg(feature = "test-support")]
#[async_trait]
impl CapabilityObligationHandler for TestSupportAllowAllObligations {
    async fn satisfy(
        &self,
