...
use ironclaw_host_api::{
    CapabilityDescriptor, CapabilityId, DispatchError, RuntimeKind, ToolAdapter, ToolCall,
    ToolError, ToolPorts, ToolResult, runtime_policy::EffectiveRuntimePolicy,
};
...
{
    pub(super) lanes: HashMap<RuntimeKind, Arc<dyn RuntimeAdapter<F, G>>>,
