...
/// `IronClawServices::with_event_stream` test wiring; see module doc for the
...
pub fn build_webui_event_stream_for_test(
    ...
    crate::projection::build_ironclaw_projection_services(event_log, reply_target_binding_ref)
