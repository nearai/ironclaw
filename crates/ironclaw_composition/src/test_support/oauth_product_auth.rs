...
// resulting `IronClawProductAuthServices` bundle exercises the full OAuth
...
#[async_trait]
impl crate::product_auth::api::auth::IronClawAuthContinuationDispatcher
...
pub struct OAuthProductAuthTestBundle {
    ...
    pub services: Arc<crate::IronClawProductAuthServices>,
...
pub fn build_oauth_product_auth_for_test() -> OAuthProductAuthTestBundle {
    ...
    let services = Arc::new(crate::IronClawProductAuthServices::new(
...
impl OAuthProductAuthTestBundle {
    ...
    /// `IronClawProductAuthServices::refresh_credential_account` →
...
/// - Calls `.with_provider_client()` on the constructed `IronClawProductAuthServices`
...
pub fn build_google_oauth_product_auth_for_test() -> OAuthProductAuthTestBundle {
    ...
    let services = Arc::new(
        crate::IronClawProductAuthServices::new(
            durable.clone() as Arc<dyn ironclaw_auth::AuthFlowManager>,
            durable.clone() as Arc<dyn ironclaw_auth::AuthInteractionService>,
            durable.clone() as Arc<dyn ironclaw_auth::CredentialSetupService>,
            durable.clone() as Arc<dyn ironclaw_auth::CredentialAccountService>,
...
pub async fn handle_oauth_callback_with_channel_identity_binding_for_test(
    services: &crate::IronClawProductAuthServices,
    request: crate::IronClawOAuthCallbackRequest,
    binding: &crate::ChannelIdentityBindingConfig,
) -> Result<crate::IronClawOAuthCallbackResponse, crate::IronClawOAuthCallbackError> {
    let provider = match &request.outcome {
        crate::IronClawOAuthCallbackOutcome::Authorized { provider_request } => {
