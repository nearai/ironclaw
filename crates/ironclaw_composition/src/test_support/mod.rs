//! Test-only helpers for the IronClaw integration-test framework and budget E2E tests.
//!
...
//!    counts for `IronClawRuntimeInput::with_model_gateway_override` tests.
...
//!    (`tests/support/ironclaw_parity_qa/`) drives the real local-dev composition paths
...
//!     production `IronClawAutomationProductFacade` constructor for the
