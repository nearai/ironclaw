...
pub(super) fn capability_wiring(
    ...
    trajectory_observer: Option<Arc<dyn crate::IronClawTrajectoryObserver>>,
...
struct StagedCapabilityIo {
    ...
    observer: Option<Arc<dyn crate::IronClawTrajectoryObserver>>,
}
...
impl LoopCapabilityResultWriter for StagedCapabilityIo {
    async fn write_capability_result(
        ...
        if let Some(observer) = &self.observer {
            ...
            // is the observer's own contract — see `IronClawTrajectoryObserver`.)
