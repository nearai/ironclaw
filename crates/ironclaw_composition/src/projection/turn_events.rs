...
use ironclaw_runner::failure_summary::{
    ironclaw_failure_summary_for_category_and_detail, pinned_failure_summary_for_category,
};
...
async fn failure_details_for_turn_event(
    ...
    let fallback_summary =
        ironclaw_failure_summary_for_category_and_detail(Some(&category), invalid_output_detail)
            .to_string();
