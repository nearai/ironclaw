...
use ironclaw_product_workflow::{
    InboundAttachmentLander, InboundAttachmentReader, IronClawServicesError,
    ...
    async fn read(
        ...
        self.read_attachment_bytes(&scope, storage_key)
            ...
            .map_err(|error| match error {
                LoopAttachmentReadError::NotFound => IronClawServicesError {
                ...
                LoopAttachmentReadError::Forbidden => IronClawServicesError {
                ...
                LoopAttachmentReadError::Backend(reason) => {
                    IronClawServicesError::internal_from(reason)
                }
            })
    }
}
...
mod tests {
    ...
    use ironclaw_product_workflow::IronClawServicesErrorCode;
