...
//!
//! Both the local-dev runtime (`build_ironclaw_runtime`) and any
...
/// `IronClawLoopDriverHostFactory::with_model_budget_accountant` builder.
///
...
mod tests {
    ...
    /// reusable independent of `build_ironclaw_runtime`.
    #[tokio::test]
