...
use ironclaw_product_workflow::{
    ChannelAuthAccountState, ChannelConnectionFacade, IronClawServicesError,
...
use crate::provider_identity::{
    IronClawUserIdentityBindingDeleteStore, IronClawUserIdentityLookup,
};
...
/// [`crate::IronClawProductAuthServices::cleanup_credentials_for_lifecycle`],
...
#[async_trait]
impl ChannelCredentialCleanup for crate::IronClawProductAuthServices {
    async fn cleanup_credentials_for_lifecycle(
        &self,
        request: SecretCleanupRequest,
    ) -> Result<SecretCleanupReport, IronClawServicesError> {
        crate::IronClawProductAuthServices::cleanup_credentials_for_lifecycle(self, request)
            .await
            .map_err(|error| {
...
/// [`crate::IronClawProductAuthServices::credential_account_record_source`]; the
...
pub(crate) trait ChannelAccountStatusReader: Send + Sync {
    ...
    async fn account_status_for_caller(
        ...
        provider: &str,
    ) -> Result<Option<CredentialAccountStatus>, IronClawServicesError>;
}

#[async_trait]
impl ChannelAccountStatusReader for crate::IronClawProductAuthServices {
    async fn account_status_for_caller(
        &self,
        caller: &WebUiAuthenticatedCaller,
        provider: &str,
...
pub(crate) struct GenericChannelConnectionFacade {
    ...
    identity_delete_store: Arc<dyn IronClawUserIdentityBindingDeleteStore>,
...
impl GenericChannelConnectionFacade {
    ...
    async fn connection_entries(
        &self,
    ) -> Result<Vec<ChannelConnectionEntry>, IronClawServicesError> {
    ...
    ) -> Result<Option<ChannelConnectionScope>, IronClawServicesError> {
        entry
            .scope_source
...
impl ChannelConnectionFacade for GenericChannelConnectionFacade {
    async fn caller_channel_connections(
        &self,
        caller: WebUiAuthenticatedCaller,
    ) -> Result<HashMap<String, bool>, IronClawServicesError> {
    ...
    async fn caller_channel_account_states(
        &self,
        caller: WebUiAuthenticatedCaller,
    ) -> Result<HashMap<String, ChannelAuthAccountState>, IronClawServicesError> {
...
fn personal_credential_cleanup_request(
    ...
    extension_id: &str,
    provider: &str,
) -> Result<SecretCleanupRequest, IronClawServicesError> {
...
mod tests {
    ...
    use crate::provider_identity::{
        IronClawUserIdentityBindingError, IronClawUserIdentityLookupError,
...
"#;
    ...
    impl ChannelCredentialCleanup for FailingCredentialCleanup {
        async fn cleanup_credentials_for_lifecycle(
            ...
            Err(IronClawServicesError::internal_from(
    ...
    #[async_trait]
    impl IronClawUserIdentityLookup for RecordingIdentityStore {
