//! Skill learning: turn-end skill distillation for the IronClaw runtime.
//!
...
mod learning {
    ...
    use crate::extension_host::lifecycle::{
        IronClawLocalSkillManagementError, IronClawLocalSkillManagementPort,
    };
    ...
    /// `IronClawLocalSkillManagementPort`; tests use a stub. Keeps the sink
    ...
    pub(crate) struct PortSkillWriter {
        port: Arc<IronClawLocalSkillManagementPort>,
    ...
    impl SkillWriter for PortSkillWriter {
        async fn install_or_update(
                ...
                .await
            {
                ...
                Err(IronClawLocalSkillManagementError::Skill(error))
