...
mod serve_mount {
    ...
    ) -> Result<PublicRouteMount, crate::IronClawBuildError> {
        let descriptor =
    ...
    fn ingress_route_descriptor(
        route_id: &'static str,
        path: &'static str,
    ) -> Result<IngressRouteDescriptor, crate::IronClawBuildError> {
        ...
        .map_err(|error| crate::IronClawBuildError::InvalidConfig {
...
mod tests {
    ...
    use ironclaw_product_workflow::{
        ChannelInboundSurfaceAdmission, ChannelInboundSurfaceOutcome, IronClawServicesError,
        IronClawServicesErrorCode, IronClawServicesErrorKind, ProductOperationId,
        ProductOperationResponse, ProductOperationTypedInput, ProductSurface,
    };
