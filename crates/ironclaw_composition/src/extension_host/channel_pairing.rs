...
//! external actor to the code's IronClaw user through the generic
...
use crate::provider_identity::{
    ...
    IronClawUserIdentityBindingStore, IronClawUserIdentityLookup,
...
pub(crate) struct ChannelPairingService {
    ...
    identity_bind: Arc<dyn IronClawUserIdentityBindingStore>,
    identity_lookup: Arc<dyn IronClawUserIdentityLookup>,
    identity_delete: Arc<dyn IronClawUserIdentityBindingDeleteStore>,
    continuation: Arc<dyn IronClawAuthContinuationDispatcher>,
...
pub(crate) struct ChannelPairingServiceParts {
    ...
    pub(crate) identity_bind: Arc<dyn IronClawUserIdentityBindingStore>,
    pub(crate) identity_lookup: Arc<dyn IronClawUserIdentityLookup>,
    pub(crate) identity_delete: Arc<dyn IronClawUserIdentityBindingDeleteStore>,
    pub(crate) continuation: Arc<dyn IronClawAuthContinuationDispatcher>,
...
impl ChannelPairingService {
    ...
    pub(crate) async fn consume(
        ...
        let binding = IronClawUserIdentityBinding {
            ...
            provider_user_id: IronClawIdentityProviderUserId::new(provider_user_id.clone())
                .map_err(store_unavailable)?,
    ...
    fn identity_provider(&self) -> Result<IronClawIdentityProviderId, ChannelPairingError> {
        IronClawIdentityProviderId::new(self.extension_id.as_str()).map_err(store_unavailable)
    }
