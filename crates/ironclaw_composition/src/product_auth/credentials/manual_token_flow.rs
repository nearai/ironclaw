...
#[async_trait]
#[doc(hidden)]
pub trait IronClawManualTokenFlowService: Send + Sync {
...
#[async_trait]
impl IronClawManualTokenFlowService for PortBackedManualTokenFlowService {
    async fn request_manual_token_flow(
        &self,
        request: ManualTokenSetupRequest,
    ) -> Result<AuthChallenge, AuthProductError> {
...
#[async_trait]
impl IronClawManualTokenFlowService for InMemoryAuthProductServices {
    async fn request_manual_token_flow(
        &self,
        request: ManualTokenSetupRequest,
    ) -> Result<AuthChallenge, AuthProductError> {
...
#[async_trait]
impl<F> IronClawManualTokenFlowService for FilesystemAuthProductServices<F>
where
