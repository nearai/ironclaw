...
use crate::product_auth::credentials::manual_token_flow::{
    IronClawManualTokenFlowService, PortBackedManualTokenFlowService,
};
...
#[async_trait]
pub trait IronClawAuthContinuationDispatcher: Send + Sync {
...
#[cfg(test)]
#[async_trait]
impl IronClawAuthContinuationDispatcher for NoopAuthContinuationDispatcher {
    async fn dispatch_auth_continuation(
        &self,
...
#[async_trait]
impl IronClawAuthContinuationDispatcher for ProductAuthTurnGateResumeDispatcher {
    async fn dispatch_auth_continuation(
        &self,
        event: AuthContinuationEvent,
    ) -> Result<(), AuthProductError> {
...
/// IronClaw product-auth boundary.
///
...
#[derive(Debug)]
pub struct IronClawOAuthCallbackRequest {
    pub scope: AuthProductScope,
    pub flow_id: AuthFlowId,
    pub opaque_state_hash: OpaqueStateHash,
    pub outcome: IronClawOAuthCallbackOutcome,
}
...
#[derive(Debug, Clone)]
pub(crate) struct IronClawOAuthStartFlowRequest {
...
#[derive(Debug)]
pub enum IronClawOAuthCallbackOutcome {
    Authorized {
...
pub struct IronClawOAuthCallbackResponse {
    pub flow_id: AuthFlowId,
...
pub struct IronClawAuthProductError {
    pub code: AuthErrorCode,
    pub retryable: bool,
}

impl From<AuthProductError> for IronClawAuthProductError {
...
pub type IronClawOAuthCallbackError = IronClawAuthProductError;
...
/// Request to open a IronClaw manual-token setup interaction.
///
...
/// [`IronClawManualTokenSubmitRequest`].
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct IronClawManualTokenSetupRequest {
    pub scope: AuthProductScope,
...
impl IronClawManualTokenSetupRequest {
    pub fn new(
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawManualTokenChallenge {
...
pub struct IronClawManualTokenSubmitRequest {
    pub scope: AuthProductScope,
    pub interaction_id: AuthInteractionId,
    pub secret: SecretString,
}

impl IronClawManualTokenSubmitRequest {
    pub fn new(
        scope: AuthProductScope,
...
impl std::fmt::Debug for IronClawManualTokenSubmitRequest {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        formatter
            .debug_struct("IronClawManualTokenSubmitRequest")
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct IronClawManualTokenSubmitResponse {
...
pub type IronClawManualTokenError = IronClawAuthProductError;

/// Stable sanitized lifecycle failure safe for Web/CLI/API surfaces.
pub type IronClawCredentialLifecycleError = IronClawAuthProductError;
...
#[derive(Clone)]
pub struct IronClawProductAuthServicePorts {
    flow_manager: Arc<dyn AuthFlowManager>,
    interaction_service: Arc<dyn AuthInteractionService>,
    manual_token_flow_service: Arc<dyn IronClawManualTokenFlowService>,
...
impl std::fmt::Debug for IronClawProductAuthServicePorts {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        formatter
            .debug_struct("IronClawProductAuthServicePorts")
            ...
            .field(
                ...
                &"Arc<dyn IronClawManualTokenFlowService>",
            )
            .field(
...
impl IronClawProductAuthServicePorts {
    pub fn new(
        flow_manager: Arc<dyn AuthFlowManager>,
        interaction_service: Arc<dyn AuthInteractionService>,
        credential_setup_service: Arc<dyn CredentialSetupService>,
    ...
    where
        T: AuthFlowManager
            ...
            + IronClawManualTokenFlowService
            + 'static,
    {
            ...
            + 'static,
    {
        ...
        let manual_token_flow_service: Arc<dyn IronClawManualTokenFlowService> = services.clone();
    ...
    pub(crate) fn into_services(
        self,
        continuation_dispatcher: Arc<dyn IronClawAuthContinuationDispatcher>,
...
/// IronClaw product-auth service bundle exposed by the composition root.
///
...
#[derive(Clone)]
pub struct IronClawProductAuthServices {
    flow_manager: Arc<dyn AuthFlowManager>,
    interaction_service: Arc<dyn AuthInteractionService>,
    manual_token_flow_service: Arc<dyn IronClawManualTokenFlowService>,
    credential_setup_service: Arc<dyn CredentialSetupService>,
    ...
    ///
    /// `IronClawProductAuthServices` may still support OAuth callbacks,
...
impl std::fmt::Debug for IronClawProductAuthServices {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut dbg = formatter.debug_struct("IronClawProductAuthServices");
...
impl IronClawProductAuthServices {
    pub fn new(
        flow_manager: Arc<dyn AuthFlowManager>,
        interaction_service: Arc<dyn AuthInteractionService>,
        credential_setup_service: Arc<dyn CredentialSetupService>,
    ...
    /// accounts from a developer's local IronClaw store into an isolated test
    ...
    fn with_manual_token_flow_service(
        mut self,
        service: Arc<dyn IronClawManualTokenFlowService>,
    ) -> Self {
    ...
    pub fn with_continuation_dispatcher(
        mut self,
        dispatcher: Arc<dyn IronClawAuthContinuationDispatcher>,
    ) -> Self {
    ...
    ) -> Result<CredentialRefreshReport, IronClawCredentialLifecycleError> {
        self.credential_account_service
            .refresh_account(request)
            .await
            .map_err(IronClawCredentialLifecycleError::from)
    }
    ...
    ) -> Result<CredentialAccountListPage, IronClawCredentialLifecycleError> {
        self.credential_account_service
    ...
    ) -> Result<CredentialAccountProjection, IronClawCredentialLifecycleError> {
        self.credential_account_service
    ...
    ) -> Result<CredentialRecoveryProjection, IronClawCredentialLifecycleError> {
        self.credential_account_service
    ...
    ///
    /// This facade keeps lifecycle callers on the IronClaw product-auth boundary
    /// instead of depending on V1 extension-manager cleanup or route-local
    /// secret authority.
    pub async fn cleanup_credentials_for_lifecycle(
        &self,
        request: SecretCleanupRequest,
    ) -> Result<SecretCleanupReport, IronClawCredentialLifecycleError> {
        let report = self
            .cleanup_service
    ...
    pub async fn handle_oauth_callback(
        &self,
        request: IronClawOAuthCallbackRequest,
    ) -> Result<IronClawOAuthCallbackResponse, IronClawOAuthCallbackError> {
    ...
    pub(crate) async fn handle_oauth_callback_with_optional_provider_identity_check(
        ...
        let (mut completed, should_dispatch_continuation) = match request.outcome {
            IronClawOAuthCallbackOutcome::Authorized { provider_request } => {
                let claimed = self
                    .flow_manager
                    ...
                    .await
                    .map_err(IronClawOAuthCallbackError::from)?;
                        ...
                        Err(error) => {
                                ...
                                .await
                            {
                                tracing::warn!(
                                    ...
                                    "IronClaw auth callback provider exchange failed and flow failure update failed"
                                );
                            }
                            ...
                            Err(error) => {
                                    ...
                                    .await
                                {
                                    tracing::warn!(
                                        ...
                                        "IronClaw auth callback provider identity check failed and token cleanup failed"
                                    );
                                }
                                if let Err(fail_error) = self
                                    .flow_manager
                                    ...
                                    .await
                                {
                                    tracing::warn!(
                                        ...
                                        check_error_code = ?error_code,
                                        fail_error_code = ?fail_error.code(),
                                        "IronClaw auth callback provider identity check failed and flow failure update failed"
                                    );
                                }
                                return Err(error.into());
                            }
                        ...
                        Err(error) => {
                                ...
                                .await
                            {
                                tracing::warn!(
                                    ...
                                    cleanup_error_code = ?cleanup_error.code(),
                                    "IronClaw auth callback completion failed and token cleanup failed"
                                );
                            }
            ...
            IronClawOAuthCallbackOutcome::ProviderDenied => self
                .flow_manager
                .complete_oauth_callback(
                    &request.scope,
                    OAuthCallbackInput {
                ...
                .map_err(IronClawOAuthCallbackError::from)?,
            IronClawOAuthCallbackOutcome::Malformed => {
        ...
        Ok(IronClawOAuthCallbackResponse {
    ...
    ) -> Result<AuthProviderId, IronClawOAuthCallbackError> {
    ...
    pub(crate) async fn flow_status(
        ...
        scope: &AuthProductScope,
        flow_id: AuthFlowId,
    ) -> Result<AuthFlowStatus, IronClawOAuthCallbackError> {
    ...
    pub(crate) async fn oauth_pkce_verifier_for_flow(
        ...
        provider: &AuthProviderId,
        flow_id: AuthFlowId,
    ) -> Result<Option<SecretString>, IronClawOAuthCallbackError> {
        let _ = provider;
    ...
    pub(crate) async fn start_setup_oauth_flow(
        &self,
        request: IronClawOAuthStartFlowRequest,
    ...
    pub async fn request_manual_token_setup(
        &self,
        request: IronClawManualTokenSetupRequest,
    ) -> Result<IronClawManualTokenChallenge, IronClawManualTokenError> {
        let challenge = self
            .manual_token_flow_service
            ...
            .await
            .map_err(IronClawManualTokenError::from)?;
        ...
        match challenge {
            ironclaw_auth::AuthChallenge::ManualTokenRequired {
                ...
                label,
                expires_at,
            } => Ok(IronClawManualTokenChallenge {
                interaction_id,
                provider,
                label,
                expires_at,
    ...
    pub async fn submit_manual_token(
        &self,
        request: IronClawManualTokenSubmitRequest,
    ) -> Result<IronClawManualTokenSubmitResponse, IronClawManualTokenError> {
        ...
        let (result, completed) = match submit {
            ...
            Err(AuthProductError::UnknownOrExpiredFlow) => self
                ...
                .map_err(IronClawManualTokenError::from)?,
            Err(error) => return Err(IronClawManualTokenError::from(error)),
        };
        self.dispatch_completed_continuation(completed)
            .await
            .map_err(IronClawManualTokenError::from)?;

        Ok(IronClawManualTokenSubmitResponse {
    ...
    async fn recover_completed_manual_token_submit(
        ...
        scope: &AuthProductScope,
        interaction_id: AuthInteractionId,
    ) -> Result<Option<(SecretSubmitResult, AuthFlowRecord)>, IronClawManualTokenError> {
    ...
    pub async fn abandon_manual_token(
        ...
        scope: &AuthProductScope,
        interaction_id: AuthInteractionId,
    ) -> Result<bool, IronClawManualTokenError> {
    ...
    async fn dispatch_completed_continuation(
            ...
            .await
        {
            ...
            tracing::debug!(
                ...
                "IronClaw auth flow completed but continuation dispatch failed"
            );
    ...
    pub(crate) fn local_dev_in_memory(
        ...
        IronClawProductAuthServicePorts::from_shared(services.clone())
            .into_services(
                continuation_dispatcher,
...
#[async_trait]
impl RuntimeCredentialAccountRefreshPort for IronClawProductAuthServices {
    async fn refresh_credential_account(
        &self,
        request: CredentialRefreshRequest,
    ) -> Result<CredentialRefreshReport, AuthProductError> {
        IronClawProductAuthServices::refresh_credential_account(self, request)
            .await
            .map_err(auth_product_error_from_ironclaw_error)
    }
}
...
#[async_trait]
impl ironclaw_auth::KeepaliveRefreshPort for IronClawProductAuthServices {
...
fn auth_product_error_from_ironclaw_error(error: IronClawAuthProductError) -> AuthProductError {
    match error.code {
...
#[async_trait]
impl AuthChallengeProvider for IronClawProductAuthServices {
...
#[async_trait]
impl BlockedAuthFlowCanceller for IronClawProductAuthServices {
