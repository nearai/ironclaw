//! Tests for `IronClawAutomationProductFacade::resolve_run_thread_scope`.
//!
...
use ironclaw_product_workflow::{
    AutomationProductFacade, IronClawServicesErrorCode, ProductAgentBoundCaller,
};
...
use crate::automation::facade::IronClawAutomationProductFacade;
...
async fn resolve_run_thread_scope_timeout_maps_to_unavailable() {
    let facade = IronClawAutomationProductFacade::with_backend_timeout(
