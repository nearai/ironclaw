...
//!
//! The IronClaw provider catalog (`providers.json`) only ever references an
...
impl LlmKeyStore {
    ...
    /// `crates/ironclaw_architecture/tests/ironclaw_dependency_boundaries.rs::ironclaw_cli_binary_crate_stays_separate_from_v1_root`,
