...
mod tests {
    ...
    use ironclaw_config::{IronClawHome, IronClawProfile};
    ...
    fn callback_mount(
        ...
        let home =
            IronClawHome::resolve_from_env_parts(Some(root.as_os_str().to_os_string()), None, None)
                .expect("temporary IronClaw home is valid");
        ...
        nearai_login_callback_mount(
            session,
            reload,
            IronClawBootConfig::new(home, IronClawProfile::LocalDev),
            states,
        )
    }
