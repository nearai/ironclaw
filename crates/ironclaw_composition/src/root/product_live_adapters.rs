...
//!
//! This module does not cut app or gateway traffic over to IronClaw. It provides
...
impl ProductLivePlannedRuntimeAdapters {
    /// Builds the adapter bundle from `IronClawServices` and explicit product-live dependencies.
    ///
