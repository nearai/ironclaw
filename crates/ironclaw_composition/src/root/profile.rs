...
pub enum IronClawCompositionProfile {
    #[default]
    Disabled,
    LocalDev,
    LocalDevYolo,
...
impl IronClawCompositionProfile {
    ...
    pub fn to_event_store_profile(self) -> ironclaw_event_store::IronClawProfile {
        self.deployment().event_store_profile()
    }
}

impl FromStr for IronClawCompositionProfile {
    type Err = IronClawCompositionProfileParseError;
    ...
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        ...
        match normalized.as_str() {
            ...
            _ => Err(IronClawCompositionProfileParseError { value: normalized }),
        }
    }
}

impl std::fmt::Display for IronClawCompositionProfile {
...
#[error("invalid IronClaw composition profile '{value}'")]
pub struct IronClawCompositionProfileParseError {
    value: String,
}
