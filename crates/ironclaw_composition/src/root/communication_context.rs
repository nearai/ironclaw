...
use ironclaw_product_workflow::{
    IronClawOutboundDeliveryTargetStatus, LifecycleProductAction, LifecycleProductContext,
    LifecycleProductFacade, LifecycleProductPayload, LifecycleProductSurfaceContext,
    OutboundPreferencesProductFacade, WebUiAuthenticatedCaller,
};
use ironclaw_turns::{
    run_profile::{
...
async fn fetch_communication_context(
    ...
    let delivery_target = match pref_result {
        Ok(response) => match (
            ...
            (None, IronClawOutboundDeliveryTargetStatus::Unavailable) => {
...
mod tests {
    ...
    use ironclaw_product_workflow::{
        ...
        IronClawOutboundPreferencesResponse, IronClawServicesError, IronClawServicesErrorCode,
        IronClawServicesErrorKind, IronClawSetOutboundPreferencesRequest,
    ...
    fn test_service_error() -> IronClawServicesError {
        ...
        ($name:ident, $get:expr) => {
            ...
            impl OutboundPreferencesProductFacade for $name {
                ...
                async fn set_outbound_preferences(
                    &self,
                    _caller: WebUiAuthenticatedCaller,
                    _request: IronClawSetOutboundPreferencesRequest,
                ) -> Result<IronClawOutboundPreferencesResponse, IronClawServicesError> {
                    $get
                }
    ...
    fake_preferences_facade!(
        ...
        Ok(IronClawOutboundPreferencesResponse::default())
    );
    ...
    fake_preferences_facade!(
        ...
        Ok(IronClawOutboundPreferencesResponse {
            ...
            final_reply_target_status: IronClawOutboundDeliveryTargetStatus::Unavailable,
            ..Default::default()
        })
    );
        ...
        Ok(IronClawOutboundPreferencesResponse {
            final_reply_target: Some(
                IronClawOutboundDeliveryTargetSummary::new(
                    IronClawOutboundDeliveryTargetId::new("target-1").unwrap(),
                    "slack",
                    "#alerts",
                    None,
                )
