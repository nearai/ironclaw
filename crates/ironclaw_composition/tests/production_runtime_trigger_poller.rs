...
//! **production-shaped** `IronClawRuntime` (`local_runtime: None`,
...
//! `build_ironclaw_runtime` returned `Err` the moment `trigger_poller.enabled`
...
use ironclaw_composition::{
    ...
    IronClawRuntimeProcessBinding, TriggerPollerSettings, build_ironclaw_runtime,
...
) -> ironclaw_composition::IronClawRuntime {
    let db = Arc::new(
