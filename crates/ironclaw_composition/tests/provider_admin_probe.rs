//! Caller-level tests for [`IronClawProviderAdmin::probe_candidate`] against a
//! live loopback HTTP stub.
//!
//! Lives outside `src/` on purpose: the architecture boundary test
//! `ironclaw_product_api_crates_do_not_bind_http_ingress`
...
use ironclaw_composition::{IronClawProviderAdmin, ProviderRepo};
...
fn write_stub_provider(home: &IronClawHome, base_url: &str) {
