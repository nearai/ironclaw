...
//!    → `IronClawServices::get_timeline` → composed WebUI v2 HTTP layer.
//!
...
use ironclaw_composition::{
    ...
    IronClawRuntimeProfileOptions, IronClawWebuiBundle, TriggerPollerSettings,
    build_ironclaw_runtime, build_webui_services, local_runtime_build_input_with_options,
};
...
async fn build_timeline_runtime(root: &tempfile::TempDir) -> IronClawRuntime {
...
fn build_timeline_app(runtime: &IronClawRuntime) -> axum::Router {
