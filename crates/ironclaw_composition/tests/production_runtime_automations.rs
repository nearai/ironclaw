//! Integration test that fully builds a production-shape `IronClawRuntime` and
...
use ironclaw_product_workflow::{
    AUTOMATIONS_VIEW, IronClawListAutomationsResponse, IronClawViewQuery, WebUiAuthenticatedCaller,
...
async fn production_runtime_webui_serves_automations_without_local_runtime() {
    ...
    let result: IronClawListAutomationsResponse =
