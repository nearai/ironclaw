...
pub const LEGACY_IRONCLAW_PROFILE_ENV: &str = "IRONCLAW_REBORN_PROFILE";

/// Coarse boot profile for the standalone IronClaw binary.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub enum IronClawProfile {
...
impl IronClawProfile {
    ...
    pub fn from_env_value(value: Option<OsString>) -> Result<Self, IronClawConfigError> {
    ...
    pub fn from_env_values(
        ...
        match value {
            ...
            None => Self::from_env_value_named(legacy_value, LEGACY_IRONCLAW_PROFILE_ENV),
        }
    }
...
impl FromStr for IronClawProfile {
    type Err = IronClawConfigError;
...
impl IronClawProfile {
    fn parse_named(value: &str, name: &'static str) -> Result<Self, IronClawConfigError> {
        match value {
            ...
            other => Err(IronClawConfigError::InvalidProfile {
                name,
...
impl std::fmt::Display for IronClawProfile {
