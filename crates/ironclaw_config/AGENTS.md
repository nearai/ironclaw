...
- Read `src/lib.rs` for exports, then area files:
  - `home.rs` — IronClaw home resolution.
...
- IronClaw home/profile/config-file/doctor/secrets-guard types and validation.
...
- Use explicit IronClaw home/profile inputs; do not read ambient env from deep helpers unless that is the contract being tested.
