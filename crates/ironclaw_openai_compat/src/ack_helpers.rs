...
use ironclaw_product_workflow::IronClawSubmitTurnResponse;
...
pub(crate) fn product_ack_from_ironclaw_submit(
    response: IronClawSubmitTurnResponse,
) -> ProductInboundAck {
    match response {
        ...
        | IronClawSubmitTurnResponse::AlreadySubmitted {
            accepted_message_ref,
            run_id,
            ..
        } => ProductInboundAck::Accepted {
        ...
        IronClawSubmitTurnResponse::RejectedBusy {
            accepted_message_ref,
            active_run_id,
            ..
        } => ProductInboundAck::RejectedBusy {
