//! Durable storage adapters for IronClaw OpenAI-compatible refs.
//!
//! This module keeps persistence behind the
//! [`OpenAiCompatRefStore`](crate::OpenAiCompatRefStore)
//! port. Contract-only consumers keep the default feature set; IronClaw
...
pub struct IronClawLibSqlOpenAiCompatRefStore {
    inner: FilesystemOpenAiCompatRefStore,
}
impl IronClawLibSqlOpenAiCompatRefStore {
...
#[async_trait]
impl OpenAiCompatRefStore for IronClawLibSqlOpenAiCompatRefStore {
    async fn reserve(
        &self,
        request: OpenAiCompatRefReservation,
    ) -> Result<OpenAiCompatRefReservationOutcome, OpenAiCompatRefError> {
...
pub struct IronClawPostgresOpenAiCompatRefStore {
    inner: FilesystemOpenAiCompatRefStore,
}
impl IronClawPostgresOpenAiCompatRefStore {
...
#[async_trait]
impl OpenAiCompatRefStore for IronClawPostgresOpenAiCompatRefStore {
    async fn reserve(
        &self,
        request: OpenAiCompatRefReservation,
    ) -> Result<OpenAiCompatRefReservationOutcome, OpenAiCompatRefError> {
