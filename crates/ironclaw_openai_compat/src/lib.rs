...
//! IronClaw-native OpenAI-compatible API contract surface.
//!
...
//! Responses, and projection-streaming services for the wired IronClaw slices.
...
pub use refs_storage::IronClawLibSqlOpenAiCompatRefStore;
pub use refs_storage::IronClawPostgresOpenAiCompatRefStore;
pub use responses::{
