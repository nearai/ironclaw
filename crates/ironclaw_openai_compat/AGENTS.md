...
- Read `CLAUDE.md` first; it defines the OpenAI-compatible IronClaw boundary.
...
- IronClaw-native OpenAI-compatible HTTP route descriptors.
...
- Execution of client-supplied OpenAI tools as IronClaw capabilities.
