...
fn ref_mapping_deserialization_revalidates_nested_refs() {
    ...
    serde_json::from_value::<ironclaw_openai_compat::OpenAiCompatResourceMapping>(mapping)
    ...
    let err =
        serde_json::from_value::<ironclaw_openai_compat::OpenAiCompatResourceMapping>(invalid)
    ...
    let err =
        serde_json::from_value::<ironclaw_openai_compat::OpenAiCompatResourceMapping>(inconsistent)
