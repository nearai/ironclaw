...
| `ironclaw_reborn_extensions` | `ironclaw_reborn_extensions/AGENTS.md`, `Cargo.toml` | First-party userland Reborn extensions with explicit scoped handles and narrow loop-facing ports. | Ambient runtime authority, dispatcher/network/secrets handles, or Reborn composition wiring. |
