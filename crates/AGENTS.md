...
- UI presentation: `ironclaw_webui` owns the Reborn route surface, serve lifecycle, auth, and static WebUI bundle. Product behavior remains behind the product-workflow facade.
