...
| `ironclaw_first_party_extensions` | `ironclaw_first_party_extensions/AGENTS.md` | First-party userland extensions for Reborn: scoped skill handles, loaded extension ports, selectable skill activation context source. | Runtime composition, raw host authority, generic skill registry/scoring behavior. |
