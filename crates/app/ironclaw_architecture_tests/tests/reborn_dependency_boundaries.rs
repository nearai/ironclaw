...
fn reborn_contracts_crates_carry_a_checked_size_ceiling() {
    ...
    const SIZE_CEILINGS: &[(&str, usize)] = &[
        ...
        // own failure message.
        //
        // 7_947 -> <see below> (2026-08-10, telegram-linked-device): the
        ...
        ("ironclaw_extension_contracts", 9_519),
        ...
        //
        // 19_086 -> <see below> (2026-08-10, telegram-linked-device): the
        ...
        // 16_024 -> 16_049 (2026-08-10, telegram-linked-device PR 2 — the
        ...
        ("ironclaw_product_contracts", 16_049),
