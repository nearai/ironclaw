...
use ironclaw_hooks::ordering::HookPhase as HookEvalPhase;
...
use ironclaw_hooks::{HookLocalId, HookRegistrar};
...
fn extension_deny_hook_factory(
    ...
    Arc::new(move || {
        ...
        let (next, _ids) = registrar
            .install(ext_id, "0.1.0".to_string(), vec![entry], builder)
