...
- Own canonical IronClaw `session_threads`, transcript message contracts, message ordering/status/redaction semantics, context-window reads, and in-memory/fake plus feature-gated durable contract stores.
