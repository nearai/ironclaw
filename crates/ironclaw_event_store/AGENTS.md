...
- No crate-local `CLAUDE.md` exists yet; use this map plus the IronClaw contracts below.
...
- IronClaw-owned durable event/audit store backends and their selection facade, currently:
- Backend selection/composition: `IronClawEventStoreConfig`, `IronClawProfile`, `IronClawEventStores`, `IronClawEventStoreError`.
