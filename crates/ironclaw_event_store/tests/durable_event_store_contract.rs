...
async fn libsql_replay_advances_next_cursor_past_trailing_filtered_records() {
    ...
    let stores = build_ironclaw_event_stores(
        ...
        IronClawEventStoreConfig::Libsql {
...
async fn postgres_replay_advances_next_cursor_past_trailing_filtered_records() {
    ...
    let stores = build_ironclaw_event_stores(
        IronClawProfile::Production,
        IronClawEventStoreConfig::Postgres {
...
async fn jsonl_concurrent_appenders_emit_monotonic_cursors_through_file_lock() {
    ...
    let stores_one = build_ironclaw_event_stores(
        IronClawProfile::LocalDev,
        IronClawEventStoreConfig::Jsonl {
            root: root.clone(),
            accept_single_node_durable: false,
    ...
    .await
    .expect("stores one");
    let stores_two = build_ironclaw_event_stores(
        IronClawProfile::LocalDev,
        IronClawEventStoreConfig::Jsonl {
            root: root.clone(),
            accept_single_node_durable: false,
    ...
    let reader = build_ironclaw_event_stores(
        IronClawProfile::LocalDev,
        IronClawEventStoreConfig::Jsonl {
            root,
            accept_single_node_durable: false,
