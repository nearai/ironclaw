...
pub const STYLE_CSS: &str = concat!(
    ...
    "\n",
    include_str!("../static/styles/components/reasoning.css"),
    "\n",
    include_str!("../static/styles/components/toollines.css"),
    "\n",
    include_str!("../static/styles/components/approval.css"),
    "\n",
    include_str!("../static/styles/components/subagent.css"),
    "\n",
    include_str!("../static/styles/primitives/toast.css"),
    "\n",
    include_str!("../static/styles/primitives/type.css"),
    "\n",
