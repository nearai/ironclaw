...
document.getElementById('secret-save-btn')?.addEventListener('click', () => saveSecretFromForm());
document.getElementById('secret-clear-btn')?.addEventListener('click', () => resetSecretForm());
document.getElementById('secrets-import-btn')?.addEventListener('click', () => importSecrets());
