...
I18n.register('en', {
  ...
  'secrets.description': 'Store per-user API tokens here. Secret values stay out of chat and are never shown again after saving.',
  'secrets.import': 'Import secrets',
  'secrets.save': 'Save secret',
  'secrets.update': 'Update secret',
  'secrets.edit': 'Edit',
  'secrets.delete': 'Delete',
  'secrets.namePlaceholder': 'Secret name (e.g. github_token)',
  'secrets.valuePlaceholder': 'Secret value',
  'secrets.providerPlaceholder': 'Provider hint (optional)',
  'secrets.expiryPlaceholder': 'Expires in days (optional)',
  'secrets.editingNote': 'Updating a secret requires entering the replacement value.',
  'secrets.columns.name': 'Name',
  'secrets.columns.provider': 'Provider',
  'secrets.columns.updated': 'Updated',
  'secrets.columns.expires': 'Expires',
  'secrets.columns.approvals': 'Approvals',
  'secrets.columns.actions': 'Actions',
  'secrets.emptyState': 'No secrets configured yet.',
  'secrets.noApprovals': 'No approvals',
  'secrets.approvalCount': '{count} approval(s)',
  'secrets.nameRequired': 'Secret name is required',
  'secrets.valueRequired': 'Secret value is required',
  'secrets.expiryInvalid': 'Expiry must be a positive number of days',
  'secrets.saveSuccess': 'Saved secret {name}',
  'secrets.saveFailed': 'Failed to save secret: {message}',
  'secrets.deleteSuccess': 'Deleted secret {name}',
  'secrets.deleteFailed': 'Failed to delete secret: {message}',
  'secrets.importSuccess': 'Secrets imported',
  'secrets.importFailed': 'Failed to import secrets: {message}',
  'secrets.importFormatError': 'Expected a JSON object with a secrets array',
  'secrets.approvalsHeading': 'Approved bindings',
  'secrets.approvalDetails': '{kind} {artifact} → {host} via {location} · approved {approvedAt} · risk: {risk}',
  'secrets.riskHigh': 'high',
  'secrets.riskNormal': 'normal',
  'secrets.revoke': 'Revoke',
  'secrets.revokeSuccess': 'Approval revoked',
  'secrets.revokeFailed': 'Failed to revoke approval: {message}',
  'secrets.confirmDeleteTitle': 'Delete secret {name}?',
  'secrets.confirmDeleteMessage': 'This removes the stored secret value for {name}.',
  'secrets.confirmRevokeTitle': 'Revoke binding for {name}?',
  'secrets.confirmRevokeMessage': 'This removes the approval for {artifact} on {host}.',
