...
I18n.register('zh-CN', {
  ...
  'missions.status': '状态',
  'missions.runs': '运行',
  'missions.lastRun': '上次运行',
  'missions.runSummary': '运行摘要',
  'missions.totalRuns': '总运行次数',
  'missions.noRuns': '尚无运行',
  'missions.runState.completed': '已完成',
  'missions.runState.failed': '失败',
  'missions.runState.inProgress': '进行中',
