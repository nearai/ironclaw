...
I18n.register('zh-CN', {
  ...
  // 工具权限
  'settings.tools': '工具',
  'settings.traceCommons': '轨迹共享',
  'traceCommons.empty': '还没有轨迹共享贡献。选择加入并贡献已脱敏轨迹后，你的积分会显示在这里。',
  'traceCommons.creditsTitle': '轨迹共享积分',
  ...
  'traceCommons.finalCreditDesc': '已确认积分',
  'traceCommons.delayedLedger': '延迟账本',
  'traceCommons.delayedLedgerDesc': '审核后仍可能变更',
  'traceCommons.submissions': '提交',
  'traceCommons.submissionsSummary': '已提交 {submitted} / 共 {total}',
  'traceCommons.submissionsAcceptedSuffix': '，已接受 {accepted}',
  'traceCommons.lastSynced': '上次同步',
  'traceCommons.lastSyncedDesc': '截至上次同步的本地视图',
  'traceCommons.never': '从未',
  'traceCommons.caveat': '这是截至上次同步的本地视图；权威积分账本位于服务器端。最终积分可能会在隐私审核、回放/评测、重复检查和下游效用评分后发生变化。',
  ...
  'debug.promptLabelAgents': '代理指令',
  'debug.promptLabelSoul': '核心价值观',
  'debug.promptLabelUser': '用户上下文',
  'debug.promptLabelIdentity': '身份',
  'debug.promptLabelTools': '工具备注',
  'debug.promptLabelMemory': '长期记忆',
  ...
  'debug.statsCost': '会话费用',
  'debug.statsDailyCost': '今日费用',
  'debug.statsToolCalls': '工具调用',
  'debug.activityEvicted': '该轮次的活动已从内存日志中移除（上限 1000 条）。',
  ...
  'debug.activityCode': '代码',
  'debug.activityStdout': '标准输出',
  'debug.activityReturn': '返回值',
  'debug.activityCodeExecuted': '代码执行',
  'debug.activityWarning': '警告',
  'debug.activityGateRequired': '需要通过',
  'debug.activityGateResolved': '已通过',
  'debug.activityApprovalNeeded': '需要批准',
  'debug.activitySkillActivated': '技能已激活',
  ...
  'debug.activityJobMessage': '作业消息',
  'debug.activityJobToolUse': '作业工具',
  'debug.activityJobToolResult': '作业工具结果',
  'debug.activityJobStatus': '作业状态',
  'debug.activityJobResult': '作业结果',
  'debug.activityJobReasoning': '作业推理',
  ...
  'chat.runFinishedWithoutReply': '运行结束但未生成回复。请重试；如果持续发生，请检查日志。',
  ...
  'missions.approachHistory': '方法历史',
  'missions.prompt': '使命提示',
  'missions.missionBrief': '使命简报',
  'missions.runLabel': '第 {number} 次运行',
  'missions.latestRun': '最新运行',
  'missions.goalAchieved': '目标已达成',
  'missions.openLoop': '未闭环',
  'missions.expectedLabel': '预期',
  'missions.observedLabel': '观察到',
  'missions.fixAppliedLabel': '已应用修复',
  'missions.nextFocusLabel': '下一重点',
  'missions.outcomeLabel': '结果',
  'missions.recentActivity': '最近活动',
  'missions.spawnedThreads': '已生成线程',
  'missions.cooldown': '冷却时间',
  'missions.project': '项目',
  'missions.retry': '重试',
  'missions.fireOnce': '执行一次',
  'missions.lastFire': '上次执行',
