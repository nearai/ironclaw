...
I18n.register('zh-CN', {
  ...
  'secrets.description': '在这里存储每个用户自己的 API 令牌。密钥值不会进入聊天，也不会在保存后再次显示。',
  'secrets.import': '导入 Secrets',
  'secrets.save': '保存 Secret',
  'secrets.update': '更新 Secret',
  'secrets.edit': '编辑',
  'secrets.delete': '删除',
  'secrets.namePlaceholder': 'Secret 名称（例如 github_token）',
  'secrets.valuePlaceholder': 'Secret 值',
  'secrets.providerPlaceholder': '提供方提示（可选）',
  'secrets.expiryPlaceholder': '有效天数（可选）',
  'secrets.editingNote': '更新 Secret 时必须重新输入替换后的值。',
  'secrets.columns.name': '名称',
  'secrets.columns.provider': '提供方',
  'secrets.columns.updated': '更新时间',
  'secrets.columns.expires': '过期时间',
  'secrets.columns.approvals': '批准',
  'secrets.columns.actions': '操作',
  'secrets.emptyState': '还没有配置任何 Secret。',
  'secrets.noApprovals': '无批准',
  'secrets.approvalCount': '{count} 个批准',
  'secrets.nameRequired': '必须填写 Secret 名称',
  'secrets.valueRequired': '必须填写 Secret 值',
  'secrets.expiryInvalid': '过期时间必须是正整数天数',
  'secrets.saveSuccess': '已保存 Secret {name}',
  'secrets.saveFailed': '保存 Secret 失败：{message}',
  'secrets.deleteSuccess': '已删除 Secret {name}',
  'secrets.deleteFailed': '删除 Secret 失败：{message}',
  'secrets.importSuccess': 'Secrets 导入成功',
  'secrets.importFailed': '导入 Secrets 失败：{message}',
  'secrets.importFormatError': '需要包含 secrets 数组的 JSON 对象',
  'secrets.approvalsHeading': '已批准绑定',
  'secrets.approvalDetails': '{kind} {artifact} → {host} / {location} · 批准时间 {approvedAt} · 风险：{risk}',
  'secrets.riskHigh': '高',
  'secrets.riskNormal': '普通',
  'secrets.revoke': '撤销',
  'secrets.revokeSuccess': '已撤销批准',
  'secrets.revokeFailed': '撤销批准失败：{message}',
  'secrets.confirmDeleteTitle': '删除 Secret {name}？',
  'secrets.confirmDeleteMessage': '这会移除 {name} 当前存储的 Secret 值。',
  'secrets.confirmRevokeTitle': '撤销 {name} 的绑定？',
  'secrets.confirmRevokeMessage': '这会移除 {artifact} 在 {host} 上的批准。',
