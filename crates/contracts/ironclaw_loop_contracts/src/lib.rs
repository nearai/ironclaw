...
pub use host::{
    ...
    LoopInlineMessageBody, LoopInlineMessageRole, LoopInput, LoopInputAck, LoopInputAckEffect,
    LoopInputAckToken, LoopInputBatch, LoopInputCursor, LoopInputCursorToken, LoopInputPort,
    LoopInterruptKind, LoopMessageContentPort, LoopModelCapabilityView, LoopModelMessage,
    LoopModelPort, LoopModelRequest, LoopModelResponse, LoopModelRouteSnapshot,
    LoopModelToolChoice, LoopModelUsage, LoopProcessRef, LoopProgressEvent, LoopProgressPort,
    ...
    ResolvedModelMessage, ResolvedToolResult, StageCheckpointPayloadRequest, UpdateAssistantDraft,
