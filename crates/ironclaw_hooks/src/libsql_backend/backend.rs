...
//! (`crate::predicate_state::InMemoryPredicateStateBackend`) against a
...
//! database file. The schema lives in [`crate::libsql_backend::schema`]; scope/key-hash
//! derivation in [`crate::libsql_backend::hashing`].
//!
...
//!
//! [`MAX_SAMPLES_PER_KEY`]: crate::predicate_state::MAX_SAMPLES_PER_KEY
//! [`PredicateBackendError::WindowOverflow`]: crate::predicate_state::PredicateBackendError::WindowOverflow
//!
...
use crate::libsql_backend::hashing::{
    invocation_key_hash, tenant_scope_hash, to_epoch_millis, value_key_hash, window_cutoff_millis,
};
use crate::libsql_backend::schema::{
    INVOCATIONS_TABLE, LIBSQL_PREDICATE_STATE_SCHEMA, VALUES_TABLE,
};
...
/// [`crate::libsql_backend::schema`]. Lives outside the `BEGIN IMMEDIATE` wrapper so the caller
...
///
/// [`MAX_HISTORY_KEYS`]: crate::predicate_state::MAX_HISTORY_KEYS
/// [`MAX_KEYS_PER_TENANT`]: crate::predicate_state::MAX_KEYS_PER_TENANT
/// [`PredicateStateBackend::evict_older_than`]: crate::predicate_state::PredicateStateBackend::evict_older_than
