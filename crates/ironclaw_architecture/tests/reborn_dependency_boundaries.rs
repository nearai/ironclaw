    ...
    vec![
        ...
        BoundaryRule {
            ...
            forbidden: vec![
                ...
                "ironclaw_outbound",
                "ironclaw_processes",
                "ironclaw_product_adapter_runtime_catalog",
        ...
        BoundaryRule {
            // Runtime catalog is read-model glue over registry state. It may
            // shape enabled adapter snapshots, but routing, WASM loading,
            // durable persistence, and secret resolution stay in later layers.
            crate_name: "ironclaw_product_adapter_runtime_catalog",
            forbidden: vec![
                "ironclaw",
                "ironclaw_authorization",
                "ironclaw_approvals",
