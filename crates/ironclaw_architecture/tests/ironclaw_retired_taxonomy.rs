...
//! This test pins all of it at **zero occurrences** across IronClaw code
...
const RETIRED_TERMS: &[&str] = &[
    ...
    "IronClawConnectableChannelInfo",
    "IronClawConnectableChannelListResponse",
...
/// runtime label), but nothing in IronClaw code may compare against the old
...
const SANCTIONED_PATHS: &[&str] = &[
    // v1 → IronClaw converter reads v1 domain names by design.
...
#[test]
fn ironclaw_code_never_references_retired_taxonomy() {
