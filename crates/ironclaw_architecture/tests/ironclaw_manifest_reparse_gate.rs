...
//!
//! Pattern mirrors `ironclaw_extension_specificity.rs`: scan production Rust with
...
const ALLOWLIST: &[(&str, usize, ReparseCategory, &str)] = &[
    ...
    (
        "crates/ironclaw_composition/src/extension_host/available_extension_import.rs",
        1,
        ReparseCategory::Compiler,
...
/// `ironclaw_extension_specificity.rs` uses.
