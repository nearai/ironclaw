...
//!
//! Goal (docs/ironclaw/extension-runtime/overview.md §1): no generic crate
...
//!
//! Scope: the `src/` tree and `Cargo.toml` of every generic IronClaw workspace
...
const PATH_TERM_COLLISIONS: &[(&str, &str, &str)] = &[
    ...
    (
        "crates/ironclaw_identity/src/filesystem_store.rs",
        "slack",
    ...
    // (`ironclaw_traces`): `tool_payload_profile` selects the
    ...
    (
        "crates/ironclaw_traces/src/contribution.rs",
        "slack",
...
/// structural reason, mirroring `ironclaw_retired_taxonomy.rs`: the one-time
...
/// IronClaw layers whose crates are "generic" for this gate. Legacy-layer and
/// unlayered (non-workspace) crates are the v1 enclave.
const IRONCLAW_LAYERS: &[&str] = &[
    "contracts",
    "substrates",
    "runtimes",
    "kernel",
...
const SANCTIONED_SCAN_EXEMPT_CRATES: &[&str] = &[
    ...
    "ironclaw",
    // The post-Tier-B workspace root: a test-only host for the IronClaw
...
fn generic_scan_roots(metadata: &Value, root: &Path) -> Vec<ScanRoot> {
    ...
    for package in packages {
        ...
        if !layer.is_some_and(|layer| IRONCLAW_LAYERS.contains(&layer)) {
            continue;
        }
...
const ALLOWLIST: &[(&str, &str)] = &[
    ...
    (
        "crates/ironclaw_product_workflow/src/ironclaw_services.rs",
        "slack",
    ),
    (
        "crates/ironclaw_product_workflow/src/ironclaw_services/llm_config.rs",
        "github",
    ),
    (
        "crates/ironclaw_product_workflow/src/ironclaw_services/llm_config.rs",
    ...
    (
        "crates/ironclaw_product_workflow/src/ironclaw_services/projects.rs",
        "github",
    ),
    ...
    (
        "crates/ironclaw_composition/src/extension_host/gsuite.rs",
        "google",
    ),
    (
        "crates/ironclaw_composition/src/projection/display_preview.rs",
        "web-access",
    ),
    (
        "crates/ironclaw_composition/src/runtime/local_dev/extension_surface.rs",
        "web_access",
    ),
    ...
    ("crates/ironclaw_composition/src/factory.rs", "nearai_mcp"),
    ("crates/ironclaw_composition/src/input.rs", "nearai_mcp"),
    ("crates/ironclaw_composition/src/input.rs", "nearaimcp"),
    ("crates/ironclaw_composition/src/lib.rs", "nearai_mcp"),
    ("crates/ironclaw_composition/src/lib.rs", "nearaimcp"),
    (
    ...
    (
        "crates/ironclaw_composition/src/product_auth/api/auth.rs",
        "nearai_mcp",
    ),
    ...
    ("crates/ironclaw_composition/src/factory.rs", "slack"),
    ...
    ("crates/ironclaw_composition/src/factory.rs", "web_access"),
    ("crates/ironclaw_composition/src/lib.rs", "web_access"),
    (
        "crates/ironclaw_composition/src/web_access.rs",
        "web_access",
    ),
    ("crates/ironclaw_composition/src/web_access.rs", "webaccess"),
    ...
    ("crates/ironclaw_composition/src/factory.rs", "notion"),
    (
        "crates/ironclaw_composition/src/google_oauth_secret_store.rs",
        "google",
    ),
    ("crates/ironclaw_composition/src/lib.rs", "google"),
    ("crates/ironclaw_composition/src/lib.rs", "slack"),
    (
        "crates/ironclaw_composition/src/llm_admin/nearai_login_serve.rs",
        "github",
    ),
    (
        "crates/ironclaw_composition/src/llm_admin/nearai_login_serve.rs",
    ...
    (
        "crates/ironclaw_product_workflow/src/ironclaw_services/outbound_delivery_capability_surface.rs",
        "slack",
    ),
    (
        "crates/ironclaw_composition/src/product_auth/api/auth.rs",
    ...
    (
        "crates/ironclaw_composition/src/product_auth/serve/mod.rs",
        "slack",
    ),
    ("crates/ironclaw_composition/src/projection.rs", "slack"),
    (
        "crates/ironclaw_composition/src/projection/turn_events.rs",
        "slack",
    ),
    (
        "crates/ironclaw_composition/src/root/communication_context.rs",
        "slack",
    ),
    ...
    (
        "crates/ironclaw_composition/src/llm_admin/provider_admin.rs",
        "github",
    ),
...
#[test]
fn ironclaw_generic_code_names_no_concrete_extension() {
