...
registerPack("ko", {
  ...
  "automations.runStatus.error": "주의 필요",
  ...
  "automations.runs.error": "조치 필요: {count}건",
  ...
  "automations.filter.failures": "주의 필요",
  "automations.filter.running": "실행 중",
  "automations.status.needsReview": "주의 필요",
  "automations.status.running": "실행 중",
  "automations.summary.failures": "주의 필요",
  "automations.summary.failuresDetail": "최근 실행에 주의가 필요한 자동화입니다.",
