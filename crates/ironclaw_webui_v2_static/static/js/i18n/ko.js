...
registerPack("ko", {
  ...
  "automations.detail.emptyDescription": "최근 실행을 확인하려면 일정을 선택하세요.",
  ...
  "automations.summary.running": "지금 실행 중",
  "automations.summary.runningDetail": "현재 진행 중인 실행입니다.",
  "automations.table.noRuns": "실행 없음",
  "automations.table.recentRuns": "최근 실행",
  "skills.cancel": "취소",
  "skills.confirmDelete": "스킬 \"{name}\"을(를) 삭제하시겠습니까?",
  "skills.contentLoadFailed": "SKILL.md 콘텐츠를 불러오지 못했습니다.",
  "skills.contentRequired": "SKILL.md 콘텐츠가 필요합니다.",
  "skills.delete": "삭제",
  "skills.edit": "편집",
  ...
  "skills.updateFailed": "업데이트에 실패했습니다.",
  "skills.updated": "스킬 \"{name}\"을(를) 업데이트했습니다",
});