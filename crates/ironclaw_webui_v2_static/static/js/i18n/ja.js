...
registerPack("ja", {
  ...
  "automations.detail.emptyTitle": "オートメーションを選択",
  "automations.detail.lastCompleted": "最終完了",
  "automations.detail.noCurrentRun": "実行中のものはありません",
  "automations.detail.noRuns": "このオートメーションはまだ表示できる実行を生成していません。",
  "automations.detail.noThread": "スレッドが添付されていません",
  ...
  "automations.summary.failuresDetail": "表示中の履歴での失敗した実行。",
  "automations.summary.running": "実行中",
  ...
  "skills.contentLoadFailed": "SKILL.md の内容の読み込みに失敗しました。",
  "skills.contentRequired": "SKILL.md の内容が必要です。",
  "skills.delete": "削除",
  "skills.edit": "編集",
  "skills.group.system": "システムスキル",
  "skills.group.user": "あなたのスキル",
  "skills.group.workspace": "ワークスペースのスキル",
