...
registerPack("ja", {
  ...
  "automations.runStatus.error": "注意が必要",
  ...
  "automations.runs.error": "対応が必要: {count} 件",
  ...
  "automations.filter.failures": "注意が必要",
  "automations.filter.running": "実行中",
  "automations.status.needsReview": "注意が必要",
  "automations.status.running": "実行中",
  "automations.summary.failures": "注意が必要",
  "automations.summary.failuresDetail": "最近の実行に注意が必要なオートメーション。",
