...
registerPack("pt-BR", {
  ...
  // Settings — usage tab
  "budget.title": "Uso",
  "budget.description": "Gasto atual, limite ativo, janela de redefinição e limites de aprovação.",
  "budget.userBudget": "Uso do usuário",
  "budget.generated": "atualizado",
  "budget.usage": "Uso",
  "budget.reserved": "Reservado",
  "budget.limit": "Limite",
  "budget.utilization": "Usado",
  "budget.reset": "Redefinir",
  "budget.warnPause": "Avisar / pausar",
  "budget.unlimited": "Ilimitado",
  "budget.unconfigured": "não configurado",
  "budget.empty": "Nenhum dado de uso está disponível para esta conta.",
  "budget.loadFailed": "Falha ao carregar o uso: {message}",
