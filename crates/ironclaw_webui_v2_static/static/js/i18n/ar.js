...
registerPack("ar", {
  ...
  "chat.send": "إرسال",
  "chat.attachmentsUnsupported": "لا يدعم WebChat v2 مرفقات الصور أو الملفات حتى الآن. قم بإزالة المرفقات ووصف ما تريده في النص.",
  ...
  "automations.detail.emptyDescription": "اختر جدولاً زمنياً لفحص عمليات التشغيل الأخيرة.",
  "automations.detail.emptyTitle": "اختر أتمتة",
  "automations.detail.lastCompleted": "آخر اكتمال",
  "automations.detail.noCurrentRun": "لا يوجد تشغيل نشط",
  "automations.detail.noRuns": "لم تُنتج هذه الأتمتة أي عمليات تشغيل مرئية بعد.",
  "automations.detail.noThread": "لا توجد سلسلة مرفقة",
  "automations.detail.openRun": "فتح التشغيل",
  "automations.detail.recentRuns": "عمليات التشغيل الأخيرة",
  "automations.detail.run": "تشغيل",
  "automations.detail.schedule": "الجدول الزمني",
  "automations.detail.successRate": "معدل النجاح",
  "automations.detail.thread": "سلسلة",
  "automations.filter.failures": "حالات الفشل",
  "automations.filter.running": "قيد التشغيل",
  "automations.status.needsReview": "يحتاج إلى مراجعة",
  "automations.status.running": "قيد التشغيل",
  "automations.summary.failures": "حالات الفشل",
  "automations.summary.failuresDetail": "عمليات التشغيل الفاشلة في السجل المرئي.",
  "automations.summary.running": "قيد التشغيل الآن",
  "automations.summary.runningDetail": "عمليات التشغيل الجارية حالياً.",
  ...
  "skills.loading": "جاري التحميل...",
  "skills.save": "حفظ",
  "skills.saving": "حفظ...",
  "skills.source.installed": "مُثبَّت",
