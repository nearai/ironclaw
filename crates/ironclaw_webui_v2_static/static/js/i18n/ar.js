...
registerPack("ar", {
  ...
  "settings.budget": "الاستخدام",
  "settings.skills": "المهارات",
  "settings.traceCommons": "Trace Commons",
  "settings.users": "المستخدمون",
  "settings.language": "اللغة",
  // Settings — usage tab
  "budget.title": "الاستخدام",
  "budget.description": "الإنفاق الحالي والحد النشط ونافذة إعادة التعيين وعتبات الموافقة.",
  "budget.userBudget": "استخدام المستخدم",
  "budget.generated": "تم التحديث",
  "budget.usage": "الاستخدام",
  "budget.reserved": "محجوز",
  "budget.limit": "الحد",
  "budget.utilization": "المستخدَم",
  "budget.reset": "إعادة التعيين",
  "budget.warnPause": "تحذير / إيقاف مؤقت",
  "budget.unlimited": "غير محدود",
  "budget.unconfigured": "غير مُهيأ",
  "budget.empty": "لا تتوفر بيانات استخدام لهذا الحساب.",
  "budget.loadFailed": "فشل تحميل الاستخدام: {message}",
