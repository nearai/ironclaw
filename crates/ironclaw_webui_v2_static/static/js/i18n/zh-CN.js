...
registerPack("zh-CN", {
  ...
  "automations.runStatus.error": "需要关注",
  ...
  "automations.runs.error": "需要关注：{count} 次",
  ...
  "automations.filter.failures": "需要关注",
  "automations.filter.running": "运行中",
  "automations.status.needsReview": "需要关注",
  "automations.status.running": "运行中",
  "automations.summary.failures": "需要关注",
  "automations.summary.failuresDetail": "最近运行需要关注的自动化。",
