...
registerPack("zh-CN", {
  ...
  "automations.detail.emptyDescription": "选择一个计划以查看最近的运行。",
  "automations.detail.emptyTitle": "选择一个自动化",
  "automations.detail.lastCompleted": "上次完成",
  "automations.detail.noCurrentRun": "无进行中的运行",
  "automations.detail.noRuns": "此自动化尚未产生任何可见的运行。",
  "automations.detail.noThread": "未关联会话",
  "automations.detail.openRun": "打开运行",
  "automations.detail.recentRuns": "最近运行",
  "automations.detail.run": "运行",
  "automations.detail.schedule": "时刻编排",
