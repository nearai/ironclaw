...
impl RecordingEgress {
    ...
    fn json_status(status: u16, body: serde_json::Value) -> RuntimeHttpEgressResponse {
    ...
    fn empty(status: u16) -> RuntimeHttpEgressResponse {
        RuntimeHttpEgressResponse {
            status,
            headers: Vec::new(),
            body: Vec::new(),
...
fn fixture(area: &str, name: &str) -> Value {
    let path = format!(
