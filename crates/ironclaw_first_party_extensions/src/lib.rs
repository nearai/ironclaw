...
pub use gsuite::{
    ...
    CALENDAR_MEETING_PREP_CAPABILITY_ID, CALENDAR_SET_REMINDER_CAPABILITY_ID,
    CALENDAR_UPDATE_EVENT_CAPABILITY_ID, GMAIL_CREATE_DRAFT_CAPABILITY_ID, GMAIL_EXTENSION_ID,
    GMAIL_FETCH_MESSAGE_SUMMARIES_CAPABILITY_ID, GMAIL_GET_MESSAGE_CAPABILITY_ID,
