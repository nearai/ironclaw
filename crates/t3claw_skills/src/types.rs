...
pub enum SkillSource {
    ...
    Workspace(PathBuf),
    /// User skills directory (~/.t3claw/skills/).
    User(PathBuf),
    /// Registry-installed skills directory (~/.t3claw/installed_skills/).
    Installed(PathBuf),
...
/// here so that `t3claw_skills` remains independent of the main crate.
