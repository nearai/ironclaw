    ...
    >
      <div className="space-y-5">
        <div className="min-w-0">
          <h2 data-testid="project-workspace-title" className="text-title-lg font-semibold tracking-tight text-[var(--v2-text-strong)]">{project.name}</h2>
          {project.description
            ? (<p className="mt-1 text-ui leading-6 text-[var(--v2-text-muted)]">{project.description}</p>)
            : null}
        </div>
