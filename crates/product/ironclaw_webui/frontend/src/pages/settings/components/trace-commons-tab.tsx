  ...
  return (
    ...
    >
      <div className="min-w-0">
        <div className="text-ui text-[var(--v2-text-strong)]">{label}</div>
        {description &&
        (<div className="mt-0.5 text-ui-sm text-[var(--v2-text-muted)]">{description}</div>)}
      </div>
      <div className="shrink-0 font-mono text-ui text-[var(--v2-text-strong)]">{value}</div>
    </div>
  );
}
...
export function TraceCommonsTab({ searchQuery = "" }) {
  ...
  if (query.isLoading) {
    ...
    body = (
      <div
        className="mt-4 rounded-xl border border-[var(--v2-panel-border)] bg-[var(--v2-surface-soft)] px-4 py-6 text-center text-ui text-[var(--v2-text-muted)]"
      >
    ...
    body = (
      ...
      (
        <div className="mt-5">
          ...
          <ul className="ml-4 list-disc space-y-1 text-ui-sm text-[var(--v2-text-muted)]">
      ...
      (
        <div className="mt-5">
          ...
          <p className="mb-2 text-ui-sm leading-5 text-[var(--v2-text-muted)]">
          ...
          <ul className="space-y-2">
            {holds.map(
              (hold) => (
                ...
                >
                  <div className="min-w-0">
                    <div className="text-ui-sm text-[var(--v2-text-strong)]">{hold.reason}</div>
                  ...
                  <button
                    ...
                    className="shrink-0 rounded-lg border border-[var(--v2-accent-soft)] px-2.5 py-1 text-ui-sm font-medium text-[var(--v2-accent-text)] transition-colors hover:bg-[var(--v2-accent-soft)] disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {authorize.isPending
            ...
            (trace) => (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div
                    className="shrink-0 font-mono text-ui-sm text-[var(--v2-text-strong)]"
                ...
                <div className="mt-1 flex gap-4 text-ui-sm text-[var(--v2-text-muted)]">
                  <span>
  ...
  return (
    <Card padding="md">
      ...
      {(credits?.enrolled || tracesEnrolled) && (
        <div className="mt-3">
          <button
            ...
            className="rounded-lg border border-[var(--v2-accent-soft)] px-3 py-1.5 text-ui-sm font-medium text-[var(--v2-accent-text)] transition-colors hover:bg-[var(--v2-accent-soft)] disabled:cursor-not-allowed disabled:opacity-50"
          >
            {openState === "pending"
      ...
      <p className="mt-5 text-ui-sm leading-5 text-[var(--v2-text-faint)]">
        {t("traceCommons.note")}
      </p>
    </Card>
  );
