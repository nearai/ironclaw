...
function MetaItem({ label, value, tone = "muted" }) {
  return (
    <div className="min-w-0 rounded-xl border border-[var(--v2-panel-border)] bg-[var(--v2-surface-soft)] p-3">
      <div className="font-mono text-[10px] uppercase tracking-[0.14em] text-[var(--v2-text-muted)]">
        {label}
      </div>
      <div
        className={cn(
          "mt-2 min-w-0 break-words text-ui text-[var(--v2-text-strong)]",
      ...
      <div className="border-b border-[var(--v2-panel-border)] p-4 sm:p-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            {isEditingName
              ? (
                  ...
                  >
                    ...
                    {nameError && (
                      <div className="text-ui-sm text-[var(--v2-danger-text)]" role="alert">
                        {nameError}
                      </div>
                    )}
                  </form>
              ...
              : (
                  <div className="flex min-w-0 items-center gap-2">
                    <h3
                      ...
                      className="min-w-0 flex-1 truncate text-title font-semibold tracking-tight text-[var(--v2-text-strong)]"
                    >
            ...
            <div className="mt-2 truncate font-mono text-[11px] uppercase tracking-[0.12em] text-[var(--v2-text-muted)]">
              {automation.automation_id}
            </div>
            {automation.hold_meta_label && (
              <div
                data-testid="automation-hold-meta"
                className="mt-1 text-ui-sm text-[var(--v2-text-muted)]"
              >
                {automation.hold_meta_label}
              </div>
            )}
      ...
      <div className="space-y-5 p-4 sm:p-5">
        ...
        <div>
          <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
            <h4 className="text-ui font-semibold text-[var(--v2-text-strong)]">
          ...
          {automation.recent_runs.length
            ...
            : (
                <div className="rounded-xl border border-dashed border-[var(--v2-panel-border)] p-4 text-ui text-[var(--v2-text-muted)]">
