...
registerPack("hi", {
  ...
  "llm.resetToDefaults": "डिफ़ॉल्ट पर रीसेट करें",
  "llm.resetToDefaultsDesc": "अपने स्टार्टअप कॉन्फ़िगरेशन द्वारा चुने गए मॉडल का उपयोग करें।",
  "llm.confirmResetToDefaults": "मॉडल सेटिंग को डिफ़ॉल्ट पर रीसेट करें?",
  "llm.resetToDefaultsWarning": "यह केवल सक्रिय प्रदाता और मॉडल चयन को साफ़ करता है। आपकी प्रदाता सेटिंग और API कुंजियाँ बनी रहती हैं।",
