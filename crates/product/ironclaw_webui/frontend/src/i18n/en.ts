...
registerPack("en", {
  ...
  "llm.learningTitle": "Learning",
  "llm.learningDesc": "After every successful run, a background review creates bounded memory candidates and decides if the run can become a reusable skill.",
  "llm.learningToggleLabel": "Review successful runs",
  "llm.learningModelLabel": "Learning model",
  "llm.learningMemoryPolicyLabel": "Memory write policy",
  "llm.learningMemoryPolicyStaged": "Stage for review",
  "llm.learningMemoryPolicyAutomatic": "Apply automatically",
  "llm.learningMemoryPolicyHelp": "This policy is saved now. Memory writes start after admission support is available.",
  "llm.learningModelRequired": "Choose a learning model before turning learning on.",
  "llm.learningNoActiveProvider": "Learning needs an active LLM provider.",
  "llm.learningSaving": "Saving...",
  "llm.learningSaveFailed": "Could not update learning.",
  "llm.learningEnabledStatus": "On — learning runs after every successful run.",
  "llm.learningDisabledStatus": "Off — no background review runs.",
  "llm.learningInvalidNotice": "Saved learning settings are invalid — learning is not running.",
