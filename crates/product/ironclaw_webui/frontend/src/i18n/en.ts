...
registerPack("en", {
  ...
  "llm.resetToDefaults": "Reset to defaults",
  "llm.resetToDefaultsDesc": "Use the model selected by your startup configuration.",
  "llm.confirmResetToDefaults": "Reset model settings to defaults?",
  "llm.resetToDefaultsWarning": "This clears only the active provider and model selection. Your provider settings and API keys are kept.",
