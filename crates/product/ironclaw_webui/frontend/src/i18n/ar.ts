...
registerPack("ar", {
  ...
  "llm.resetToDefaults": "إعادة التعيين إلى الإعدادات الافتراضية",
  "llm.resetToDefaultsDesc": "استخدم النموذج المحدد في تكوين بدء التشغيل.",
  "llm.confirmResetToDefaults": "إعادة تعيين إعدادات النموذج إلى الإعدادات الافتراضية؟",
  "llm.resetToDefaultsWarning": "يؤدي هذا إلى مسح الموفر النشط واختيار النموذج فقط. سيتم الاحتفاظ بإعدادات الموفر ومفاتيح API.",
