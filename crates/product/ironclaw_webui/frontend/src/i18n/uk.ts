...
registerPack("uk", {
  ...
  "authGate.authorizationUnavailable":
    "IronClaw не зміг почати авторизацію {provider}. Постачальник недоступний, ще не налаштований або повернув непридатне посилання для авторизації, тож немає чого відкривати. Повторіть запуск або перевірте налаштування розширення.",
