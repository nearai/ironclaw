...
registerPack("uk", {
  ...
  "llm.resetToDefaults": "Скинути до типових значень",
  "llm.resetToDefaultsDesc": "Використовуйте модель, вибрану конфігурацією запуску.",
  "llm.confirmResetToDefaults": "Скинути налаштування моделі до типових значень?",
  "llm.resetToDefaultsWarning": "Буде очищено лише активного постачальника та вибір моделі. Налаштування постачальника й ключі API збережуться.",
