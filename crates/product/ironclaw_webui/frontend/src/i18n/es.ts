...
registerPack("es", {
  ...
  "llm.resetToDefaults": "Restablecer valores predeterminados",
  "llm.resetToDefaultsDesc": "Use el modelo seleccionado por su configuración de inicio.",
  "llm.confirmResetToDefaults": "¿Restablecer la configuración del modelo a los valores predeterminados?",
  "llm.resetToDefaultsWarning": "Esto borra solo el proveedor activo y la selección de modelo. Se conservan la configuración del proveedor y las claves de API.",
