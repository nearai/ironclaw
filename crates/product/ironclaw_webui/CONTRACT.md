...
| `webui.v2.ironhub_link` | GET | `/api/webchat/v2/ironhub/link` | — | `ProductSurface` |
| `webui.v2.ironhub_link_set_key` | POST | `/api/webchat/v2/ironhub/link/key` | — | `ProductSurface` |
| `webui.v2.ironhub_link_clear_key` | DELETE | `/api/webchat/v2/ironhub/link/key` | — | `ProductSurface` |
