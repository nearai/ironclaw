...
fn expected_table() -> Vec<Expected> {
    vec![
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_SESSION_WEBSOCKET_TICKET,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/session/websocket-ticket",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_SESSION_WEBSOCKET,
            method: NetworkMethod::Get,
            pattern: "/api/webchat/v2/session/websocket",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::SingleUseTicket],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
            rate_limit_max: 30,
            rate_limit_window_seconds: 60,
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_RUN_COMPLETION_INTENT,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/run-completions/intent",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_RUN_COMPLETION_ACKNOWLEDGE,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/run-completions/acknowledge",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_RUN_COMPLETION_THREAD_READ,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/run-completions/thread-read",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_RUN_COMPLETIONS_UNREAD,
            method: NetworkMethod::Get,
            pattern: "/api/webchat/v2/run-completions/unread",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
