...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_SET_LEARNING, WEBUI_V2_ROUTE_SET_NOTIFICATION_CHANNELS,
...
pub use handlers::{
    ...
    set_auto_activate_learned, set_learning, set_notification_channels, set_operator_config_key,
