...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_RENAME_AUTOMATION, WEBUI_V2_ROUTE_RESET_LLM_CONFIG, WEBUI_V2_ROUTE_RESOLVE_GATE,
...
pub use handlers::{
    ...
    reset_llm_config, resolve_gate, resume_automation, retry_run, run_operator_service_lifecycle,
