...
fn response_dtos_serialize_openai_shapes() {
    let chat = OpenAiChatCompletionResponse {
        ...
        choices: vec![ironclaw_openai_compat::OpenAiChatChoice {
            index: 0,
            message: ironclaw_openai_compat::OpenAiChatMessage {
    ...
    let chunk = OpenAiChatCompletionChunk {
        ...
        created: 1_777_777_777,
        model: "gpt-reborn".to_string(),
        choices: vec![ironclaw_openai_compat::OpenAiChatStreamChoice {
            index: 0,
            delta: ironclaw_openai_compat::OpenAiChatDelta {
                role: Some(OpenAiChatMessageRole::Assistant),
                content: Some("he".to_string()),
                tool_calls: Some(vec![ironclaw_openai_compat::OpenAiChatToolCallDelta {
                    index: 0,
                    id: Some("call_1".to_string()),
                    kind: Some(ironclaw_openai_compat::OpenAiChatToolKind::Function),
                    function: Some(ironclaw_openai_compat::OpenAiChatToolCallFunctionDelta {
