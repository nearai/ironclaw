...
| `ironclaw_reborn_webui_ingress` | `ironclaw_reborn_webui_ingress` | Host-owned WebChat v2 gateway: router/route-mount composition, authenticators, descriptor-driven policy middleware, security headers, listener binding, and serve loop. |
