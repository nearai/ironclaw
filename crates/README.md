...
| `ironclaw_auth_storage` | `ironclaw_auth_storage` | Durable filesystem-backed adapters for Reborn product-auth records over scoped filesystem and secret-store substrate. Composition wires it; UI/runtime crates should not own these records. |
