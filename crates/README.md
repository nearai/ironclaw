...
| `ironclaw_product_adapter_runtime_catalog` | `ironclaw_product_adapter_runtime_catalog` | Runtime-facing read model over the ProductAdapter registry. Surfaces enabled adapter snapshots without owning persistence, routing, or WASM loading. |
