...
import { activateExtension } from "../pages/extensions/lib/extensions-api";
...
export function SlackPairingSection({ action }) {
  ...
  return (
    ...
    >
      ...
      (<p data-testid="slack-pairing-success" className="text-xs text-emerald-300">
        {redeemMutation.data?.message || copy.successMessage}
      </p>)}
      {redeemMutation.isError &&
      (<p data-testid="slack-pairing-error" className="text-xs text-red-300">
