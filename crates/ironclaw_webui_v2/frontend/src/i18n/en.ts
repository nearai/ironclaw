...
registerPack("en", {
  ...
  "slackSetup.saved": "Slack setup saved.",
  "slackSetup.saveFailed": "Slack setup update failed.",
  "slackSetup.field.installationId": "Installation ID",
  "slackSetup.field.teamId": "Team ID",
  "slackSetup.field.appId": "App ID",
  "slackSetup.field.botUser": "Bot user",
  "slackSetup.field.sharedSubject": "Shared subject",
  "slackSetup.field.botToken": "Bot token",
  "slackSetup.field.signingSecret": "Signing secret",
  "slackSetup.help.installationId": "Local IronClaw name for this Slack install. Choose one and keep it stable.",
  "slackSetup.help.teamId": "Slack workspace/team ID from the workspace that installed the app.",
  "slackSetup.help.appId": "Slack app Basic Information > App Credentials.",
  "slackSetup.help.botUser": "Optional Reborn user. Blank uses the current WebUI operator.",
  "slackSetup.help.sharedSubject": "Optional default team agent for shared channel turns. Usually blank.",
  ...
  "slackSetup.example.localSlack": "Example: local-slack",
  "slackSetup.example.teamId": "Example: T0123456789",
  "slackSetup.example.appId": "Example: A0123456789",
  "slackSetup.example.botUser": "Example: user:operator",
