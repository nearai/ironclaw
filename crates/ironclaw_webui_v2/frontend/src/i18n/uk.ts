...
registerPack("uk", {
  ...
  "tool.errorBackend": "Сталася помилка серверної частини інструмента.",
  "tool.errorSecurity": "Відповідь інструмента заблоковано перевіркою безпеки.",
  "tool.errorCancelled": "Виклик інструмента скасовано.",
  "tool.errorTimeout": "Час очікування виклику інструмента вичерпано.",
  "tool.errorInvalidRequest": "Запит інструмента був недійсним.",
  "tool.errorAuth": "Інструмент потребує автентифікації.",
  "tool.errorPermission": "Виклик інструмента не дозволено.",
  "tool.errorGateDeclined": "Виклик інструмента відхилено.",
  ...
  "settings.budget": "Використання",
  "budget.title": "Використання",
  "budget.description": "Поточні витрати, активний ліміт, вікно скидання та пороги затвердження.",
  "budget.userBudget": "Використання користувача",
  "budget.generated": "оновлено",
  "budget.usage": "Використання",
  "budget.reserved": "Зарезервовано",
  "budget.limit": "Ліміт",
  "budget.utilization": "Використано",
  "budget.reset": "Скидання",
  "budget.warnPause": "Попередити / призупинити",
  "budget.unlimited": "Без обмежень",
  "budget.unconfigured": "не налаштовано",
  "budget.empty": "Для цього облікового запису немає даних про використання.",
  "budget.loadFailed": "Не вдалося завантажити використання: {message}",
  ...
  "automations.delivery.unavailableNotice": "Slack DM — недоступно",
  "automations.delivery.unavailableDesc": "Підключіть свій обліковий запис Slack, щоб увімкнути доставку через приватні повідомлення.",
  ...
  "projects.summary.threadsActiveToday": "{count} активних гілок сьогодні",
  "projects.summary.attentionQueue": "Черга уваги",
  "projects.summary.attentionBadge": "Увага",
  "projects.summary.failures24h": "{count} помилок за останні 24 год",
  "projects.summary.spendToday": "Витрати сьогодні",
  "projects.summary.spendBadge": "Витрати",
  "projects.summary.acrossEveryProject": "У всіх проєктах",
  "projects.summary.waitingForActivity": "Очікування активності",
  ...
  "extensions.activate": "Активувати",
  ...
  "extensions.activatedSuccess": "{name} активовано",
  "extensions.removedSuccess": "{name} видалено",
  "extensions.installFailed": "Не вдалося встановити",
  "extensions.activationFailed": "Не вдалося активувати",
...
registerPack("uk", {
  ...
  "slackSetup.saved": "Налаштування Slack збережено.",
  "slackSetup.saveFailed": "Не вдалося оновити налаштування Slack.",
  "slackSetup.field.installationId": "ID встановлення",
  "slackSetup.field.teamId": "ID команди",
  "slackSetup.field.appId": "ID застосунку",
  "slackSetup.field.botUser": "Користувач бота",
  "slackSetup.field.sharedSubject": "Спільний суб'єкт",
  "slackSetup.field.botToken": "Токен бота",
  "slackSetup.field.signingSecret": "Секрет підпису",
  "slackSetup.help.installationId": "Локальна назва IronClaw для цього встановлення Slack. Виберіть одну й не змінюйте її.",
  "slackSetup.help.teamId": "ID робочого простору/команди Slack, яка встановила застосунок.",
  "slackSetup.help.appId": "Slack app Basic Information > App Credentials.",
  "slackSetup.help.botUser": "Необов'язковий користувач Reborn. Порожнє значення використовує поточного оператора WebUI.",
  "slackSetup.help.sharedSubject": "Необов'язковий типовий командний агент для ходів у спільних каналах. Зазвичай порожній.",
  ...
  "slackSetup.example.localSlack": "Приклад: local-slack",
  "slackSetup.example.teamId": "Приклад: T0123456789",
  "slackSetup.example.appId": "Приклад: A0123456789",
  "slackSetup.example.botUser": "Приклад: user:operator",
