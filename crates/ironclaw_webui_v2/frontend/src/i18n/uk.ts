...
registerPack("uk", {
  ...
  "automations.subtext.all": "Заплановані завдання, що спостерігають, підсумовують і діють за вас у фоновому режимі.",
  "automations.subtext.active": "Активні розклади, готові й чекають на наступний запуск.",
  "automations.subtext.running": "Автоматизації, що працюють просто зараз — кожен запуск відкривається як чат, який можна переглянути.",
  "automations.subtext.failures": "Автоматизації, останні запуски яких мали помилки й можуть потребувати вашої уваги.",
  "automations.subtext.paused": "Призупинені розклади — зберігають налаштування, але не спрацюють до відновлення.",
  "automations.subtext.completed": "Одноразові автоматизації, які виконали свою роботу й завершилися.",
  "automations.filterLabel": "Фільтр статусу автоматизації",
  "automations.filter.prefix": "Фільтр",
  ...
  "automations.delivery.setDefaults": "Задати за замовчуванням",
  ...
  "automations.detail.openFullView": "Відкрити повний вигляд",
  "automations.detail.backToList": "Назад до автоматизацій",
  "automations.detail.viewLogs": "Переглянути журнали",
  "automations.detail.notFoundTitle": "Автоматизацію не знайдено",
  ...
  "automations.status.needsReview": "На перевірку",
