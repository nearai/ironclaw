...
registerPack("uk", {
  ...
  "tools.description.builtin.outbound_delivery_target_set": "Задати ціль вихідної доставки фінальної відповіді поточного користувача, наприклад приватне повідомлення або канал підключеного розширення обміну повідомленнями",
  ...
  "automations.delivery.unavailableNotice": "Приватне повідомлення — недоступно",
  "automations.delivery.unavailableDesc": "Підключіть свій обліковий запис обміну повідомленнями, щоб увімкнути доставку через приватні повідомлення.",
  ...
  "automations.delivery.footnote": "На запити підтвердження, надіслані у ваш DM, відповідають, відповівши {command} у підключеному каналі.",
