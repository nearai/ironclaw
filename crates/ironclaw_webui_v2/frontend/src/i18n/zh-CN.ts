...
registerPack("zh-CN", {
  ...
  "settings.budget": "用量",
  "budget.title": "用量",
  "budget.description": "当前支出、活动限额、重置周期和审批阈值。",
  "budget.userBudget": "用户用量",
  "budget.generated": "已更新",
  "budget.usage": "用量",
  "budget.reserved": "已预留",
  "budget.limit": "限额",
  "budget.utilization": "已使用",
  "budget.reset": "重置",
  "budget.warnPause": "警告 / 暂停",
  "budget.unlimited": "无限制",
  "budget.unconfigured": "未配置",
  "budget.empty": "此账户没有可用的用量数据。",
  "budget.loadFailed": "加载用量失败：{message}",
  "settings.skills": "技能",
