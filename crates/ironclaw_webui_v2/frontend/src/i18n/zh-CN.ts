...
registerPack("zh-CN", {
  ...
  "automations.subtext.all": "在后台为你监视、总结并采取行动的计划任务。",
  "automations.subtext.active": "已就绪并等待下次运行的启用计划。",
  "automations.subtext.running": "正在工作的自动化——每次运行都会以可查看的聊天形式打开。",
  "automations.subtext.failures": "最近运行出错、可能需要你关注的自动化。",
  "automations.subtext.paused": "已暂停的计划——保留设置，但在恢复前不会触发。",
  "automations.subtext.completed": "完成使命并退役的一次性自动化。",
  "automations.filterLabel": "自动化状态筛选",
  "automations.filter.prefix": "筛选",
  ...
  "automations.delivery.setDefaults": "设置默认值",
  ...
  "automations.detail.openFullView": "打开完整视图",
  "automations.detail.backToList": "返回自动化",
  "automations.detail.viewLogs": "查看日志",
  "automations.detail.notFoundTitle": "未找到自动化",
  ...
  "automations.status.needsReview": "待审核",
