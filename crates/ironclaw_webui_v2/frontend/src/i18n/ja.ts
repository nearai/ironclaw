...
registerPack("ja", {
  ...
  "automations.subtext.all": "バックグラウンドで監視・要約・実行してくれるスケジュール済みジョブ。",
  "automations.subtext.active": "次の実行を待機している有効なスケジュール。",
  "automations.subtext.running": "現在実行中の自動化 — 各実行は確認できるチャットとして開きます。",
  "automations.subtext.failures": "最近の実行でエラーが発生し、確認が必要かもしれない自動化。",
  "automations.subtext.paused": "保留中のスケジュール — 設定は保持されますが、再開するまで実行されません。",
  "automations.subtext.completed": "役目を終えて退役した一回限りの自動化。",
  "automations.filterLabel": "自動化ステータスフィルター",
  "automations.filter.prefix": "フィルター",
  ...
  "automations.delivery.setDefaults": "デフォルトを設定",
  ...
  "automations.delivery.unavailableNotice": "Slack DM — 利用不可",
  "automations.delivery.unavailableDesc": "DM 配信を有効にするには Slack アカウントを連携してください。",
  ...
  "automations.summary.nextRunDue": "まもなく",
  ...
  "projects.summary.threadsActiveToday": "今日アクティブなスレッド {count} 件",
  "projects.summary.attentionQueue": "注意キュー",
  "projects.summary.attentionBadge": "注意",
  "projects.summary.failures24h": "過去24時間の失敗 {count} 件",
  "projects.summary.spendToday": "今日の支出",
  "projects.summary.spendBadge": "支出",
  "projects.summary.acrossEveryProject": "すべてのプロジェクト全体",
  "projects.summary.waitingForActivity": "アクティビティ待ち",
  ...
  "extensions.activatedSuccess": "{name} を有効化しました",
  "extensions.removedSuccess": "{name} を削除しました",
  "extensions.installFailed": "インストールに失敗しました",
  "extensions.activationFailed": "有効化に失敗しました",
  ...
  "automations.detail.openFullView": "全画面表示を開く",
  "automations.detail.backToList": "オートメーションに戻る",
  "automations.detail.viewLogs": "ログを表示",
  "automations.detail.notFoundTitle": "オートメーションが見つかりません",
  ...
  "automations.status.needsReview": "要確認",
...
registerPack("ja", {
  ...
  "slackSetup.saved": "Slack 設定を保存しました。",
  "slackSetup.saveFailed": "Slack 設定の更新に失敗しました。",
  "slackSetup.field.installationId": "インストール ID",
  "slackSetup.field.teamId": "チーム ID",
  "slackSetup.field.appId": "アプリ ID",
  "slackSetup.field.botUser": "Bot ユーザー",
  "slackSetup.field.sharedSubject": "共有サブジェクト",
  "slackSetup.field.botToken": "Bot トークン",
  "slackSetup.field.signingSecret": "署名シークレット",
  "slackSetup.help.installationId": "この Slack インストールのローカル IronClaw 名です。1つ選んで固定してください。",
  "slackSetup.help.teamId": "アプリをインストールした Slack ワークスペース/チームの ID です。",
  "slackSetup.help.appId": "Slack app Basic Information > App Credentials。",
  "slackSetup.help.botUser": "任意の Reborn ユーザーです。空欄なら現在の WebUI 操作者を使います。",
  "slackSetup.help.sharedSubject": "共有チャンネルのターンに使う任意の既定チームエージェントです。通常は空欄です。",
  ...
  "slackSetup.example.localSlack": "例: local-slack",
  "slackSetup.example.teamId": "例: T0123456789",
  "slackSetup.example.appId": "例: A0123456789",
  "slackSetup.example.botUser": "例: user:operator",
  "slackSetup.example.sharedSubject": "例: user:slack-shared",
  "slackSetup.example.botToken": "例: xoxb-...",
  "slackSetup.placeholder.defaultOperator": "既定の操作者",
