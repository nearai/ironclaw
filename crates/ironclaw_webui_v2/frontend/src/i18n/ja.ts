...
registerPack("ja", {
  ...
  "tool.errorBackend": "ツールのバックエンドが失敗しました。",
  "tool.errorSecurity": "ツールの応答はセキュリティチェックによってブロックされました。",
  "tool.errorCancelled": "ツールの呼び出しがキャンセルされました。",
  "tool.errorTimeout": "ツールの呼び出しがタイムアウトしました。",
  "tool.errorInvalidRequest": "ツールのリクエストが無効でした。",
  "tool.errorAuth": "ツールには認証が必要です。",
  "tool.errorPermission": "ツールの呼び出しは許可されませんでした。",
  "tool.errorGateDeclined": "ツールの呼び出しが拒否されました。",
  ...
  "settings.tools": "ツール",
  "settings.budget": "使用状況",
  "budget.title": "使用状況",
  "budget.description": "現在の支出、有効な上限、リセット期間、承認のしきい値。",
  "budget.userBudget": "ユーザーの使用状況",
  "budget.generated": "更新済み",
  "budget.usage": "使用状況",
  "budget.reserved": "予約済み",
  "budget.limit": "上限",
  "budget.utilization": "使用済み",
  "budget.reset": "リセット",
  "budget.warnPause": "警告 / 一時停止",
  "budget.unlimited": "無制限",
  "budget.unconfigured": "未設定",
  "budget.empty": "このアカウントで利用可能な使用状況データはありません。",
  "budget.loadFailed": "使用状況の読み込みに失敗しました: {message}",
  "settings.skills": "スキル",
