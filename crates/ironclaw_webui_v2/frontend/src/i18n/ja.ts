...
registerPack("ja", {
  ...
  "tools.description.builtin.outbound_delivery_target_set": "接続済みメッセージング拡張機能の DM やチャンネルなど、現在のユーザーの最終返信の送信先を設定します",
  ...
  "automations.delivery.unavailableNotice": "DM — 利用不可",
  "automations.delivery.unavailableDesc": "DM 配信を有効にするにはメッセージングアカウントを連携してください。",
  ...
  "automations.delivery.footnote": "DM に送信された承認リクエストは、接続されたチャンネルで {command} と返信して回答します。",
