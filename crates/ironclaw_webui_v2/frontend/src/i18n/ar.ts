...
registerPack("ar", {
  ...
  "automations.subtext.all": "مهام مجدولة تراقب وتلخّص وتتصرف نيابة عنك في الخلفية.",
  "automations.subtext.active": "جداول نشطة، جاهزة وتنتظر تشغيلها التالي.",
  "automations.subtext.running": "أتمتات تعمل الآن — كل تشغيل يُفتح كمحادثة يمكنك فحصها.",
  "automations.subtext.failures": "أتمتات واجهت عمليات تشغيلها الأخيرة أخطاء وقد تحتاج إلى انتباهك.",
  "automations.subtext.paused": "جداول متوقفة مؤقتًا — تحتفظ بإعدادها لكنها لن تعمل حتى الاستئناف.",
  "automations.subtext.completed": "أتمتات لمرة واحدة أنجزت عملها وتقاعدت.",
  "automations.filterLabel": "مرشح حالة الأتمتة",
  "automations.filter.prefix": "تصفية",
