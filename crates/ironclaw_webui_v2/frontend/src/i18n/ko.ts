...
registerPack("ko", {
  ...
  "tool.errorBackend": "도구 백엔드가 실패했습니다.",
  "tool.errorSecurity": "도구 응답이 보안 검사에 의해 차단되었습니다.",
  "tool.errorCancelled": "도구 호출이 취소되었습니다.",
  "tool.errorTimeout": "도구 호출 시간이 초과되었습니다.",
  "tool.errorInvalidRequest": "도구 요청이 잘못되었습니다.",
  "tool.errorAuth": "도구에 인증이 필요합니다.",
  "tool.errorPermission": "도구 호출이 허용되지 않았습니다.",
  "tool.errorGateDeclined": "도구 호출이 거부되었습니다.",
  ...
  "settings.budget": "사용량",
  "budget.title": "사용량",
  "budget.description": "현재 지출, 활성 한도, 재설정 기간 및 승인 임계값.",
  "budget.userBudget": "사용자 사용량",
  "budget.generated": "업데이트됨",
  "budget.usage": "사용량",
  "budget.reserved": "예약됨",
  "budget.limit": "한도",
  "budget.utilization": "사용됨",
  "budget.reset": "재설정",
  "budget.warnPause": "경고 / 일시정지",
  "budget.unlimited": "무제한",
  "budget.unconfigured": "구성되지 않음",
  "budget.empty": "이 계정에 사용 가능한 사용량 데이터가 없습니다.",
  "budget.loadFailed": "사용량을 불러오지 못했습니다: {message}",
  "settings.skills": "스킬",
