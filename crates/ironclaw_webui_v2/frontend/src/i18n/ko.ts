...
registerPack("ko", {
  ...
  "automations.subtext.all": "백그라운드에서 감시하고 요약하고 대신 실행해 주는 예약 작업.",
  "automations.subtext.active": "다음 실행을 기다리고 있는 활성 일정.",
  "automations.subtext.running": "지금 작업 중인 자동화 — 각 실행은 살펴볼 수 있는 채팅으로 열립니다.",
  "automations.subtext.failures": "최근 실행에서 오류가 발생해 확인이 필요할 수 있는 자동화.",
  "automations.subtext.paused": "보류 중인 일정 — 설정은 유지되지만 재개할 때까지 실행되지 않습니다.",
  "automations.subtext.completed": "할 일을 마치고 은퇴한 일회성 자동화.",
  "automations.filterLabel": "자동화 상태 필터",
  "automations.filter.prefix": "필터",
