...
registerPack("es", {
  ...
  "tools.description.builtin.outbound_delivery_target_set": "Configurar el destino de entrega saliente de la respuesta final del usuario actual, como un mensaje directo o un canal de una extensión de mensajería conectada",
  ...
  "automations.delivery.unavailableNotice": "Mensaje directo — no disponible",
  "automations.delivery.unavailableDesc": "Vincula tu cuenta de mensajería para habilitar la entrega por mensaje directo.",
  ...
  "automations.delivery.footnote": "Las solicitudes de aprobación enviadas a tu mensaje directo se responden respondiendo {command} en el canal conectado.",
