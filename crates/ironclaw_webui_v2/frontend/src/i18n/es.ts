...
registerPack("es", {
  ...
  "tool.errorBackend": "El backend de la herramienta falló.",
  "tool.errorSecurity": "La respuesta de la herramienta fue bloqueada por una comprobación de seguridad.",
  "tool.errorCancelled": "Se canceló la llamada a la herramienta.",
  "tool.errorTimeout": "Se agotó el tiempo de espera de la llamada a la herramienta.",
  "tool.errorInvalidRequest": "La solicitud de la herramienta no era válida.",
  "tool.errorAuth": "La herramienta necesita autenticación.",
  "tool.errorPermission": "No se permitió la llamada a la herramienta.",
  "tool.errorGateDeclined": "Se rechazó la llamada a la herramienta.",
  ...
  "settings.budget": "Uso",
  "budget.title": "Uso",
  "budget.description": "Gasto actual, límite activo, ventana de reinicio y umbrales de aprobación.",
  "budget.userBudget": "Uso del usuario",
  "budget.generated": "actualizado",
  "budget.usage": "Uso",
  "budget.reserved": "Reservado",
  "budget.limit": "Límite",
  "budget.utilization": "Usado",
  "budget.reset": "Reinicio",
  "budget.warnPause": "Advertir / pausar",
  "budget.unlimited": "Ilimitado",
  "budget.unconfigured": "sin configurar",
  "budget.empty": "No hay datos de uso disponibles para esta cuenta.",
  "budget.loadFailed": "No se pudo cargar el uso: {message}",
