...
registerPack("es", {
  ...
  "automations.subtext.all": "Tareas programadas que observan, resumen y actúan por ti en segundo plano.",
  "automations.subtext.active": "Programaciones activas, listas y a la espera de su próxima ejecución.",
  "automations.subtext.running": "Automatizaciones trabajando ahora mismo: cada ejecución se abre como un chat que puedes inspeccionar.",
  "automations.subtext.failures": "Automatizaciones cuyas ejecuciones recientes tuvieron errores y pueden requerir tu atención.",
  "automations.subtext.paused": "Programaciones en pausa: conservan su configuración pero no se ejecutarán hasta reanudarse.",
  "automations.subtext.completed": "Automatizaciones de una sola vez que hicieron su trabajo y se retiraron.",
  "automations.filterLabel": "Filtro de estado de automatización",
  "automations.filter.prefix": "Filtrar",
  ...
  "automations.delivery.setDefaults": "Configurar valores",
  ...
  "automations.summary.nextRunDue": "Ahora mismo",
  ...
  "automations.detail.openFullView": "Abrir vista completa",
  "automations.detail.backToList": "Volver a automatizaciones",
  "automations.detail.viewLogs": "Ver registros",
  "automations.detail.notFoundTitle": "Automatización no encontrada",
  "automations.detail.notFoundDescription":
    "Esta automatización ya no está disponible o no tienes acceso a ella.",
  "automations.row.lastRun": "Última ejecución",
  "automations.sort.label": "Ordenar",
  "automations.runs.countLabel": "ejecuciones recientes",
  "automations.detail.idLabel": "ID",
  "automations.detail.copyId": "Copiar ID",
  ...
  "automations.status.needsReview": "Por revisar",
