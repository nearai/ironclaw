...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_GET_SESSION, WEBUI_V2_ROUTE_GET_SKILL,
    WEBUI_V2_ROUTE_GET_THREAD_STATE, WEBUI_V2_ROUTE_GET_TIMELINE,
    ...
    WEBUI_V2_ROUTE_OPERATOR_CREATE_ACCESS_SESSION, WEBUI_V2_ROUTE_OPERATOR_DIAGNOSTICS,
    ...
    WEBUI_V2_ROUTE_OPERATOR_VALIDATE_CONFIG, WEBUI_V2_ROUTE_READ_PROJECT_FILE,
    WEBUI_V2_ROUTE_REMOVE_EXTENSION, WEBUI_V2_ROUTE_REMOVE_SKILL,
...
pub use handlers::{
    ...
    list_extension_registry, list_extensions, list_llm_models, list_operator_config,
    list_outbound_delivery_targets, list_skills, list_threads, operator_create_access_session,
    query_operator_logs, remove_extension, remove_skill, resolve_gate,
