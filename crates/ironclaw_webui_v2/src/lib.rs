...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_GET_OUTBOUND_PREFERENCES, WEBUI_V2_ROUTE_GET_SESSION, WEBUI_V2_ROUTE_GET_SKILL,
    ...
    WEBUI_V2_ROUTE_LIST_SKILLS, WEBUI_V2_ROUTE_LIST_THREADS, WEBUI_V2_ROUTE_OPERATOR_DIAGNOSTICS,
...
pub use handlers::{
    ...
    get_operator_diagnostics, get_operator_setup, get_operator_status, get_outbound_preferences,
    get_session, get_skill_content, get_timeline, install_extension, install_skill,
    list_automations, list_connectable_channels, list_extension_registry, list_extensions,
    list_llm_models, list_operator_config, list_outbound_delivery_targets, list_skills,
    list_threads, query_operator_logs, remove_extension, remove_skill, resolve_gate,
    run_operator_service_lifecycle, run_operator_setup, search_skills, send_message,
    set_active_llm, set_outbound_preferences, setup_extension, start_codex_login,
