...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_COMPLETE_NEARAI_WALLET_LOGIN, WEBUI_V2_ROUTE_CREATE_AUTOMATION,
    WEBUI_V2_ROUTE_CREATE_PROJECT, WEBUI_V2_ROUTE_CREATE_THREAD, WEBUI_V2_ROUTE_DELETE_AUTOMATION,
...
#[cfg(feature = "webui-v2-beta")]
pub use handlers::{
    activate_extension, browse_fs_dir, cancel_run, complete_nearai_wallet_login, create_automation,
    create_thread, delete_automation, delete_llm_provider, delete_thread, get_attachment,
    get_extension_setup, get_llm_config, get_operator_config_key, get_operator_diagnostics,
    get_operator_setup, get_operator_status, get_outbound_preferences, get_session,
