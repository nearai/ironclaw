...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_COMPLETE_NEARAI_WALLET_LOGIN, WEBUI_V2_ROUTE_CONTROL_OPERATOR_SERVICE,
    WEBUI_V2_ROUTE_CREATE_THREAD, WEBUI_V2_ROUTE_DELETE_LLM_PROVIDER, WEBUI_V2_ROUTE_DELETE_THREAD,
    WEBUI_V2_ROUTE_GET_EXTENSION_SETUP, WEBUI_V2_ROUTE_GET_LLM_CONFIG,
    WEBUI_V2_ROUTE_GET_OPERATOR_STATUS, WEBUI_V2_ROUTE_GET_SESSION, WEBUI_V2_ROUTE_GET_SKILL,
    ...
    WEBUI_V2_ROUTE_QUERY_OPERATOR_LOGS, WEBUI_V2_ROUTE_REMOVE_EXTENSION,
    ...
    is_webui_v2_operator_route_id, webui_v2_routes,
};
#[cfg(feature = "webui-v2-beta")]
pub use error::{WebUiV2HttpError, WebUiV2HttpErrorBody};
#[cfg(feature = "webui-v2-beta")]
pub use handlers::{
    activate_extension, cancel_run, complete_nearai_wallet_login, control_operator_service,
    create_thread, delete_llm_provider, delete_thread, get_extension_setup, get_llm_config,
    get_operator_status, get_session, get_skill_content, get_timeline, install_extension,
    install_skill, list_automations, list_connectable_channels, list_extension_registry,
    list_extensions, list_llm_models, list_skills, list_threads, remove_extension, remove_skill,
    resolve_gate, search_skills, send_message, set_active_llm, setup_extension, start_codex_login,
    start_nearai_login, stream_events, stream_events_ws, test_llm_connection, update_skill,
    upsert_llm_provider,
};
#[cfg(feature = "webui-v2-beta")]
pub use router::{
