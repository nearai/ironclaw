...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_APPROVE_PENDING_SKILL, WEBUI_V2_ROUTE_BROWSE_FS_DIR, WEBUI_V2_ROUTE_CANCEL_RUN,
    ...
    WEBUI_V2_ROUTE_DELETE_THREAD, WEBUI_V2_ROUTE_DISCARD_PENDING_SKILL,
    ...
    WEBUI_V2_ROUTE_GET_PROJECT, WEBUI_V2_ROUTE_GET_SESSION, WEBUI_V2_ROUTE_GET_SKILL,
    ...
    WEBUI_V2_ROUTE_LIST_OUTBOUND_DELIVERY_TARGETS, WEBUI_V2_ROUTE_LIST_PENDING_SKILLS,
    WEBUI_V2_ROUTE_LIST_PROJECT_FILES, WEBUI_V2_ROUTE_LIST_PROJECT_MEMBERS,
    WEBUI_V2_ROUTE_LIST_PROJECTS, WEBUI_V2_ROUTE_LIST_SKILLS, WEBUI_V2_ROUTE_LIST_THREADS,
    ...
    WEBUI_V2_ROUTE_PAUSE_AUTOMATION, WEBUI_V2_ROUTE_READ_FS_FILE, WEBUI_V2_ROUTE_READ_PROJECT_FILE,
    WEBUI_V2_ROUTE_REMOVE_EXTENSION, WEBUI_V2_ROUTE_REMOVE_PROJECT_MEMBER,
    WEBUI_V2_ROUTE_REMOVE_SKILL, WEBUI_V2_ROUTE_RESOLVE_GATE, WEBUI_V2_ROUTE_RESUME_AUTOMATION,
    WEBUI_V2_ROUTE_SEARCH_SKILLS, WEBUI_V2_ROUTE_SEND_MESSAGE, WEBUI_V2_ROUTE_SET_ACTIVE_LLM,
    WEBUI_V2_ROUTE_SET_AUTO_ACTIVATE_LEARNED, WEBUI_V2_ROUTE_SET_LEARNING_ENABLED,
    WEBUI_V2_ROUTE_SET_OUTBOUND_PREFERENCES, WEBUI_V2_ROUTE_SET_REQUIRE_REVIEW,
...
#[cfg(feature = "webui-v2-beta")]
pub use handlers::{
    activate_extension, approve_pending_skill, browse_fs_dir, cancel_run,
    complete_nearai_wallet_login, create_thread, delete_automation, delete_llm_provider,
    delete_thread, discard_pending_skill, get_attachment, get_extension_setup, get_llm_config,
    ...
    list_outbound_delivery_targets, list_pending_skills, list_skills, list_threads,
    ...
    search_skills, send_message, set_active_llm, set_auto_activate_learned, set_learning_enabled,
    set_operator_config_key, set_outbound_preferences, set_require_review, set_skill_auto_activate,
