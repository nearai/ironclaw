...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_REGISTER_EXTENSION, WEBUI_V2_ROUTE_REMOVE_EXTENSION,
...
pub use handlers::{
    ...
    register_extension, remove_extension, remove_skill, rename_automation, resolve_gate,
    resume_automation, retry_run,
    ...
    stream_events_ws, test_llm_connection, trace_account_traces, trace_credits, unregister_extension,
