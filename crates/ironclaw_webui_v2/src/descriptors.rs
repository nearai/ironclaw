...
pub const WEBUI_V2_ROUTE_GET_PROJECT_OUTBOUND_PREFERENCES: &str =
    "webui.v2.get_project_outbound_preferences";
pub const WEBUI_V2_ROUTE_SET_PROJECT_OUTBOUND_PREFERENCES: &str =
    "webui.v2.set_project_outbound_preferences";
pub const WEBUI_V2_ROUTE_LIST_PROJECT_OUTBOUND_DELIVERY_TARGETS: &str =
    "webui.v2.list_project_outbound_delivery_targets";
...
pub const WEBUI_V2_PATTERN_PROJECT_OUTBOUND_PREFERENCES: &str =
    "/api/webchat/v2/outbound/project/preferences";
pub const WEBUI_V2_PATTERN_PROJECT_OUTBOUND_DELIVERY_TARGETS: &str =
    "/api/webchat/v2/outbound/project/targets";
...
pub fn webui_v2_routes() -> Vec<IngressRouteDescriptor> {
    vec![
        ...
        get_project_outbound_preferences_descriptor(),
        set_project_outbound_preferences_descriptor(),
        list_project_outbound_delivery_targets_descriptor(),
...
pub fn is_webui_v2_operator_route_id(route_id: &str) -> bool {
    is_webui_v2_llm_config_route_id(route_id)
        || matches!(
            route_id,
            WEBUI_V2_ROUTE_GET_PROJECT_OUTBOUND_PREFERENCES
                | WEBUI_V2_ROUTE_SET_PROJECT_OUTBOUND_PREFERENCES
                | WEBUI_V2_ROUTE_LIST_PROJECT_OUTBOUND_DELIVERY_TARGETS
        )
}
...
fn get_project_outbound_preferences_descriptor() -> IngressRouteDescriptor {
    descriptor(
        WEBUI_V2_ROUTE_GET_PROJECT_OUTBOUND_PREFERENCES,
        NetworkMethod::Get,
...
fn set_project_outbound_preferences_descriptor() -> IngressRouteDescriptor {
    descriptor(
        WEBUI_V2_ROUTE_SET_PROJECT_OUTBOUND_PREFERENCES,
        NetworkMethod::Post,
        WEBUI_V2_PATTERN_PROJECT_OUTBOUND_PREFERENCES,
...
fn list_project_outbound_delivery_targets_descriptor() -> IngressRouteDescriptor {
    descriptor(
        WEBUI_V2_ROUTE_LIST_PROJECT_OUTBOUND_DELIVERY_TARGETS,
        NetworkMethod::Get,
