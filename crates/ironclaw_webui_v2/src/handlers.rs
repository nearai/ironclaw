...
///
/// Resolves a single automation by id for the full-screen detail view / deep
/// link, with no completed-state or page-cap filter (unlike list). A missing or
/// non-caller-owned id returns `404`.
