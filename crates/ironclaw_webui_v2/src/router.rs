...
use crate::descriptors::{
    ...
    WEBUI_V2_PATTERN_SET_AUTO_ACTIVATE_LEARNED, WEBUI_V2_PATTERN_SET_SHARED_CREDENTIAL,
...
pub fn webui_v2_router_with_options(state: WebUiV2State, options: WebUiV2RouteOptions) -> Router {
    let mut router = Router::new()
        ...
        .route(
            WEBUI_V2_PATTERN_SET_SHARED_CREDENTIAL,
            post(handlers::set_shared_credential),
        )
        .route(
