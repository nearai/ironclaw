...
use crate::descriptors::{
    ...
    WEBUI_V2_PATTERN_PROJECT_OUTBOUND_DELIVERY_TARGETS,
    WEBUI_V2_PATTERN_PROJECT_OUTBOUND_PREFERENCES, WEBUI_V2_PATTERN_REMOVE_EXTENSION,
...
pub fn webui_v2_router_with_options(state: WebUiV2State, options: WebUiV2RouteOptions) -> Router {
    let mut router = Router::new()
        ...
        .route(
            WEBUI_V2_PATTERN_PROJECT_OUTBOUND_PREFERENCES,
            get(handlers::get_project_outbound_preferences)
                .post(handlers::set_project_outbound_preferences),
        )
        .route(
            WEBUI_V2_PATTERN_PROJECT_OUTBOUND_DELIVERY_TARGETS,
            get(handlers::list_project_outbound_delivery_targets),
        )
        .route(
