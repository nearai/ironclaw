...
use crate::descriptors::{
    ...
    WEBUI_V2_PATTERN_GET_LLM_CONFIG, WEBUI_V2_PATTERN_GET_SESSION,
    WEBUI_V2_PATTERN_GET_THREAD_STATE, WEBUI_V2_PATTERN_GET_TIMELINE,
    ...
    WEBUI_V2_PATTERN_OPERATOR_CREATE_ACCESS_SESSION, WEBUI_V2_PATTERN_OPERATOR_DIAGNOSTICS,
    ...
    if options.mount_operator_routes {
        router = router
            ...
            .route(
                ...
                post(handlers::operator_create_access_session),
            );
    }
