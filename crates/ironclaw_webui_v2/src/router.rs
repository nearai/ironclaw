...
use crate::descriptors::{
    ...
    WEBUI_V2_PATTERN_REGISTER_EXTENSION, WEBUI_V2_PATTERN_REMOVE_EXTENSION,
    ...
    WEBUI_V2_PATTERN_TRACE_HOLD_AUTHORIZE, WEBUI_V2_PATTERN_UNREGISTER_EXTENSION,
};
use crate::handlers;
...
pub fn webui_v2_router_with_options(state: WebUiV2State, options: WebUiV2RouteOptions) -> Router {
    let mut router = Router::new()
        ...
        .route(
            ...
            post(handlers::register_extension),
        )
        .route(
        ...
        .route(
            ...
            post(handlers::unregister_extension),
        )
        .route(
