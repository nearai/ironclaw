...
fn expected_table() -> Vec<Expected> {
    vec![
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_SET_REQUIRE_REVIEW,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/skills/require-review",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_SET_LEARNING_ENABLED,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/skills/learning-enabled",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_LIST_PENDING_SKILLS,
            method: NetworkMethod::Get,
            pattern: "/api/webchat/v2/skills/pending",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_APPROVE_PENDING_SKILL,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/skills/pending/approve",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_DISCARD_PENDING_SKILL,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/skills/pending/discard",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
