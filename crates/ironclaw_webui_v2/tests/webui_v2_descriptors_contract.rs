...
fn expected_table() -> Vec<Expected> {
    vec![
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_GET_PROJECT_OUTBOUND_PREFERENCES,
            method: NetworkMethod::Get,
            pattern: "/api/webchat/v2/outbound/project/preferences",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_SET_PROJECT_OUTBOUND_PREFERENCES,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/outbound/project/preferences",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_LIST_PROJECT_OUTBOUND_DELIVERY_TARGETS,
            method: NetworkMethod::Get,
            pattern: "/api/webchat/v2/outbound/project/targets",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
