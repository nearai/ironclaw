...
fn expected_table() -> Vec<Expected> {
    vec![
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_REGISTER_EXTENSION,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/extensions/register",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(16),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_UNREGISTER_EXTENSION,
            method: NetworkMethod::Post,
            pattern: "/api/webchat/v2/extensions/{package_id}/unregister",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
