...
registerPack("ar", {
  ...
  "ext.registry.importReplaceConfirm": "هذه الأداة مثبّتة بالفعل. هل تريد استبدالها للمستأجر بالكامل بهذا الإصدار؟ سيؤدي ذلك إلى استبدال التثبيت الحالي، بما في ذلك النسخة الخاصة لأحد الزملاء إن وُجدت، وقد يلزم تفعيلها بعد ذلك.",
