...
registerPack("ko", {
  ...
  "projects.summary.threadsActiveToday": "오늘 활성 스레드 {count}개",
  "projects.summary.attentionQueue": "주의 큐",
  "projects.summary.attentionBadge": "주의",
  "projects.summary.failures24h": "최근 24시간 실패 {count}건",
  "projects.summary.spendToday": "오늘 지출",
  "projects.summary.spendBadge": "지출",
  "projects.summary.acrossEveryProject": "모든 프로젝트 전체",
  "projects.summary.waitingForActivity": "활동 대기 중",
  ...
  "extensions.activatedSuccess": "{name} 활성화됨",
  "extensions.removedSuccess": "{name} 제거됨",
  "extensions.installFailed": "설치 실패",
  "extensions.activationFailed": "활성화 실패",
...
registerPack("ko", {
  ...
  "slackSetup.saved": "Slack 설정이 저장되었습니다.",
  "slackSetup.saveFailed": "Slack 설정 업데이트에 실패했습니다.",
  "slackSetup.field.installationId": "설치 ID",
  "slackSetup.field.teamId": "팀 ID",
  "slackSetup.field.appId": "앱 ID",
  "slackSetup.field.botUser": "봇 사용자",
  "slackSetup.field.sharedSubject": "공유 주체",
  "slackSetup.field.botToken": "봇 토큰",
  "slackSetup.field.signingSecret": "서명 시크릿",
  "slackSetup.help.installationId": "이 Slack 설치의 로컬 IronClaw 이름입니다. 하나를 선택하고 유지하세요.",
  "slackSetup.help.teamId": "앱을 설치한 Slack 워크스페이스/팀 ID입니다.",
  "slackSetup.help.appId": "Slack app Basic Information > App Credentials.",
  "slackSetup.help.botUser": "선택 사항인 Reborn 사용자입니다. 비워두면 현재 WebUI 운영자를 사용합니다.",
  "slackSetup.help.sharedSubject": "공유 채널 턴에 사용할 선택 사항 기본 팀 에이전트입니다. 보통 비워둡니다.",
  ...
  "slackSetup.example.localSlack": "예: local-slack",
  "slackSetup.example.teamId": "예: T0123456789",
  "slackSetup.example.appId": "예: A0123456789",
  "slackSetup.example.botUser": "예: user:operator",
  "slackSetup.example.sharedSubject": "예: user:slack-shared",
  "slackSetup.example.botToken": "예: xoxb-...",
  "slackSetup.placeholder.defaultOperator": "기본 운영자",
