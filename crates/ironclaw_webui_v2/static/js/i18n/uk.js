...
registerPack("uk", {
  ...
  "ext.registry.importReplaceConfirm": "Цей інструмент уже встановлено. Замінити його для всього орендаря цією версією? Це замінить поточну інсталяцію, зокрема приватну копію колеги, якщо така є, яку, можливо, доведеться активувати після цього.",
