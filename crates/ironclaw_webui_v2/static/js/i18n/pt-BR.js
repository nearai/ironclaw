...
registerPack("pt-BR", {
  ...
  "automations.delivery.setDefaults": "Definir padrões",
  ...
  "automations.summary.nextRunDue": "Agora mesmo",
  ...
  "pairing.reconnectHint": "Conectado — cole um novo código para reparear.",
  ...
  "automations.detail.openFullView": "Abrir visualização completa",
  "automations.detail.backToList": "Voltar para automações",
  "automations.detail.viewLogs": "Ver registros",
  "automations.detail.notFoundTitle": "Automação não encontrada",
  "automations.detail.notFoundDescription":
    "Esta automação não está mais disponível ou você não tem acesso a ela.",
  "automations.row.lastRun": "Última execução",
  "automations.sort.label": "Ordenar",
  "automations.runs.countLabel": "execuções recentes",
  ...
  "automations.status.needsReview": "Para revisar",
