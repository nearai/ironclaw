...
- `crates/ironclaw_engine/AGENTS.md` — engine v2 primitives, execution loop, CodeAct
- `src/agent/AGENTS.md` — agent loop architecture
- `src/llm/AGENTS.md` — LLM provider architecture
- `src/db/AGENTS.md` — database dual-backend architecture
