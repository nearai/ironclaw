...
XMPP_JID="${XMPP_JID:-ruffles@xmpp.sobe.world}"
...
XMPP_OMEMO_STORE_DIR="${XMPP_OMEMO_STORE_DIR:-/home/cmc/.ironclaw/xmpp}"
...
Environment:
  ...
  Optional:
    ...
    XMPP_OMEMO_STORE_DIR          default: /home/cmc/.ironclaw/xmpp
