...
- *(webui-v2)* release local thread admission after a failed rebased run so follow-up messages reach the server instead of being silently dropped ([#6155](https://github.com/nearai/ironclaw/issues/6155)).
