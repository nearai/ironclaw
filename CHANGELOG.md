...
- *(webui-v2)* show “Running” during an automation's first execution instead of incorrectly labeling its current run as a previous run still in progress ([#6127](https://github.com/nearai/ironclaw/issues/6127)).
