...
- *(reborn webui)* hide the unsupported token reissue action from existing admin user details while preserving the one-time token shown after user creation ([#6085](https://github.com/nearai/ironclaw/issues/6085)).
